...
# Image: k3s-openssl-static
# Reference: https://images.chainguard.dev/directory/image/k3s-openssl-static/overview
...
# TODO: Implement k3s-openssl-static image
throw "Image 'k3s-openssl-static' is not yet implemented"
