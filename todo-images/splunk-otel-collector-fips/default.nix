...
# Image: splunk-otel-collector-fips
# Reference: https://images.chainguard.dev/directory/image/splunk-otel-collector-fips/overview
...
#   quota-tools (4.10-r1)
#   splunk-otel-collector-fips (0.140.0-r1)
#   sqlite-libs (3.51.1-r0)
#   systemd-boot (258.2-r3)
#   systemd-systemctl (258.2-r3)

# TODO: Implement splunk-otel-collector-fips image
throw "Image 'splunk-otel-collector-fips' is not yet implemented"
