...
# Image: gcp-compute-persistent-disk-csi-driver-fips
# Reference: https://images.chainguard.dev/directory/image/gcp-compute-persistent-disk-csi-driver-fips/overview
...
#   gcp-compute-persistent-disk-csi-driver-fips-1.21 (1.21.12-r2)
#   heimdal-libs (7.8.0-r42)
#   jitterentropy-library (3.6.3-r2)
#   jitterentropy-library-dev (3.6.3-r2)
#   json-c-dev (0.18-r4)
#   keyutils-dev (1.6.3-r37)
...
#   userspace-rcu (0.15.5-r0)
#   util-linux-misc (2.41.2-r2)
#   xfsprogs-core (6.17.0-r2)

# TODO: Implement gcp-compute-persistent-disk-csi-driver-fips image
throw "Image 'gcp-compute-persistent-disk-csi-driver-fips' is not yet implemented"
