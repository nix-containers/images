...
# Image: rancher-fleet
# Reference: https://images.chainguard.dev/directory/image/rancher-fleet/overview
...
#   rancher-fleet-cli (0.14.0-r2)
#   rancher-fleet-controller (0.14.0-r2)
#   rancher-fleet-termination-log (0.14.0-r2)
#   sqlite-libs (3.51.1-r0)

# TODO: Implement rancher-fleet image
throw "Image 'rancher-fleet' is not yet implemented"
