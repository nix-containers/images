...
# Image: k3s-openssl
# Reference: https://images.chainguard.dev/directory/image/k3s-openssl/overview
...
# TODO: Implement k3s-openssl image
throw "Image 'k3s-openssl' is not yet implemented"
