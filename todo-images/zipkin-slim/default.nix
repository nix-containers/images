...
# Image: zipkin-slim
# Reference: https://images.chainguard.dev/directory/image/zipkin-slim/overview
...
#   zipkin-slim (3.5.1-r8)

# TODO: Implement zipkin-slim image
throw "Image 'zipkin-slim' is not yet implemented"
