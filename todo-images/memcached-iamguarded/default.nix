...
# Image: memcached-iamguarded
# Reference: https://images.chainguard.dev/directory/image/memcached-iamguarded/overview
...
# TODO: Implement memcached-iamguarded image
throw "Image 'memcached-iamguarded' is not yet implemented"
