...
# Image: quic-go
# Reference: https://images.chainguard.dev/directory/image/quic-go/overview
...
#   quic-go (0.57.1-r1)
#   quic-go-client (0.57.1-r1)
#   quic-go-server (0.57.1-r1)
#   quic-network-simulator (0_git20251118-r0)
#   wait-for-it (0.20200823-r7)
#   xtables (1.8.11-r29)

# TODO: Implement quic-go image
throw "Image 'quic-go' is not yet implemented"
