...
# Reference: https://images.chainguard.dev/directory/image/jitsucom-console/overview
...
#   jitsucom-jitsu (2.11.0-r8)
#   jitsucom-jitsu-console (2.11.0-r8)
...
# TODO: Implement jitsucom-console image
throw "Image 'jitsucom-console' is not yet implemented"
