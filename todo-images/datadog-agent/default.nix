...
# Image: datadog-agent
# Reference: https://images.chainguard.dev/directory/image/datadog-agent/overview

# Packages available in nixpkgs:
#   pkgs.bash  # bash (5.3-r3)
#   pkgs.busybox  # busybox (1.37.0-r50)
#   pkgs.coreutils  # coreutils (9.9-r0)
#   pkgs.datadog-agent  # datadog-agent (7.72.4-r2)
...
#   blkid (2.41.2-r2)
#   datadog-agent-core-integrations (7.72.4-r2)
#   datadog-agent-s6-overlay (7.72.4-r2)
...
# TODO: Implement datadog-agent image
throw "Image 'datadog-agent' is not yet implemented"
...
#   entrypoint = [ "${pkgs.datadog-agent}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "0";
#
#   labels = {
