...
# Image: metricbeat-fips
# Reference: https://images.chainguard.dev/directory/image/metricbeat-fips/overview
...
# TODO: Implement metricbeat-fips image
throw "Image 'metricbeat-fips' is not yet implemented"
