...
# Image: liquibase
# Reference: https://images.chainguard.dev/directory/image/liquibase/overview
...
#   pkgs.liquibase  # liquibase (5.0.1-r2)
...
# TODO: Implement liquibase image
throw "Image 'liquibase' is not yet implemented"
...
#   entrypoint = [ "${pkgs.liquibase}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "1001";
#
#   labels = {
