...
# Reference: https://images.chainguard.dev/directory/image/aws-efs-csi-driver/overview
...
# TODO: Implement aws-efs-csi-driver image
throw "Image 'aws-efs-csi-driver' is not yet implemented"
