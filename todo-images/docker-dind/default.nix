...
# Image: docker-dind
# Reference: https://images.chainguard.dev/directory/image/docker-dind/overview
...
#   pkgs.docker  # docker (28.5.2-r7)
#   pkgs.docker-compose  # docker-compose (5.0.0-r1)
#   pkgs.docker-init  # docker-init (28.5.2-r7)
...
#   docker-cli-buildx (0.30.1-r2)
#   docker-dind (28.5.2-r7)
#   docker-oci-entrypoint (28.5.2-r7)
#   dockerd (28.5.2-r7)
#   dockerd-oci-entrypoint (28.5.2-r7)
...
# TODO: Implement docker-dind image
throw "Image 'docker-dind' is not yet implemented"
