...
# Image: promitor-agent-scraper-fips
# Reference: https://images.chainguard.dev/directory/image/promitor-agent-scraper-fips/overview
...
# TODO: Implement promitor-agent-scraper-fips image
throw "Image 'promitor-agent-scraper-fips' is not yet implemented"
