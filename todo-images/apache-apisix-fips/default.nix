...
# Image: apache-apisix-fips
# Reference: https://images.chainguard.dev/directory/image/apache-apisix-fips/overview
...
# TODO: Implement apache-apisix-fips image
throw "Image 'apache-apisix-fips' is not yet implemented"
