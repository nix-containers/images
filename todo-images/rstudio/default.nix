...
# Image: rstudio
# Reference: https://images.chainguard.dev/directory/image/rstudio/overview
...
# TODO: Implement rstudio image
throw "Image 'rstudio' is not yet implemented"
...
#   entrypoint = [ "${pkgs.rstudio}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "65532";
#
#   labels = {
