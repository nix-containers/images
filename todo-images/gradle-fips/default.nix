...
# Image: gradle-fips
# Reference: https://images.chainguard.dev/directory/image/gradle-fips/overview
...
# TODO: Implement gradle-fips image
throw "Image 'gradle-fips' is not yet implemented"
