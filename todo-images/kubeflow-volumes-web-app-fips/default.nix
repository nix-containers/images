...
# Image: kubeflow-volumes-web-app-fips
# Reference: https://images.chainguard.dev/directory/image/kubeflow-volumes-web-app-fips/overview
...
#   kubeflow-volumes-web-app (1.10.0-r5)
#   ld-linux (2.42-r4)
#   libbz2-1 (1.0.8-r21)
#   libcrypto3 (3.6.0-r4)
#   libexpat1 (2.7.3-r0)
...
# TODO: Implement kubeflow-volumes-web-app-fips image
throw "Image 'kubeflow-volumes-web-app-fips' is not yet implemented"
