...
# Image: git-iamguarded-fips
# Reference: https://images.chainguard.dev/directory/image/git-iamguarded-fips/overview
...
# TODO: Implement git-iamguarded-fips image
throw "Image 'git-iamguarded-fips' is not yet implemented"
