...
# Reference: https://images.chainguard.dev/directory/image/prometheus-cloudwatch-exporter/overview
...
# TODO: Implement prometheus-cloudwatch-exporter image
throw "Image 'prometheus-cloudwatch-exporter' is not yet implemented"
