...
# Image: fluent-bit-watcher-fips
# Reference: https://images.chainguard.dev/directory/image/fluent-bit-watcher-fips/overview
...
# TODO: Implement fluent-bit-watcher-fips image
throw "Image 'fluent-bit-watcher-fips' is not yet implemented"
