...
# Image: wavefront-proxy
# Reference: https://images.chainguard.dev/directory/image/wavefront-proxy/overview
...
#   ttf-dejavu (2.37-r7)
#   wavefront-proxy (13.9-r0)
#   wavefront-proxy-config (13.9-r0)
#   wavefront-proxy-licenses (13.9-r0)

# TODO: Implement wavefront-proxy image
throw "Image 'wavefront-proxy' is not yet implemented"
