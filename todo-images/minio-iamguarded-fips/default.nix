...
# Image: minio-iamguarded-fips
# Reference: https://images.chainguard.dev/directory/image/minio-iamguarded-fips/overview
...
# TODO: Implement minio-iamguarded-fips image
throw "Image 'minio-iamguarded-fips' is not yet implemented"
