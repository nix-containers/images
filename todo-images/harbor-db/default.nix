...
# Image: harbor-db
# Reference: https://images.chainguard.dev/directory/image/harbor-db/overview
...
# TODO: Implement harbor-db image
throw "Image 'harbor-db' is not yet implemented"
...
#
#   labels = {
#     "org.opencontainers.image.title" = "harbor-db";
