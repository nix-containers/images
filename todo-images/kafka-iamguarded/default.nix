...
# Image: kafka-iamguarded
# Reference: https://images.chainguard.dev/directory/image/kafka-iamguarded/overview
...
# TODO: Implement kafka-iamguarded image
throw "Image 'kafka-iamguarded' is not yet implemented"
