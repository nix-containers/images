...
# Image: nginx-iamguarded-fips
# Reference: https://images.chainguard.dev/directory/image/nginx-iamguarded-fips/overview
...
# TODO: Implement nginx-iamguarded-fips image
throw "Image 'nginx-iamguarded-fips' is not yet implemented"
