...
# Image: plugin-barman-cloud-fips-sidecar
# Reference: https://images.chainguard.dev/directory/image/plugin-barman-cloud-fips-sidecar/overview
...
#   plugin-barman-cloud-fips (0.9.0-r0)
#   plugin-barman-cloud-sidecar-fips (0.9.0-r0)
...
# TODO: Implement plugin-barman-cloud-fips-sidecar image
throw "Image 'plugin-barman-cloud-fips-sidecar' is not yet implemented"
