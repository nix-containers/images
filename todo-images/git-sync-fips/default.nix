...
# Image: git-sync-fips
# Reference: https://images.chainguard.dev/directory/image/git-sync-fips/overview
...
# TODO: Implement git-sync-fips image
throw "Image 'git-sync-fips' is not yet implemented"
