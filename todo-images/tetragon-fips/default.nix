...
# Image: tetragon-fips
# Reference: https://images.chainguard.dev/directory/image/tetragon-fips/overview
...
#   tetra-fips (1.6.0-r1)
#   tetragon-bash-completion-fips (1.6.0-r1)
#   tetragon-fips (1.6.0-r1)
#   xtables (1.8.11-r29)

# TODO: Implement tetragon-fips image
throw "Image 'tetragon-fips' is not yet implemented"
