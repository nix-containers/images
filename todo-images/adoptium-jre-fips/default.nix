...
# Image: adoptium-jre-fips
# Reference: https://images.chainguard.dev/directory/image/adoptium-jre-fips/overview
...
# TODO: Implement adoptium-jre-fips image
throw "Image 'adoptium-jre-fips' is not yet implemented"
