...
# Image: mesosphere-vsphere-csi-driver
# Reference: https://images.chainguard.dev/directory/image/mesosphere-vsphere-csi-driver/overview
...
#   mesosphere-vsphere-csi-driver (3.5.0-r4)
...
# TODO: Implement mesosphere-vsphere-csi-driver image
throw "Image 'mesosphere-vsphere-csi-driver' is not yet implemented"
...
#
#   labels = {
#     "org.opencontainers.image.title" = "mesosphere-vsphere-csi-driver";
