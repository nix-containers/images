...
# Image: kibana-iamguarded-fips
# Reference: https://images.chainguard.dev/directory/image/kibana-iamguarded-fips/overview
...
# TODO: Implement kibana-iamguarded-fips image
throw "Image 'kibana-iamguarded-fips' is not yet implemented"
