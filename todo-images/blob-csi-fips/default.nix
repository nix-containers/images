...
# Image: blob-csi-fips
# Reference: https://images.chainguard.dev/directory/image/blob-csi-fips/overview
...
#   azcopy-fips (10.31.0-r2)
#   aznfs-mount (2.0.12-r4)
#   blob-csi-fips-1.27 (1.27.0-r2)
...
# TODO: Implement blob-csi-fips image
throw "Image 'blob-csi-fips' is not yet implemented"

# Suggested implementation:
# buildCLIImage {
#   drv = pkgs.bind;
#   name = "blob-csi-fips";
#   tag = "v${pkgs.bind.version}";
#   entrypoint = [ "${pkgs.bind}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "0";
#
#   labels = {
#     "org.opencontainers.image.title" = "blob-csi-fips";
