...
# Image: vllm-openai-fips
# Reference: https://images.chainguard.dev/directory/image/vllm-openai-fips/overview
...
# TODO: Implement vllm-openai-fips image
throw "Image 'vllm-openai-fips' is not yet implemented"
