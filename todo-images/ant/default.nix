...
# Image: ant
# Reference: https://images.chainguard.dev/directory/image/ant/overview

# Packages available in nixpkgs:
#   pkgs.alsa-lib  # alsa-lib (1.2.14-r2)
#   pkgs.ant  # ant (1.10.15-r3)
...
#   pkgs.openjdk  # openjdk-25 (25.0.1-r0)
...
#   libcrypt1 (2.42-r4)
#   libcrypto3 (3.6.0-r4)
#   openjdk-25-default-jdk (25.0.1-r0)
#   p11-kit-trust (0.25.10-r0)
#   ttf-dejavu (2.37-r7)

# TODO: Implement ant image
throw "Image 'ant' is not yet implemented"
...
#   entrypoint = [ "${pkgs.ant}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "65532";
#
#   labels = {
#     "org.opencontainers.image.title" = "ant";
