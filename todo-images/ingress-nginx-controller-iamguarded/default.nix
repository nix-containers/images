...
# Image: ingress-nginx-controller-iamguarded
# Reference: https://images.chainguard.dev/directory/image/ingress-nginx-controller-iamguarded/overview
...
#   ingress-nginx-controller-1.14 (1.14.1-r0)
...
# TODO: Implement ingress-nginx-controller-iamguarded image
throw "Image 'ingress-nginx-controller-iamguarded' is not yet implemented"
