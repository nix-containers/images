...
# Image: sonobuoy-systemd-logs
# Reference: https://images.chainguard.dev/directory/image/sonobuoy-systemd-logs/overview
...
#   quota-tools (4.10-r1)
#   sonobuoy-systemd-logs (0.4.0-r2)
#   sqlite-libs (3.51.1-r0)
#   systemd-boot (258.2-r3)
#   systemd-systemctl (258.2-r3)

# TODO: Implement sonobuoy-systemd-logs image
throw "Image 'sonobuoy-systemd-logs' is not yet implemented"
...
#
#   labels = {
#     "org.opencontainers.image.title" = "sonobuoy-systemd-logs";
