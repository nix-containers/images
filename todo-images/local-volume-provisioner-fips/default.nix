...
# Image: local-volume-provisioner-fips
# Reference: https://images.chainguard.dev/directory/image/local-volume-provisioner-fips/overview
...
#   libsepol-dev (3.9-r1)
#   local-static-provisioner-fips (2.8.0-r6)
...
# TODO: Implement local-volume-provisioner-fips image
throw "Image 'local-volume-provisioner-fips' is not yet implemented"
