...
# Reference: https://images.chainguard.dev/directory/image/selenium-session-queue/overview
...
#   docker-selenium-session-queue (4.38.0.20251101-r0)
...
# TODO: Implement selenium-session-queue image
throw "Image 'selenium-session-queue' is not yet implemented"
