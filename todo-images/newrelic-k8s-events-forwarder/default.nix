...
# Image: newrelic-k8s-events-forwarder
# Reference: https://images.chainguard.dev/directory/image/newrelic-k8s-events-forwarder/overview
...
# TODO: Implement newrelic-k8s-events-forwarder image
throw "Image 'newrelic-k8s-events-forwarder' is not yet implemented"
