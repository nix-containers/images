...
# Image: kibana-iamguarded
# Reference: https://images.chainguard.dev/directory/image/kibana-iamguarded/overview
...
#   kibana-9.2-iamguarded (9.2.2-r1)
#   krb5-conf (1.0-r7)
#   krb5-libs (1.22.1-r1)
#   ld-linux (2.42-r4)
#   libacl1 (2.3.2-r54)
...
# TODO: Implement kibana-iamguarded image
throw "Image 'kibana-iamguarded' is not yet implemented"
