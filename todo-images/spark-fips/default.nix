...
# Image: spark-fips
# Reference: https://images.chainguard.dev/directory/image/spark-fips/overview
...
#   spark-fips-3.5-scala-2.13 (3.5.4-r17)
#   sqlite-libs (3.51.1-r0)
#   ttf-dejavu (2.37-r7)

# TODO: Implement spark-fips image
throw "Image 'spark-fips' is not yet implemented"
