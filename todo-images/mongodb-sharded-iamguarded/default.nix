...
# Image: mongodb-sharded-iamguarded
# Reference: https://images.chainguard.dev/directory/image/mongodb-sharded-iamguarded/overview
...
#   pkgs.mongosh  # mongosh (2.5.10-r0)
...
#   libssl3 (3.6.0-r4)
#   libstdc++ (15.2.0-r6)
#   mongo-tools (100.13.0-r5)
#   mongod-8.0 (8.0.12-r1)
#   mongos-8.0 (8.0.12-r1)
...
# TODO: Implement mongodb-sharded-iamguarded image
throw "Image 'mongodb-sharded-iamguarded' is not yet implemented"
