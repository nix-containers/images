...
# Image: trino
# Reference: https://images.chainguard.dev/directory/image/trino/overview
...
#   trino-config (478-r3)
#   trino-oci-entrypoint (478-r3)
#   trino-plugin-exchange-filesystem (478-r3)
#   trino-plugin-jmx (478-r3)
#   trino-plugin-memory (478-r3)
#   trino-plugin-tpcds (478-r3)
#   trino-plugin-tpch (478-r3)
#   ttf-dejavu (2.37-r7)

# TODO: Implement trino image
throw "Image 'trino' is not yet implemented"

# Suggested implementation:
# buildCLIImage {
#   drv = pkgs.trino-cli;
#   name = "trino";
#   tag = "v${pkgs.trino-cli.version}";
#   entrypoint = [ "${pkgs.trino-cli}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "65532";
#
#   labels = {
