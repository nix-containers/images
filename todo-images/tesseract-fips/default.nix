...
# Image: tesseract-fips
# Reference: https://images.chainguard.dev/directory/image/tesseract-fips/overview
...
# TODO: Implement tesseract-fips image
throw "Image 'tesseract-fips' is not yet implemented"
