...
# Image: calico-node
# Reference: https://images.chainguard.dev/directory/image/calico-node/overview
...
# TODO: Implement calico-node image
throw "Image 'calico-node' is not yet implemented"
