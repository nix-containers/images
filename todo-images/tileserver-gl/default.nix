...
# Image: tileserver-gl
# Reference: https://images.chainguard.dev/directory/image/tileserver-gl/overview
...
#   tiff (4.7.1-r0)
#   tileserver-gl (5.4.0-r5)
#   wayland-libs-client (1.24.0-r2)
#   wayland-libs-egl (1.24.0-r2)
#   xkbcomp (1.5.0-r0)

# TODO: Implement tileserver-gl image
throw "Image 'tileserver-gl' is not yet implemented"
