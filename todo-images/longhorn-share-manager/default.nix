...
# Image: longhorn-share-manager
# Reference: https://images.chainguard.dev/directory/image/longhorn-share-manager/overview
...
# TODO: Implement longhorn-share-manager image
throw "Image 'longhorn-share-manager' is not yet implemented"
