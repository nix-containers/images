...
# Image: rancher-hardened-kubernetes-compat-fips
# Reference: https://images.chainguard.dev/directory/image/rancher-hardened-kubernetes-compat-fips/overview
...
#   kube-apiserver-fips-1.34 (1.34.2-r2)
#   kube-proxy-fips-1.34 (1.34.2-r2)
#   kube-scheduler-fips-1.34 (1.34.2-r2)
#   kubectl-fips-1.34 (1.34.2-r2)
#   kubelet-fips-1.34 (1.34.2-r2)
#   ld-linux (2.42-r4)
#   libcrypto3 (3.6.0-r4)
#   libstdc++ (15.2.0-r6)
#   libzstd1 (1.5.7-r5)
...
# TODO: Implement rancher-hardened-kubernetes-compat-fips image
throw "Image 'rancher-hardened-kubernetes-compat-fips' is not yet implemented"
