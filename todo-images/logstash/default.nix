...
# Image: logstash
# Reference: https://images.chainguard.dev/directory/image/logstash/overview
...
#   pkgs.logstash  # logstash-9.2 (9.2.2-r0)
...
#   logstash-9.2-env2yaml (9.2.2-r0)
#   ncurses-terminfo-base (6.5_p20251025-r1)
#   openjdk-17-default-jdk (17.0.17-r2)
#   p11-kit-trust (0.25.10-r0)
#   ttf-dejavu (2.37-r7)

# TODO: Implement logstash image
throw "Image 'logstash' is not yet implemented"
...
#   entrypoint = [ "${pkgs.logstash}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "1000";
#
#   labels = {
