...
# Image: adoptium-jdk
# Reference: https://images.chainguard.dev/directory/image/adoptium-jdk/overview
...
#   adoptium-openjdk-25 (25.0.1.8-r2)
#   adoptium-openjdk-25-default-jdk (25.0.1.8-r2)
...
# TODO: Implement adoptium-jdk image
throw "Image 'adoptium-jdk' is not yet implemented"
