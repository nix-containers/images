...
# Image: aspnet-runtime-fips
# Reference: https://images.chainguard.dev/directory/image/aspnet-runtime-fips/overview
...
# TODO: Implement aspnet-runtime-fips image
throw "Image 'aspnet-runtime-fips' is not yet implemented"
