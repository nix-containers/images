...
# Image: psqlodbc-fips
# Reference: https://images.chainguard.dev/directory/image/psqlodbc-fips/overview
...
# TODO: Implement psqlodbc-fips image
throw "Image 'psqlodbc-fips' is not yet implemented"
