...
# Reference: https://images.chainguard.dev/directory/image/selenium-router/overview
...
#   docker-selenium-router (4.38.0.20251101-r0)
...
# TODO: Implement selenium-router image
throw "Image 'selenium-router' is not yet implemented"
