...
# Image: kubeflow-volumes-web-app
# Reference: https://images.chainguard.dev/directory/image/kubeflow-volumes-web-app/overview
...
# TODO: Implement kubeflow-volumes-web-app image
throw "Image 'kubeflow-volumes-web-app' is not yet implemented"
