...
# Image: swift
# Reference: https://images.chainguard.dev/directory/image/swift/overview
...
# TODO: Implement swift image
throw "Image 'swift' is not yet implemented"
...
#   entrypoint = [ "${pkgs.swift}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "0";
#
#   labels = {
