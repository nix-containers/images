...
# Image: cass-config-builder
# Reference: https://images.chainguard.dev/directory/image/cass-config-builder/overview
...
# TODO: Implement cass-config-builder image
throw "Image 'cass-config-builder' is not yet implemented"
...
#
#   labels = {
#     "org.opencontainers.image.title" = "cass-config-builder";
