...
# Image: openresty-fips
# Reference: https://images.chainguard.dev/directory/image/openresty-fips/overview
...
# TODO: Implement openresty-fips image
throw "Image 'openresty-fips' is not yet implemented"
