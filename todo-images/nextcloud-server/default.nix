...
# Reference: https://images.chainguard.dev/directory/image/nextcloud-server/overview
...
#   php-8.3-apcu (5.1.27-r1)
#   php-8.3-apcu-config (5.1.27-r1)
...
# TODO: Implement nextcloud-server image
throw "Image 'nextcloud-server' is not yet implemented"
