...
# Image: azuredisk-csi-fips
# Reference: https://images.chainguard.dev/directory/image/azuredisk-csi-fips/overview
...
#   azuredisk-csi-fips-1.33 (1.33.7-r1)
#   blkid (2.41.2-r2)
#   blockdev (2.41.2-r2)
...
# TODO: Implement azuredisk-csi-fips image
throw "Image 'azuredisk-csi-fips' is not yet implemented"
