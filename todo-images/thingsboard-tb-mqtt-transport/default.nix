...
# Reference: https://images.chainguard.dev/directory/image/thingsboard-tb-mqtt-transport/overview
...
#   thingsboard-tb-mqtt-transport (4.2.1-r8)
#   ttf-dejavu (2.37-r7)

# TODO: Implement thingsboard-tb-mqtt-transport image
throw "Image 'thingsboard-tb-mqtt-transport' is not yet implemented"
...
#
#   labels = {
#     "org.opencontainers.image.title" = "thingsboard-tb-mqtt-transport";
