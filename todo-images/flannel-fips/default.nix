...
# Image: flannel-fips
# Reference: https://images.chainguard.dev/directory/image/flannel-fips/overview
...
#   pkgs.strongswan  # strongswan (6.0.3-r0)
#   pkgs.xz  # xz (5.8.1-r6)
#   pkgs.zlib  # zlib (1.3.1-r51)

# Packages NOT in nixpkgs (need custom derivations):
#   ca-certificates (20251003-r0)
#   flannel-fips (0.27.4-r3)
...
# TODO: Implement flannel-fips image
throw "Image 'flannel-fips' is not yet implemented"
