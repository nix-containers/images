...
# Image: jetty
# Reference: https://images.chainguard.dev/directory/image/jetty/overview
...
#   pkgs.jetty  # jetty-12.1 (12.1.5-r0)
...
# TODO: Implement jetty image
throw "Image 'jetty' is not yet implemented"
...
#   entrypoint = [ "${pkgs.jetty}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "999";
#
#   labels = {
#     "org.opencontainers.image.title" = "jetty";
