...
# Image: valkey-iamguarded-fips
# Reference: https://images.chainguard.dev/directory/image/valkey-iamguarded-fips/overview
...
# TODO: Implement valkey-iamguarded-fips image
throw "Image 'valkey-iamguarded-fips' is not yet implemented"
