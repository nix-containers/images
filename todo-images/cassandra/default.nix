...
# Image: cassandra
# Reference: https://images.chainguard.dev/directory/image/cassandra/overview

# Packages available in nixpkgs:
#   pkgs.alsa-lib  # alsa-lib (1.2.14-r2)
#   pkgs.bash  # bash (5.3-r3)
#   pkgs.busybox  # busybox (1.37.0-r50)
#   pkgs.cassandra  # cassandra-5.0 (5.0.6-r1)
...
# TODO: Implement cassandra image
throw "Image 'cassandra' is not yet implemented"
...
#   entrypoint = [ "${pkgs.cassandra}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "999";
#
#   labels = {
