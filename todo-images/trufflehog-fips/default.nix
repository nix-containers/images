...
# Image: trufflehog-fips
# Reference: https://images.chainguard.dev/directory/image/trufflehog-fips/overview
...
#   trufflehog-fips (3.91.2-r1)

# TODO: Implement trufflehog-fips image
throw "Image 'trufflehog-fips' is not yet implemented"
