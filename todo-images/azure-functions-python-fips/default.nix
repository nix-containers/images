...
# Image: azure-functions-python-fips
# Reference: https://images.chainguard.dev/directory/image/azure-functions-python-fips/overview
...
# TODO: Implement azure-functions-python-fips image
throw "Image 'azure-functions-python-fips' is not yet implemented"
