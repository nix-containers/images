...
# Image: nginx-otel-fips
# Reference: https://images.chainguard.dev/directory/image/nginx-otel-fips/overview
...
# TODO: Implement nginx-otel-fips image
throw "Image 'nginx-otel-fips' is not yet implemented"
