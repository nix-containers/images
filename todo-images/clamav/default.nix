...
# Image: clamav
# Reference: https://images.chainguard.dev/directory/image/clamav/overview

# Packages available in nixpkgs:
#   pkgs.bash  # bash (5.3-r3)
#   pkgs.busybox  # busybox (1.37.0-r50)
#   pkgs.clamav  # clamav-1.5 (1.5.1-r2)
...
#   clamav-1.5-clamdscan (1.5.1-r2)
#   clamav-1.5-daemon (1.5.1-r2)
#   clamav-1.5-db (1.5.1-r2)
#   clamav-1.5-freshclam (1.5.1-r2)
#   clamav-1.5-libunrar (1.5.1-r2)
#   clamav-1.5-milter (1.5.1-r2)
#   clamav-1.5-scanner (1.5.1-r2)
...
# TODO: Implement clamav image
throw "Image 'clamav' is not yet implemented"
