...
# Reference: https://images.chainguard.dev/directory/image/kubernetes-kube-proxy/overview
...
#   kube-proxy-1.34 (1.34.2-r3)
#   kube-proxy-1.34-default (1.34.2-r3)
#   ld-linux (2.42-r4)
#   libcrypto3 (3.6.0-r4)
#   libstdc++ (15.2.0-r6)
#   libzstd1 (1.5.7-r5)
...
# TODO: Implement kubernetes-kube-proxy image
throw "Image 'kubernetes-kube-proxy' is not yet implemented"
