...
# Image: nats-box-fips
# Reference: https://images.chainguard.dev/directory/image/nats-box-fips/overview
...
# TODO: Implement nats-box-fips image
throw "Image 'nats-box-fips' is not yet implemented"
