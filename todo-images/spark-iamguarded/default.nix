...
# Image: spark-iamguarded
# Reference: https://images.chainguard.dev/directory/image/spark-iamguarded/overview
...
#   spark-3.5-scala-2.12 (3.5.7-r3)
#   sqlite-libs (3.51.1-r0)
#   ttf-dejavu (2.37-r7)

# TODO: Implement spark-iamguarded image
throw "Image 'spark-iamguarded' is not yet implemented"
