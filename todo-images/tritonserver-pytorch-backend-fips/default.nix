...
# Image: tritonserver-pytorch-backend-fips
# Reference: https://images.chainguard.dev/directory/image/tritonserver-pytorch-backend-fips/overview
...
#   libssl3 (3.6.0-r4)
#   libstdc++ (15.2.0-r6)
#   libtorch-cuda-13.0 (2.9.1-r2)
#   libtorch-tensorrt-cuda-13.0 (2.9.0-r0)
#   libzstd1 (1.5.7-r5)
...
#   nvidia-libcufile-13.0 (1.15.0.42-r0)
...
#   triton-inference-server-local-cache (25.11_git20251126-r0)
#   tritonserver-backend-python-cuda-13.0 (25.11-r0)
#   tritonserver-backend-pytorch-cuda-13.0 (25.11-r0)
#   tritonserver-cuda-13.0 (2.63.0-r2)

# TODO: Implement tritonserver-pytorch-backend-fips image
throw "Image 'tritonserver-pytorch-backend-fips' is not yet implemented"
