...
# Image: keycloak-config-cli
# Reference: https://images.chainguard.dev/directory/image/keycloak-config-cli/overview
...
# TODO: Implement keycloak-config-cli image
throw "Image 'keycloak-config-cli' is not yet implemented"
