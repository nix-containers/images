...
# Image: kubeflow-pipelines-visualization-server
# Reference: https://images.chainguard.dev/directory/image/kubeflow-pipelines-visualization-server/overview
...
#   kubeflow-pipelines-visualization-server (2.15.0-r0)
#   ld-linux (2.42-r4)
#   libbz2-1 (1.0.8-r21)
#   libcrypt1 (2.42-r4)
#   libcrypto3 (3.6.0-r4)
...
# TODO: Implement kubeflow-pipelines-visualization-server image
throw "Image 'kubeflow-pipelines-visualization-server' is not yet implemented"
