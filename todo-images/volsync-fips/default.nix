...
# Image: volsync-fips
# Reference: https://images.chainguard.dev/directory/image/volsync-fips/overview
...
#   syncthing-fips (2.0.12-r1)
#   volsync-fips (0.14.0-r1)
#   volsync-fips-diskrsync-tcp (0.14.0-r1)
#   xxhash-libs (0.8.3-r3)

# TODO: Implement volsync-fips image
throw "Image 'volsync-fips' is not yet implemented"
...
#
#   labels = {
#     "org.opencontainers.image.title" = "volsync-fips";
