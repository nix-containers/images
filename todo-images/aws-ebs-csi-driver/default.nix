...
# Reference: https://images.chainguard.dev/directory/image/aws-ebs-csi-driver/overview
...
#   aws-ebs-csi-driver-1.53 (1.53.0-r1)
#   blkid (2.41.2-r2)
#   blockdev (2.41.2-r2)
...
# TODO: Implement aws-ebs-csi-driver image
throw "Image 'aws-ebs-csi-driver' is not yet implemented"
