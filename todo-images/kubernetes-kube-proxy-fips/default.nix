...
# Image: kubernetes-kube-proxy-fips
# Reference: https://images.chainguard.dev/directory/image/kubernetes-kube-proxy-fips/overview
...
#   kube-proxy-fips-1.34 (1.34.2-r1)
#   kube-proxy-fips-1.34-default (1.34.2-r1)
#   ld-linux (2.42-r4)
#   libcrypto3 (3.6.0-r4)
#   libstdc++ (15.2.0-r6)
#   libzstd1 (1.5.7-r5)
...
# TODO: Implement kubernetes-kube-proxy-fips image
throw "Image 'kubernetes-kube-proxy-fips' is not yet implemented"
