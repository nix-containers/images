...
# Image: postgres-cloudnative-pg
# Reference: https://images.chainguard.dev/directory/image/postgres-cloudnative-pg/overview
...
# TODO: Implement postgres-cloudnative-pg image
throw "Image 'postgres-cloudnative-pg' is not yet implemented"
