...
# Image: camunda-keycloak-fips
# Reference: https://images.chainguard.dev/directory/image/camunda-keycloak-fips/overview
...
#   openjdk-bcfips-policy-140-3-j21 (1-r26)
...
# TODO: Implement camunda-keycloak-fips image
throw "Image 'camunda-keycloak-fips' is not yet implemented"
