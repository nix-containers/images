...
# Image: arangodb-fips
# Reference: https://images.chainguard.dev/directory/image/arangodb-fips/overview
...
# TODO: Implement arangodb-fips image
throw "Image 'arangodb-fips' is not yet implemented"
...
#
#   labels = {
#     "org.opencontainers.image.title" = "arangodb-fips";
