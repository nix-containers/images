...
# Image: druid
# Reference: https://images.chainguard.dev/directory/image/druid/overview

# Packages available in nixpkgs:
#   pkgs.alsa-lib  # alsa-lib (1.2.14-r2)
#   pkgs.bash  # bash (5.3-r3)
#   pkgs.busybox  # busybox (1.37.0-r50)
#   pkgs.druid  # druid (35.0.0-r0)
...
# TODO: Implement druid image
throw "Image 'druid' is not yet implemented"
...
#   entrypoint = [ "${pkgs.druid}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "65532";
#
#   labels = {
#     "org.opencontainers.image.title" = "druid";
