...
# Reference: https://images.chainguard.dev/directory/image/keycloak-operator/overview
...
#   keycloak-26.4-operator (26.4.7-r0)
#   ld-linux (2.42-r4)
...
# TODO: Implement keycloak-operator image
throw "Image 'keycloak-operator' is not yet implemented"
