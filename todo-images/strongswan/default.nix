...
# Image: strongswan
# Reference: https://images.chainguard.dev/directory/image/strongswan/overview
...
# TODO: Implement strongswan image
throw "Image 'strongswan' is not yet implemented"
...
#   entrypoint = [ "${pkgs.strongswan}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "65532";
#
#   labels = {
