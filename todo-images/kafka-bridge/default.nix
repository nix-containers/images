...
# Image: kafka-bridge
# Reference: https://images.chainguard.dev/directory/image/kafka-bridge/overview
...
# TODO: Implement kafka-bridge image
throw "Image 'kafka-bridge' is not yet implemented"
