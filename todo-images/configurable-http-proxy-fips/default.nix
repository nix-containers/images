...
# Image: configurable-http-proxy-fips
# Reference: https://images.chainguard.dev/directory/image/configurable-http-proxy-fips/overview
...
# TODO: Implement configurable-http-proxy-fips image
throw "Image 'configurable-http-proxy-fips' is not yet implemented"
