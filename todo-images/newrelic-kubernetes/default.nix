...
# Image: newrelic-kubernetes
# Reference: https://images.chainguard.dev/directory/image/newrelic-kubernetes/overview
...
# TODO: Implement newrelic-kubernetes image
throw "Image 'newrelic-kubernetes' is not yet implemented"
