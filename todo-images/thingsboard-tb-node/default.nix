...
# Reference: https://images.chainguard.dev/directory/image/thingsboard-tb-node/overview
...
#   thingsboard-tb-node (4.2.1-r8)
#   ttf-dejavu (2.37-r7)

# TODO: Implement thingsboard-tb-node image
throw "Image 'thingsboard-tb-node' is not yet implemented"
...
#
#   labels = {
#     "org.opencontainers.image.title" = "thingsboard-tb-node";
