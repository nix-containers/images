...
# Image: go-fips
# Reference: https://images.chainguard.dev/directory/image/go-fips/overview
...
# TODO: Implement go-fips image
throw "Image 'go-fips' is not yet implemented"
