...
# Image: tetragon
# Reference: https://images.chainguard.dev/directory/image/tetragon/overview
...
#   pkgs.tetragon  # tetragon (1.6.0-r1)
#   pkgs.xz  # xz (5.8.1-r6)
...
#   tetra (1.6.0-r1)
#   tetragon-bash-completion (1.6.0-r1)
#   xtables (1.8.11-r29)

# TODO: Implement tetragon image
throw "Image 'tetragon' is not yet implemented"
...
#   entrypoint = [ "${pkgs.tetragon}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "0";
#
#   labels = {
