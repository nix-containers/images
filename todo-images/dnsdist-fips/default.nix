...
# Image: dnsdist-fips
# Reference: https://images.chainguard.dev/directory/image/dnsdist-fips/overview
...
#   dnsdist-2.0-nodnscrypt (2.0.2-r0)
...
# TODO: Implement dnsdist-fips image
throw "Image 'dnsdist-fips' is not yet implemented"
