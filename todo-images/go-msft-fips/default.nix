...
# Image: go-msft-fips
# Reference: https://images.chainguard.dev/directory/image/go-msft-fips/overview
...
# TODO: Implement go-msft-fips image
throw "Image 'go-msft-fips' is not yet implemented"
