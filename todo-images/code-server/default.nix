...
# Image: code-server
# Reference: https://images.chainguard.dev/directory/image/code-server/overview
...
# TODO: Implement code-server image
throw "Image 'code-server' is not yet implemented"
...
#   entrypoint = [ "${pkgs.code-server}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "1000";
#
#   labels = {
