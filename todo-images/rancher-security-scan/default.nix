...
# Image: rancher-security-scan
# Reference: https://images.chainguard.dev/directory/image/rancher-security-scan/overview
...
#   quota-tools (4.10-r1)
#   rancher-security-scan-0.6 (0.6.5-r0)
#   sqlite-libs (3.51.1-r0)
#   systemd-boot (258.2-r3)
#   systemd-systemctl (258.2-r3)

# TODO: Implement rancher-security-scan image
throw "Image 'rancher-security-scan' is not yet implemented"
