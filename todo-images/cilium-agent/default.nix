...
#   bpftool (7.6.0-r0)
#   cilium-1.18-container-init (1.18.4-r2)
...
# TODO: Implement cilium-agent image
throw "Image 'cilium-agent' is not yet implemented"
