...
# Image: sbt
# Reference: https://images.chainguard.dev/directory/image/sbt/overview
...
# TODO: Implement sbt image
throw "Image 'sbt' is not yet implemented"
...
#   entrypoint = [ "${pkgs.sbt}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "65532";
#
#   labels = {
