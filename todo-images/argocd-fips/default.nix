...
# Image: argocd-fips
# Reference: https://images.chainguard.dev/directory/image/argocd-fips/overview
...
# TODO: Implement argocd-fips image
throw "Image 'argocd-fips' is not yet implemented"
