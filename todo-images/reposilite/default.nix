...
# Image: reposilite
# Reference: https://images.chainguard.dev/directory/image/reposilite/overview
...
#   pkgs.reposilite  # reposilite (3.5.26-r0)
...
# TODO: Implement reposilite image
throw "Image 'reposilite' is not yet implemented"
...
#   entrypoint = [ "${pkgs.reposilite}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "977";
#
#   labels = {
