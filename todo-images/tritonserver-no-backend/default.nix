...
# Image: tritonserver-no-backend
# Reference: https://images.chainguard.dev/directory/image/tritonserver-no-backend/overview
...
# TODO: Implement tritonserver-no-backend image
throw "Image 'tritonserver-no-backend' is not yet implemented"
...
#
#   labels = {
#     "org.opencontainers.image.title" = "tritonserver-no-backend";
