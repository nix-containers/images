...
# Reference: https://images.chainguard.dev/directory/image/percona-server/overview
...
#   pkgs.percona-server  # percona-server-9.1 (9.1.0.1-r9)
...
#   percona-server-9.1-oci-entrypoint (9.1.0.1-r9)
#   sqlite-libs (3.51.1-r0)

# TODO: Implement percona-server image
throw "Image 'percona-server' is not yet implemented"
...
#   entrypoint = [ "${pkgs.percona-server}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "65532";
#
#   labels = {
