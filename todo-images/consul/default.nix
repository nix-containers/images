...
# Image: consul
# Reference: https://images.chainguard.dev/directory/image/consul/overview
...
# TODO: Implement consul image
throw "Image 'consul' is not yet implemented"
...
#   entrypoint = [ "${pkgs.consul}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "0";
#
#   labels = {
