...
# Image: strimzi-kafka-operator
# Reference: https://images.chainguard.dev/directory/image/strimzi-kafka-operator/overview
...
#   strimzi-kafka-operator (0.49.1-r0)
#   strimzi-kafka-operator-cluster-operator (0.49.1-r0)
#   strimzi-kafka-operator-kafka-init (0.49.1-r0)
#   strimzi-kafka-operator-topic-operator (0.49.1-r0)
#   strimzi-kafka-operator-user-operator (0.49.1-r0)
#   ttf-dejavu (2.37-r7)

# TODO: Implement strimzi-kafka-operator image
throw "Image 'strimzi-kafka-operator' is not yet implemented"
