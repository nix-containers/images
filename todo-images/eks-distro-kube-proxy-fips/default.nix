...
# Image: eks-distro-kube-proxy-fips
# Reference: https://images.chainguard.dev/directory/image/eks-distro-kube-proxy-fips/overview
...
#   eks-distro-kube-proxy-fips-1.34 (1.34.11-r0)
...
# TODO: Implement eks-distro-kube-proxy-fips image
throw "Image 'eks-distro-kube-proxy-fips' is not yet implemented"
...
#
#   labels = {
#     "org.opencontainers.image.title" = "eks-distro-kube-proxy-fips";
