...
# Image: k3s
# Reference: https://images.chainguard.dev/directory/image/k3s/overview
...
#   containerd-shim-runc-v2-1 (1.7.29-r3)
...
# TODO: Implement k3s image
throw "Image 'k3s' is not yet implemented"
...
#   entrypoint = [ "${pkgs.k3s}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "—";
#
#   labels = {
