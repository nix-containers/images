...
# Reference: https://images.chainguard.dev/directory/image/nginx-s3-gateway/overview
...
# TODO: Implement nginx-s3-gateway image
throw "Image 'nginx-s3-gateway' is not yet implemented"
