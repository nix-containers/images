...
# Image: wiremock
# Reference: https://images.chainguard.dev/directory/image/wiremock/overview
...
#   pkgs.wiremock  # wiremock (3.13.2-r0)
...
#   ttf-dejavu (2.37-r7)
#   wiremock-oci-entrypoint (3.13.2.1-r0)

# TODO: Implement wiremock image
throw "Image 'wiremock' is not yet implemented"
...
#   entrypoint = [ "${pkgs.wiremock}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "65532";
#
#   labels = {
