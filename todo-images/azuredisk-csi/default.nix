...
# Image: azuredisk-csi
# Reference: https://images.chainguard.dev/directory/image/azuredisk-csi/overview
...
# TODO: Implement azuredisk-csi image
throw "Image 'azuredisk-csi' is not yet implemented"
