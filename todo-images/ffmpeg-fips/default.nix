...
# Image: ffmpeg-fips
# Reference: https://images.chainguard.dev/directory/image/ffmpeg-fips/overview
...
# TODO: Implement ffmpeg-fips image
throw "Image 'ffmpeg-fips' is not yet implemented"
