...
# Image: postgres-iamguarded
# Reference: https://images.chainguard.dev/directory/image/postgres-iamguarded/overview
...
# TODO: Implement postgres-iamguarded image
throw "Image 'postgres-iamguarded' is not yet implemented"
