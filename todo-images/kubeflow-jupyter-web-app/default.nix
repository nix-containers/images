...
# Image: kubeflow-jupyter-web-app
# Reference: https://images.chainguard.dev/directory/image/kubeflow-jupyter-web-app/overview
...
# TODO: Implement kubeflow-jupyter-web-app image
throw "Image 'kubeflow-jupyter-web-app' is not yet implemented"
