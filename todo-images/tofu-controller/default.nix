...
# Image: tofu-controller
# Reference: https://images.chainguard.dev/directory/image/tofu-controller/overview
...
#   tofu-controller (0.16.0_rc5-r8)

# TODO: Implement tofu-controller image
throw "Image 'tofu-controller' is not yet implemented"
