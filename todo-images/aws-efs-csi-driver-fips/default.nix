...
# Image: aws-efs-csi-driver-fips
# Reference: https://images.chainguard.dev/directory/image/aws-efs-csi-driver-fips/overview
...
#   aws-efs-csi-driver-fips (2.1.15-r0)
#   dbus-libs (1.16.2-r5)
#   device-mapper-libs (2.03.37-r0)
#   e2fsprogs-libs (1.47.3-r1)
#   efs-utils-for-aws-csi-driver (2.4.1-r1)
...
# TODO: Implement aws-efs-csi-driver-fips image
throw "Image 'aws-efs-csi-driver-fips' is not yet implemented"
