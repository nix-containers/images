...
# Reference: https://images.chainguard.dev/directory/image/selenium-standalone-firefox/overview
...
#   pkgs.selenium-server-standalone  # selenium-server-standalone (4.38.0-r0)
...
#   docker-selenium-standalone (4.38.0.20251101-r0)
#   docker-selenium-standalone-firefox (4.38.0.20251101-r0)
...
# TODO: Implement selenium-standalone-firefox image
throw "Image 'selenium-standalone-firefox' is not yet implemented"
