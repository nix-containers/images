...
# Image: keycloak-config-cli-iamguarded-fips
# Reference: https://images.chainguard.dev/directory/image/keycloak-config-cli-iamguarded-fips/overview
...
#   openjdk-bcfips-policy-140-3-j21 (1-r27)
...
# TODO: Implement keycloak-config-cli-iamguarded-fips image
throw "Image 'keycloak-config-cli-iamguarded-fips' is not yet implemented"
...
#
#   labels = {
#     "org.opencontainers.image.title" = "keycloak-config-cli-iamguarded-fips";
