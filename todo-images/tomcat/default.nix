...
# Image: tomcat
# Reference: https://images.chainguard.dev/directory/image/tomcat/overview
...
#   tomcat-11.0-openjdk-21 (11.0.15-r0)
#   ttf-dejavu (2.37-r7)

# TODO: Implement tomcat image
throw "Image 'tomcat' is not yet implemented"

# Suggested implementation:
# buildCLIImage {
#   drv = pkgs.tomcat-native;
#   name = "tomcat";
#   tag = "v${pkgs.tomcat-native.version}";
#   entrypoint = [ "${pkgs.tomcat-native}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "65532";
#
#   labels = {
