...
# Image: keycloak-fips
# Reference: https://images.chainguard.dev/directory/image/keycloak-fips/overview
...
# TODO: Implement keycloak-fips image
throw "Image 'keycloak-fips' is not yet implemented"
