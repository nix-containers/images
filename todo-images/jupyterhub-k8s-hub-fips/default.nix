...
# Image: jupyterhub-k8s-hub-fips
# Reference: https://images.chainguard.dev/directory/image/jupyterhub-k8s-hub-fips/overview
...
# TODO: Implement jupyterhub-k8s-hub-fips image
throw "Image 'jupyterhub-k8s-hub-fips' is not yet implemented"
