...
# Reference: https://images.chainguard.dev/directory/image/kserve-modelmesh/overview
...
# TODO: Implement kserve-modelmesh image
throw "Image 'kserve-modelmesh' is not yet implemented"
