...
# Image: argocd-repo-server-fips
# Reference: https://images.chainguard.dev/directory/image/argocd-repo-server-fips/overview
...
#   argo-cd-fips-3.2-repo-server (3.2.1-r0)
...
# TODO: Implement argocd-repo-server-fips image
throw "Image 'argocd-repo-server-fips' is not yet implemented"
