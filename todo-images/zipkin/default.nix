...
# Image: zipkin
# Reference: https://images.chainguard.dev/directory/image/zipkin/overview
...
#   ttf-dejavu (2.37-r7)
#   zipkin-oci-entrypoint (3.5.1-r8)

# TODO: Implement zipkin image
throw "Image 'zipkin' is not yet implemented"
...
#   entrypoint = [ "${pkgs.zipkin}/bin/BINARY" ];
#   cmd = [ "--help" ];
#   user = "1000";
#
#   labels = {
