...
# Image: etcd-iamguarded-fips
# Reference: https://images.chainguard.dev/directory/image/etcd-iamguarded-fips/overview
...
# TODO: Implement etcd-iamguarded-fips image
throw "Image 'etcd-iamguarded-fips' is not yet implemented"
