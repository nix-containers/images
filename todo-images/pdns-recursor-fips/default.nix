...
# Image: pdns-recursor-fips
# Reference: https://images.chainguard.dev/directory/image/pdns-recursor-fips/overview
...
#   pdns-5.2-recursor-nosodium (5.2.6-r0)
...
# TODO: Implement pdns-recursor-fips image
throw "Image 'pdns-recursor-fips' is not yet implemented"
