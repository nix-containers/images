...
# Reference: https://images.chainguard.dev/directory/image/nfs-subdir-external-provisioner/overview
...
#   nfs-subdir-external-provisioner (4.0.18-r27)
#   py3-pip-wheel (25.3-r2)
#   python-3.13-base (3.13.10-r0)
#   sqlite-libs (3.51.1-r0)

# TODO: Implement nfs-subdir-external-provisioner image
throw "Image 'nfs-subdir-external-provisioner' is not yet implemented"
...
#
#   labels = {
#     "org.opencontainers.image.title" = "nfs-subdir-external-provisioner";
