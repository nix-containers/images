...
# Image: rstudio-fips
# Reference: https://images.chainguard.dev/directory/image/rstudio-fips/overview
...
#   pkgs.rstudio  # rstudio (2025.09.2_p418-r0)
...
#   xz-dev (5.8.1-r6)
#   yaml-cpp-dev (0.8.0-r10)
#   zlib-dev (1.3.1-r51)

# TODO: Implement rstudio-fips image
throw "Image 'rstudio-fips' is not yet implemented"
