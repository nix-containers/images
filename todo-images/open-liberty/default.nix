...
# Image: open-liberty
# Reference: https://images.chainguard.dev/directory/image/open-liberty/overview
...
#   open-liberty-kernel (25.0.0.11-r1)
#   openjdk-8-openj9 (0.56.0-r0)
#   openjdk-8-openj9-default-jdk (0.56.0-r0)
#   p11-kit-trust (0.25.10-r0)

# TODO: Implement open-liberty image
throw "Image 'open-liberty' is not yet implemented"
