...
# Image: pytorch-fips
# Reference: https://images.chainguard.dev/directory/image/pytorch-fips/overview
...
#   nvidia-cuda-ld-config-12.8 (1-r8)
...
# TODO: Implement pytorch-fips image
throw "Image 'pytorch-fips' is not yet implemented"
...
#
#   labels = {
#     "org.opencontainers.image.title" = "pytorch-fips";
