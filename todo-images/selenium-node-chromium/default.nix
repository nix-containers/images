...
# Reference: https://images.chainguard.dev/directory/image/selenium-node-chromium/overview
...
# TODO: Implement selenium-node-chromium image
throw "Image 'selenium-node-chromium' is not yet implemented"
