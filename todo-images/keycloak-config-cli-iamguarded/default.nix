...
# Image: keycloak-config-cli-iamguarded
# Reference: https://images.chainguard.dev/directory/image/keycloak-config-cli-iamguarded/overview
...
# TODO: Implement keycloak-config-cli-iamguarded image
throw "Image 'keycloak-config-cli-iamguarded' is not yet implemented"
