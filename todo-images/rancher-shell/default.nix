...
# Image: rancher-shell
# Reference: https://images.chainguard.dev/directory/image/rancher-shell/overview
...
#   kubectl-bash-completion-1.34 (1.34.2-r1)
#   ld-linux (2.42-r4)
...
#   rancher-shell-0.5 (0.5.1-r0)
#   sqlite-libs (3.51.1-r0)

# TODO: Implement rancher-shell image
throw "Image 'rancher-shell' is not yet implemented"
