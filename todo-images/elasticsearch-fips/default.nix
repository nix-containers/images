...
# Image: elasticsearch-fips
# Reference: https://images.chainguard.dev/directory/image/elasticsearch-fips/overview
...
#   elasticsearch-fips-9.2 (9.2.2-r1)
#   elasticsearch-fips-9.2-config (9.2.2-r1)
...
# TODO: Implement elasticsearch-fips image
throw "Image 'elasticsearch-fips' is not yet implemented"
...
#
#   labels = {
#     "org.opencontainers.image.title" = "elasticsearch-fips";
