...
# Image: git-iamguarded
# Reference: https://images.chainguard.dev/directory/image/git-iamguarded/overview
...
# TODO: Implement git-iamguarded image
throw "Image 'git-iamguarded' is not yet implemented"
