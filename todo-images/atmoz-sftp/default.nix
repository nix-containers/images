...
# Image: atmoz-sftp
# Reference: https://images.chainguard.dev/directory/image/atmoz-sftp/overview
...
#   atmoz-sftp (0.0.0_git20251207-r0)
#   ld-linux (2.42-r4)
#   libacl1 (2.3.2-r54)
#   libattr1 (2.5.2-r54)
#   libaudit (4.1.2-r1)
...
# TODO: Implement atmoz-sftp image
throw "Image 'atmoz-sftp' is not yet implemented"
