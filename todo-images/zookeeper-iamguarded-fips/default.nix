...
# Image: zookeeper-iamguarded-fips
# Reference: https://images.chainguard.dev/directory/image/zookeeper-iamguarded-fips/overview
...
#   zookeeper-fips-3.9 (3.9.4.2-r2)

# TODO: Implement zookeeper-iamguarded-fips image
throw "Image 'zookeeper-iamguarded-fips' is not yet implemented"
...
#
#   labels = {
#     "org.opencontainers.image.title" = "zookeeper-iamguarded-fips";
