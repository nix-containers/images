...
# nix-containers Secure Images Helm chart for Apache Spark
...
```console
helm install my-release oci://registry-1.docker.io/nix-containerscharts/spark
```
...
This chart bootstraps an [Apache Spark](https://github.com/nix-containers/containers/tree/main/nix-containers/spark) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
$ ./bin/spark-submit \
    ...
    --conf spark.kubernetes.container.image=nix-containers/spark:3 \
...
- Spark container images are updated to use Hadoop `3.2.x`: [Notable Changes: 3.0.0-debian-10-r44](https://github.com/nix-containers/containers/tree/main/nix-containers/spark#300-debian-10-r44)
