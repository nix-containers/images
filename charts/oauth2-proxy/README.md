...
# nix-containers Secure Images Helm chart for OAuth2 Proxy
...
```console
helm install my-release oci://registry-1.docker.io/nix-containerscharts/oauth2-proxy
```
...
The [nix-containers OAuth2 Proxy](https://github.com/nix-containers/containers/tree/main/nix-containers/oauth2-proxy) image stores the OAuth2 Proxy data and configurations at the `/nix-containers` path of the container. Persistent Volume Claims are used to keep the data across deployments.
...
The above parameters map to the env variables defined in [nix-containers/oauth2-proxy](https://github.com/nix-containers/containers/tree/main/nix-containers/oauth2-proxy). For more information please refer to the [nix-containers/oauth2-proxy](https://github.com/nix-containers/containers/tree/main/nix-containers/oauth2-proxy) image documentation.
...
This major update the Redis&reg; subchart to its newest major, 16.0.0. [Here](https://github.com/nix-containers/images you can find more info about the specific changes.
