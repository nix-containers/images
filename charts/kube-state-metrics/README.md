...
# nix-containers Secure Images Helm chart for Kube State Metrics
...
```console
helm install my-release oci://registry-1.docker.io/nix-containerscharts/kube-state-metrics
```
...
This chart bootstraps [kube-state-metrics](https://github.com/nix-containers/containers/tree/main/nix-containers/kube-state-metrics) on [Kubernetes](https://kubernetes.io) using the [Helm](https://helm.sh) package manager.
