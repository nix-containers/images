...
# nix-containers Secure Images Helm chart for Kubernetes Event Exporter
...
```console
helm install my-release oci://registry-1.docker.io/nix-containerscharts/kubernetes-event-exporter
```
