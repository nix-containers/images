...
postgresql-ha: LDAP
    ...
    $ helm install {{ .Release.Name }} oci://registry-1.docker.io/nix-containerscharts/postgresql-ha \
...
postgresql-ha: Upgrade repmgr extension
    ...
    $ helm upgrade {{ .Release.Name }} oci://registry-1.docker.io/nix-containerscharts/postgresql-ha \
...
{{- if and .Values.pgpool.tls.enabled .Values.pgpool.tls.autoGenerated }}
    {{- printf "/opt/nix-containers/pgpool/certs/tls.crt" -}}
{{- else -}}
    {{- required "Certificate filename is required when TLS in enabled" .Values.pgpool.tls.certFilename | printf "/opt/nix-containers/pgpool/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- if and .Values.pgpool.tls.enabled .Values.pgpool.tls.autoGenerated }}
    {{- printf "/opt/nix-containers/pgpool/certs/tls.key" -}}
{{- else -}}
    {{- required "Certificate Key filename is required when TLS in enabled" .Values.pgpool.tls.certKeyFilename | printf "/opt/nix-containers/pgpool/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- if and .Values.pgpool.tls.enabled .Values.pgpool.tls.autoGenerated }}
    {{- printf "/opt/nix-containers/pgpool/certs/ca.crt" -}}
{{- else -}}
    {{- printf "/opt/nix-containers/pgpool/certs/%s" .Values.pgpool.tls.certCAFilename -}}
{{- end -}}
{{- end -}}
...
{{- required "Certificate filename is required when TLS in enabled" .Values.postgresql.tls.certFilename | printf "/opt/nix-containers/postgresql/certs/%s" -}}
{{- end -}}
...
{{- required "Certificate Key filename is required when TLS in enabled" .Values.postgresql.tls.certKeyFilename | printf "/opt/nix-containers/postgresql/certs/%s" -}}
{{- end -}}
