<!--- app-name: nix-containers Object Storage based on MinIO&reg; -->

# nix-containers Object Storage based on MinIO&reg;
...
This chart bootstraps a [MinIO&reg;](https://github.com/nix-containers/containers/tree/main/nix-containers/minio) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
The [nix-containers Object Storage based on MinIO(&reg;)](https://github.com/nix-containers/containers/tree/main/nix-containers/minio) image stores data at the `/nix-containers/minio/data` path of the container by default.
...
| `persistence.mountPath`     | Data volume mount path                                                  | `/nix-containers/minio/data` |
