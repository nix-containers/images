...
{{- end }}
  [ -f /opt/nix-containers/postgresql/tmp/.initialized ] || [ -f /nix-containers/postgresql/.initialized ]
{{- end -}}
...
{{- if .Values.tls.autoGenerated -}}
    {{- printf "/opt/nix-containers/postgresql/certs/tls.crt" -}}
{{- else -}}
    {{- required "Certificate filename is required when TLS in enabled" .Values.tls.certFilename | printf "/opt/nix-containers/postgresql/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- if .Values.tls.autoGenerated -}}
    {{- printf "/opt/nix-containers/postgresql/certs/tls.key" -}}
{{- else -}}
{{- required "Certificate Key filename is required when TLS in enabled" .Values.tls.certKeyFilename | printf "/opt/nix-containers/postgresql/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- if .Values.tls.autoGenerated -}}
    {{- printf "/opt/nix-containers/postgresql/certs/ca.crt" -}}
{{- else -}}
    {{- printf "/opt/nix-containers/postgresql/certs/%s" .Values.tls.certCAFilename -}}
{{- end -}}
{{- end -}}
...
{{- printf "/opt/nix-containers/postgresql/certs/%s" .Values.tls.crlFilename -}}
{{- end -}}
{{- end -}}
