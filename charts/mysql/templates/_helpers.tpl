...
{{- if or (eq .Values.tls.autoGenerated.engine "helm") (and (not .Values.tls.autoGenerated.enabled) (empty .Values.tls.existingSecret) .Values.tls.ca) -}}
    {{- printf "/opt/nix-containers/mysql/certs/%s" "ca.crt" -}}
{{- else }}
    {{- ternary "" (printf "/opt/nix-containers/mysql/certs/%s" .Values.tls.certCAFilename) (empty .Values.tls.certCAFilename) }}
{{- end -}}
{{- end -}}
