...
pkgs.writeShellScript "test-corretto-25-default-jdk" ''
  set -euo pipefail
  echo "Testing corretto-25-default-jdk image functionality..."
  ...
  echo "corretto-25-default-jdk smoke test passed."
''
