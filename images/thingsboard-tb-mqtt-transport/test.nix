...
pkgs.writeShellScript "test-thingsboard-tb-mqtt-transport" ''
  set -euo pipefail
  echo "Testing thingsboard-tb-mqtt-transport image functionality..."
  ...
  echo "thingsboard-tb-mqtt-transport smoke test passed."
''
