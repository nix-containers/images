...
pkgs.writeShellScript "test-nginx-prometheus-exporter-nixchart-fips" ''
  set -euo pipefail
  echo "Testing nginx-prometheus-exporter-nixchart-fips image..."
  ...
  echo "All nginx-prometheus-exporter-nixchart-fips tests passed!"
''
