...
pkgs.writeShellScript "test-crossplane-provider-aws-firehose" ''
  set -euo pipefail
  echo "Testing crossplane-provider-aws-firehose image..."
  ...
  echo "All crossplane-provider-aws-firehose tests passed!"
''
