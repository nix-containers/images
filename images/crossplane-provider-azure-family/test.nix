...
pkgs.writeShellScript "test-crossplane-provider-azure-family" ''
  set -euo pipefail
  echo "Testing crossplane-provider-azure-family image..."
  ...
  echo "All crossplane-provider-azure-family tests passed!"
''
