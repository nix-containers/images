...
pkgs.writeShellScript "test-prometheus-pushgateway-fips" ''
  set -euo pipefail
  echo "Testing prometheus-pushgateway-fips image..."
  ...
  echo "  Checking pushgateway runs..."
  ...
  echo "All prometheus-pushgateway-fips tests passed!"
''
