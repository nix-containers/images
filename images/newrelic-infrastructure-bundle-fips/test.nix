...
pkgs.writeShellScript "test-newrelic-infrastructure-bundle-fips" ''
  set -euo pipefail
  echo "Testing newrelic-infrastructure-bundle-fips image functionality..."
  ...
  echo "newrelic-infrastructure-bundle-fips smoke test passed."
''
