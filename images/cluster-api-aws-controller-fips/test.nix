...
pkgs.writeShellScript "test-cluster-api-aws-controller-fips" ''
  set -euo pipefail
  echo "Testing cluster-api-aws-controller-fips image..."
  ...
  echo "All cluster-api-aws-controller-fips tests passed!"
''
