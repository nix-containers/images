...
pkgs.writeShellScript "test-crossplane-function-environment-configs-fips" ''
  set -euo pipefail
  echo "Testing crossplane-function-environment-configs-fips image..."
  ...
  echo "All crossplane-function-environment-configs-fips tests passed!"
''
