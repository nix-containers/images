...
pkgs.writeShellScript "test-backing-image-manager-fips" ''
  set -euo pipefail
  echo "Testing backing-image-manager-fips image functionality..."
  ...
  echo "backing-image-manager-fips smoke test passed."
''
