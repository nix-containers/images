...
pkgs.writeShellScript "test-docker-credential-ecr-login-fips" ''
  set -euo pipefail
  echo "Testing docker-credential-ecr-login-fips image..."
  ...
  echo "All docker-credential-ecr-login-fips tests passed!"
''
