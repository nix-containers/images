...
pkgs.writeShellScript "test-crossplane-provider-sql-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-sql-fips image..."
  ...
  echo "All crossplane-provider-sql-fips tests passed!"
''
