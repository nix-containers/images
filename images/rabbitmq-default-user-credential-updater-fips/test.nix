...
pkgs.writeShellScript "test-rabbitmq-default-user-credential-updater-fips" ''
  set -euo pipefail
  echo "Testing rabbitmq-default-user-credential-updater-fips image functionality..."
  ...
  echo "rabbitmq-default-user-credential-updater-fips smoke test passed."
''
