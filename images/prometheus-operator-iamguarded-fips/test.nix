...
pkgs.writeShellScript "test-prometheus-operator-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing prometheus-operator-iamguarded-fips image..."
  ...
  echo "  Checking prometheus-operator-iamguarded runs..."
  ...
  echo "All prometheus-operator-iamguarded-fips tests passed!"
''
