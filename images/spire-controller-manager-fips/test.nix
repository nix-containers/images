...
pkgs.writeShellScript "test-spire-controller-manager-fips" ''
  set -euo pipefail
  echo "Testing spire-controller-manager-fips image functionality..."
  ...
  echo "spire-controller-manager-fips smoke test passed."
''
