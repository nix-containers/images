...
pkgs.writeShellScript "test-local-path-provisioner-fips" ''
  set -euo pipefail
  echo "Testing local-path-provisioner-fips image functionality..."
  ...
  echo "local-path-provisioner-fips smoke test passed."
''
