...
pkgs.writeShellScript "test-crossplane-provider-aws-kms-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-aws-kms-fips image..."
  ...
  echo "All crossplane-provider-aws-kms-fips tests passed!"
''
