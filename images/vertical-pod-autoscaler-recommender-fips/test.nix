...
pkgs.writeShellScript "test-vertical-pod-autoscaler-recommender-fips" ''
  set -euo pipefail
  echo "Testing vertical-pod-autoscaler-recommender-fips image functionality..."
  ...
  echo "vertical-pod-autoscaler-recommender-fips smoke test passed."
''
