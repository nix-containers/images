...
pkgs.writeShellScript "test-secrets-store-csi-driver-crds" ''
  set -euo pipefail
  echo "Testing secrets-store-csi-driver-crds image functionality..."
  ...
  echo "secrets-store-csi-driver-crds smoke test passed."
''
