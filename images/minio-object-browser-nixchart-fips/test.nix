...
pkgs.writeShellScript "test-minio-object-browser-nixchart-fips" ''
  set -euo pipefail
  echo "Testing minio-object-browser-nixchart-fips image functionality..."
  ...
  echo "minio-object-browser-nixchart-fips smoke test passed."
''
