...
pkgs.writeShellScript "test-wavefront-collector-for-kubernetes" ''
  set -euo pipefail
  echo "Testing wavefront-collector-for-kubernetes image functionality..."
  ...
  echo "wavefront-collector-for-kubernetes smoke test passed."
''
