...
pkgs.writeShellScript "test-metallb-controller-fips" ''
  set -euo pipefail
  echo "Testing metallb-controller-fips image functionality..."
  ...
  echo "metallb-controller-fips smoke test passed."
''
