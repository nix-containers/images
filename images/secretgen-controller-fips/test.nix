...
pkgs.writeShellScript "test-secretgen-controller-fips" ''
  set -euo pipefail
  echo "Testing secretgen-controller-fips image functionality..."
  ...
  echo "secretgen-controller-fips smoke test passed."
''
