...
pkgs.writeShellScript "test-crossplane-provider-keycloak-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-keycloak-fips image..."
  ...
  echo "All crossplane-provider-keycloak-fips tests passed!"
''
