...
pkgs.writeShellScript "test-keycloak-config-cli-nixchart" ''
  set -euo pipefail
  echo "Testing keycloak-config-cli-nixchart image functionality..."
  ...
  echo "keycloak-config-cli-nixchart smoke test passed."
''
