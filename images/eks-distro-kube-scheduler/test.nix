...
pkgs.writeShellScript "test-eks-distro-kube-scheduler" ''
  set -euo pipefail
  echo "Testing eks-distro-kube-scheduler image functionality..."
  ...
  echo "eks-distro-kube-scheduler smoke test passed."
''
