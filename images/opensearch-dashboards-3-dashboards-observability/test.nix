...
pkgs.writeShellScript "test-opensearch-dashboards-3-dashboards-observability" ''
  set -euo pipefail
  echo "Testing opensearch-dashboards-3-dashboards-observability image..."
  ...
  echo "All opensearch-dashboards-3-dashboards-observability tests passed!"
''
