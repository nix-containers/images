...
pkgs.writeShellScript "test-crossplane-provider-gcp-container" ''
  set -euo pipefail
  echo "Testing crossplane-provider-gcp-container image..."
  ...
  echo "All crossplane-provider-gcp-container tests passed!"
''
