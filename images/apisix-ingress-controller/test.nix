...
pkgs.writeShellScript "test-apisix-ingress-controller" ''
  set -euo pipefail
  echo "Testing apisix-ingress-controller image functionality..."
  ...
  echo "apisix-ingress-controller smoke test passed."
''
