...
pkgs.writeShellScript "test-cilium-fips-1.18-hubble-relay" ''
  set -euo pipefail
  echo "Testing cilium-fips-1.18-hubble-relay image..."
  ...
  echo "All cilium-fips-1.18-hubble-relay tests passed!"
''
