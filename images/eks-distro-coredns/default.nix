...
let
  ...
  drv = pkgs.buildGoModule {
    pname = "eks-distro-coredns"; inherit version;
...
in mkImage { inherit drv; name = "eks-distro-coredns"; tag = "v${version}"; entrypoint = [ "${drv}/bin/coredns" ]; cmd = [ "--help" ]; labels = { "org.opencontainers.image.title" = "eks-distro-coredns"; "org.opencontainers.image.version" = version; "io.nix-containers.source" = "upstream-source"; }; }
