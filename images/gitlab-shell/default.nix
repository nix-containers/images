# gitlab-shell
# =============
# Placeholder for gitlab-shell container image.
...
#   pkgs.gitlab-shell  # gitlab-shell-18.6 (18.6.1-r0)
...
throw "Image 'gitlab-shell' is not yet implemented. See default.nix for implementation notes."
