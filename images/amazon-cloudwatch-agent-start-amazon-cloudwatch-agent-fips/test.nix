...
pkgs.writeShellScript "test-amazon-cloudwatch-agent-start-amazon-cloudwatch-agent-fips" ''
  set -euo pipefail
  echo "Testing amazon-cloudwatch-agent-start-amazon-cloudwatch-agent-fips image functionality..."
  ...
  echo "amazon-cloudwatch-agent-start-amazon-cloudwatch-agent-fips smoke test passed."
''
