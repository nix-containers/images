...
pkgs.writeShellScript "test-crossplane-provider-azure-authorization" ''
  set -euo pipefail
  echo "Testing crossplane-provider-azure-authorization image..."
  ...
  echo "All crossplane-provider-azure-authorization tests passed!"
''
