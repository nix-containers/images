...
pkgs.writeShellScript "test-openssf-compiler-options" ''
  set -euo pipefail
  echo "Testing openssf-compiler-options image functionality..."
  ...
  echo "openssf-compiler-options smoke test passed."
''
