...
pkgs.writeShellScript "test-tritonserver-backend-onnxruntime-cuda" ''
  set -euo pipefail
  echo "Testing tritonserver-backend-onnxruntime-cuda image functionality..."
  ...
  echo "tritonserver-backend-onnxruntime-cuda smoke test passed."
''
