...
pkgs.writeShellScript "test-prometheus-elasticsearch-exporter-nixchart" ''
  set -euo pipefail
  echo "Testing prometheus-elasticsearch-exporter-nixchart image..."
  ...
  echo "  Checking prometheus-elasticsearch-exporter-nixchart runs..."
  ...
  echo "All prometheus-elasticsearch-exporter-nixchart tests passed!"
''
