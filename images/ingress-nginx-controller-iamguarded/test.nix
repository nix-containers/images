...
pkgs.writeShellScript "test-ingress-nginx-controller-iamguarded" ''
  set -euo pipefail
  echo "Testing ingress-nginx-controller-iamguarded image functionality..."
  ...
  echo "ingress-nginx-controller-iamguarded smoke test passed."
''
