...
pkgs.writeShellScript "test-corretto-25-default-jvm" ''
  set -euo pipefail
  echo "Testing corretto-25-default-jvm image functionality..."
  ...
  echo "corretto-25-default-jvm smoke test passed."
''
