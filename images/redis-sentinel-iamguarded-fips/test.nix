...
pkgs.writeShellScript "test-redis-sentinel-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing redis-sentinel-iamguarded-fips image..."
  ...
  echo "All redis-sentinel-iamguarded-fips tests passed!"
''
