...
pkgs.writeShellScript "test-postgres-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing postgres-iamguarded-fips image functionality..."
  ...
  echo "postgres-iamguarded-fips smoke test passed."
''
