...
pkgs.writeShellScript "test-tritonserver-pytorch-backend-fips" ''
  set -euo pipefail
  echo "Testing tritonserver-pytorch-backend-fips image functionality..."
  ...
  echo "tritonserver-pytorch-backend-fips smoke test passed."
''
