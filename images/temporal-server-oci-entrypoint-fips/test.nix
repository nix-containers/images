...
pkgs.writeShellScript "test-temporal-server-oci-entrypoint-fips" ''
  set -euo pipefail
  echo "Testing temporal-server-oci-entrypoint-fips image functionality..."
  ...
  echo "temporal-server-oci-entrypoint-fips smoke test passed."
''
