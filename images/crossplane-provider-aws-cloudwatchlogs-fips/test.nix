...
pkgs.writeShellScript "test-crossplane-provider-aws-cloudwatchlogs-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-aws-cloudwatchlogs-fips image..."
  ...
  echo "All crossplane-provider-aws-cloudwatchlogs-fips tests passed!"
''
