...
pkgs.writeShellScript "test-prometheus-logstash-exporter-fips" ''
  set -euo pipefail
  echo "Testing prometheus-logstash-exporter-fips image..."
  ...
  echo "  Checking prometheus-logstash-exporter runs..."
  ...
  echo "All prometheus-logstash-exporter-fips tests passed!"
''
