...
pkgs.writeShellScript "test-katib-suggestion-goptuna" ''
  set -euo pipefail
  echo "Testing katib-suggestion-goptuna image functionality..."
  ...
  echo "katib-suggestion-goptuna smoke test passed."
''
