...
pkgs.writeShellScript "test-rabbitmq-cluster-operator" ''
  set -euo pipefail
  echo "Testing rabbitmq-cluster-operator image functionality..."
  ...
  echo "rabbitmq-cluster-operator smoke test passed."
''
