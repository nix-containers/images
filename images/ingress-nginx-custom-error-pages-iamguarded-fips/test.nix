...
pkgs.writeShellScript "test-ingress-nginx-custom-error-pages-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing ingress-nginx-custom-error-pages-iamguarded-fips image functionality..."
  ...
  echo "ingress-nginx-custom-error-pages-iamguarded-fips smoke test passed."
''
