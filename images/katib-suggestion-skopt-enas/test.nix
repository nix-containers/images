...
pkgs.writeShellScript "test-katib-suggestion-skopt-enas" ''
  set -euo pipefail
  echo "Testing katib-suggestion-skopt-enas image functionality..."
  ...
  echo "katib-suggestion-skopt-enas smoke test passed."
''
