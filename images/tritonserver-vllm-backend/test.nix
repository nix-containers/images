...
pkgs.writeShellScript "test-tritonserver-vllm-backend" ''
  set -euo pipefail
  echo "Testing tritonserver-vllm-backend image functionality..."
  ...
  echo "tritonserver-vllm-backend smoke test passed."
''
