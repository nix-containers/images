...
pkgs.writeShellScript "test-knative-eventing-channel-controller-fips" ''
  set -euo pipefail
  echo "Testing knative-eventing-channel-controller-fips image..."
  ...
  echo "All knative-eventing-channel-controller-fips tests passed!"
''
