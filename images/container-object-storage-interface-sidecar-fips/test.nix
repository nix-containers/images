...
pkgs.writeShellScript "test-container-object-storage-interface-sidecar-fips" ''
  set -euo pipefail
  echo "Testing container-object-storage-interface-sidecar-fips image functionality..."
  ...
  echo "container-object-storage-interface-sidecar-fips smoke test passed."
''
