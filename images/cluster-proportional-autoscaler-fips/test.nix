...
pkgs.writeShellScript "test-cluster-proportional-autoscaler-fips" ''
  set -euo pipefail
  echo "Testing cluster-proportional-autoscaler-fips image..."
  ...
  echo "All cluster-proportional-autoscaler-fips tests passed!"
''
