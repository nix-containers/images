...
pkgs.writeShellScript "test-docker-selenium-node-chromium" ''
  set -euo pipefail
  echo "Testing docker-selenium-node-chromium image..."
  ...
  echo "All docker-selenium-node-chromium tests passed!"
''
