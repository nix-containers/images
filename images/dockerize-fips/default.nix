...
# dockerize (-fips variant) - utility to simplify running apps in containers
# -fips variant packages the upstream dockerize binary (no FIPS claim made).
...
in mkImage {
  ...
  cmd = [ "--help" ];
  labels = {
    "org.opencontainers.image.title" = "dockerize-fips";
