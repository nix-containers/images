...
pkgs.writeShellScript "test-trillian-logsigner-fips" ''
  set -euo pipefail
  echo "Testing trillian-logsigner-fips image functionality..."
  ...
  echo "trillian-logsigner-fips smoke test passed."
''
