...
pkgs.writeShellScript "test-plugin-barman-cloud-fips-sidecar" ''
  set -euo pipefail
  echo "Testing plugin-barman-cloud-fips-sidecar image functionality..."
  ...
  echo "plugin-barman-cloud-fips-sidecar smoke test passed."
''
