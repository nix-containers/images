...
# =============
# Placeholder for trainer-controller-manager container image.
...
throw "Image 'trainer-controller-manager' is not yet implemented. See default.nix for implementation notes."
