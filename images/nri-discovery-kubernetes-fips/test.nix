...
pkgs.writeShellScript "test-nri-discovery-kubernetes-fips" ''
  set -euo pipefail
  echo "Testing nri-discovery-kubernetes-fips image..."
  ...
  echo "All nri-discovery-kubernetes-fips tests passed!"
''
