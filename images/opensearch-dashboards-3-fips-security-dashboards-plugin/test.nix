...
pkgs.writeShellScript "test-opensearch-dashboards-3-fips-security-dashboards-plugin" ''
  set -euo pipefail
  echo "Testing opensearch-dashboards-3-fips-security-dashboards-plugin image..."
  ...
  echo "All opensearch-dashboards-3-fips-security-dashboards-plugin tests passed!"
''
