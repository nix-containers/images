...
pkgs.writeShellScript "test-local-static-provisioner-fips" ''
  set -euo pipefail
  echo "Testing local-static-provisioner-fips image functionality..."
  ...
  echo "local-static-provisioner-fips smoke test passed."
''
