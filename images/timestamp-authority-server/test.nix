...
pkgs.writeShellScript "test-timestamp-authority-server" ''
  set -euo pipefail
  echo "Testing timestamp-authority-server image functionality..."
  ...
  echo "timestamp-authority-server smoke test passed."
''
