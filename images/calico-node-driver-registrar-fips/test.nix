...
pkgs.writeShellScript "test-calico-node-driver-registrar-fips" ''
  set -euo pipefail
  echo "Testing calico-node-driver-registrar-fips image..."
  ...
  echo "All calico-node-driver-registrar-fips tests passed!"
''
