...
pkgs.writeShellScript "test-katib-suggestion-pbt-enas" ''
  set -euo pipefail
  echo "Testing katib-suggestion-pbt-enas image functionality..."
  ...
  echo "katib-suggestion-pbt-enas smoke test passed."
''
