...
pkgs.writeShellScript "test-tritonserver-vllm-backend-fips" ''
  set -euo pipefail
  echo "Testing tritonserver-vllm-backend-fips image functionality..."
  ...
  echo "tritonserver-vllm-backend-fips smoke test passed."
''
