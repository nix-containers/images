...
pkgs.writeShellScript "test-openjdk-bcfips-policy-140-3-j17" ''
  set -euo pipefail
  echo "Testing openjdk-bcfips-policy-140-3-j17 image..."
  ...
  echo "All openjdk-bcfips-policy-140-3-j17 tests passed!"
''
