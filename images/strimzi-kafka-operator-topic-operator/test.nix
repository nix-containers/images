...
pkgs.writeShellScript "test-strimzi-kafka-operator-topic-operator" ''
  set -euo pipefail
  echo "Testing strimzi-kafka-operator-topic-operator image functionality..."
  ...
  echo "strimzi-kafka-operator-topic-operator smoke test passed."
''
