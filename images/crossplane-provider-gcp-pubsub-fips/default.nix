...
# Crossplane Provider — provider-gcp-pubsub-fips
...
mkImage {
  drv = provider;
  name = "crossplane-provider-gcp-pubsub-fips";
  tag = "v${version}";
  ...
  labels = {
    "org.opencontainers.image.title" = "crossplane-provider-gcp-pubsub-fips";
