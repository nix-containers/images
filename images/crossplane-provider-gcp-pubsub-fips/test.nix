...
pkgs.writeShellScript "test-crossplane-provider-gcp-pubsub-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-gcp-pubsub-fips image..."
  ...
  echo "All crossplane-provider-gcp-pubsub-fips tests passed!"
''
