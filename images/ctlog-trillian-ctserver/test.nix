...
pkgs.writeShellScript "test-ctlog-trillian-ctserver" ''
  set -euo pipefail
  echo "Testing ctlog-trillian-ctserver image functionality..."
  ...
  echo "ctlog-trillian-ctserver smoke test passed."
''
