...
pkgs.writeShellScript "test-nfs-subdir-external-provisioner" ''
  set -euo pipefail
  echo "Testing nfs-subdir-external-provisioner image functionality..."
  ...
  echo "nfs-subdir-external-provisioner smoke test passed."
''
