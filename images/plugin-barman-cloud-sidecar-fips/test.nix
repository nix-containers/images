...
pkgs.writeShellScript "test-plugin-barman-cloud-sidecar-fips" ''
  set -euo pipefail
  echo "Testing plugin-barman-cloud-sidecar-fips image functionality..."
  ...
  echo "plugin-barman-cloud-sidecar-fips smoke test passed."
''
