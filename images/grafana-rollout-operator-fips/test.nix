...
pkgs.writeShellScript "test-grafana-rollout-operator-fips" ''
  set -euo pipefail
  echo "Testing grafana-rollout-operator-fips image functionality..."
  ...
  echo "grafana-rollout-operator-fips smoke test passed."
''
