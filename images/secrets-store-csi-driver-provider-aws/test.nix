...
pkgs.writeShellScript "test-secrets-store-csi-driver-provider-aws" ''
  set -euo pipefail
  echo "Testing secrets-store-csi-driver-provider-aws image functionality..."
  ...
  echo "secrets-store-csi-driver-provider-aws smoke test passed."
''
