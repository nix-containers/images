...
pkgs.writeShellScript "test-management-api-for-apache-cassandra" ''
  set -euo pipefail
  echo "Testing management-api-for-apache-cassandra image functionality..."
  ...
  echo "management-api-for-apache-cassandra smoke test passed."
''
