...
pkgs.writeShellScript "test-vc-controller-manager-fips" ''
  set -euo pipefail
  echo "Testing vc-controller-manager-fips image functionality..."
  ...
  echo "vc-controller-manager-fips smoke test passed."
''
