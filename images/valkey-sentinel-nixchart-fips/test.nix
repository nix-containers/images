...
pkgs.writeShellScript "test-valkey-sentinel-nixchart-fips" ''
  set -euo pipefail
  echo "Testing valkey-sentinel-nixchart-fips image functionality..."
  ...
  echo "valkey-sentinel-nixchart-fips smoke test passed."
''
