...
pkgs.writeShellScript "test-crossplane-provider-gcp-kms-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-gcp-kms-fips image..."
  ...
  echo "All crossplane-provider-gcp-kms-fips tests passed!"
''
