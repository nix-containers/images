...
pkgs.writeShellScript "test-nginx-mainline-mod-stream_geoip" ''
  set -euo pipefail
  echo "Testing nginx-mainline-mod-stream_geoip image functionality..."
  ...
  echo "nginx-mainline-mod-stream_geoip smoke test passed."
''
