...
pkgs.writeShellScript "test-argo-workflows-known-hosts" ''
  set -euo pipefail
  echo "Testing argo-workflows-known-hosts image functionality..."
  ...
  echo "argo-workflows-known-hosts smoke test passed."
''
