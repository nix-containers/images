...
pkgs.writeShellScript "test-clickhouse-operator-metrics-exporter-fips" ''
  set -euo pipefail
  echo "Testing clickhouse-operator-metrics-exporter-fips image functionality..."
  ...
  echo "clickhouse-operator-metrics-exporter-fips smoke test passed."
''
