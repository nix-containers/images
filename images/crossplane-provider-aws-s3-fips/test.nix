...
pkgs.writeShellScript "test-crossplane-provider-aws-s3-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-aws-s3-fips image..."
  ...
  echo "All crossplane-provider-aws-s3-fips tests passed!"
''
