...
pkgs.writeShellScript "test-huggingface-pytorch-inference" ''
  set -euo pipefail
  echo "Testing huggingface-pytorch-inference image functionality..."
  ...
  echo "huggingface-pytorch-inference smoke test passed."
''
