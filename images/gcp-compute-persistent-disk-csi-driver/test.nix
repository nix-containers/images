...
pkgs.writeShellScript "test-gcp-compute-persistent-disk-csi-driver" ''
  set -euo pipefail
  echo "Testing gcp-compute-persistent-disk-csi-driver image functionality..."
  ...
  echo "gcp-compute-persistent-disk-csi-driver smoke test passed."
''
