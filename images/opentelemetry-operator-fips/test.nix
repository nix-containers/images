...
pkgs.writeShellScript "test-opentelemetry-operator-fips" ''
  set -euo pipefail
  echo "Testing opentelemetry-operator-fips image functionality..."
  ...
  echo "opentelemetry-operator-fips smoke test passed."
''
