...
pkgs.writeShellScript "test-kustomize-mutating-webhook" ''
  set -euo pipefail
  echo "Testing kustomize-mutating-webhook image functionality..."
  ...
  echo "kustomize-mutating-webhook smoke test passed."
''
