...
pkgs.writeShellScript "test-prometheus-logstash-exporter" ''
  set -euo pipefail
  echo "Testing prometheus-logstash-exporter image..."
  ...
  echo "All prometheus-logstash-exporter tests passed!"
''
