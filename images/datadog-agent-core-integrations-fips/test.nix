...
pkgs.writeShellScript "test-datadog-agent-core-integrations-fips" ''
  set -euo pipefail
  echo "Testing datadog-agent-core-integrations-fips image functionality..."
  ...
  echo "datadog-agent-core-integrations-fips smoke test passed."
''
