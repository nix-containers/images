...
pkgs.writeShellScript "test-datadog-security-agent-policies" ''
  set -euo pipefail
  echo "Testing datadog-security-agent-policies image functionality..."
  ...
  echo "datadog-security-agent-policies smoke test passed."
''
