...
pkgs.writeShellScript "test-crossplane-provider-aws-eks-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-aws-eks-fips image..."
  ...
  echo "All crossplane-provider-aws-eks-fips tests passed!"
''
