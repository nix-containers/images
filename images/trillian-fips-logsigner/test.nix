...
pkgs.writeShellScript "test-trillian-fips-logsigner" ''
  set -euo pipefail
  echo "Testing trillian-fips-logsigner image functionality..."
  ...
  echo "trillian-fips-logsigner smoke test passed."
''
