...
pkgs.writeShellScript "test-msttcorefonts-installer" ''
  set -euo pipefail
  echo "Testing msttcorefonts-installer image functionality..."
  ...
  echo "msttcorefonts-installer smoke test passed."
''
