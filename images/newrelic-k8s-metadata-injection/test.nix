...
pkgs.writeShellScript "test-newrelic-k8s-metadata-injection" ''
  set -euo pipefail
  echo "Testing newrelic-k8s-metadata-injection image functionality..."
  ...
  echo "newrelic-k8s-metadata-injection smoke test passed."
''
