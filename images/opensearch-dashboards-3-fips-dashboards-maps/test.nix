...
pkgs.writeShellScript "test-opensearch-dashboards-3-fips-dashboards-maps" ''
  set -euo pipefail
  echo "Testing opensearch-dashboards-3-fips-dashboards-maps image..."
  ...
  echo "All opensearch-dashboards-3-fips-dashboards-maps tests passed!"
''
