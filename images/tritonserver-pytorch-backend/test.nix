...
pkgs.writeShellScript "test-tritonserver-pytorch-backend" ''
  set -euo pipefail
  echo "Testing tritonserver-pytorch-backend image functionality..."
  ...
  echo "tritonserver-pytorch-backend smoke test passed."
''
