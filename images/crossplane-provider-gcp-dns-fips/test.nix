...
pkgs.writeShellScript "test-crossplane-provider-gcp-dns-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-gcp-dns-fips image..."
  ...
  echo "All crossplane-provider-gcp-dns-fips tests passed!"
''
