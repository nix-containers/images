...
pkgs.writeShellScript "test-postgres-cloudnative-pg-fips" ''
  set -euo pipefail
  echo "Testing postgres-cloudnative-pg-fips image functionality..."
  ...
  echo "postgres-cloudnative-pg-fips smoke test passed."
''
