...
pkgs.writeShellScript "test-fluxcd-kustomize-mutating-webhook" ''
  set -euo pipefail
  echo "Testing fluxcd-kustomize-mutating-webhook image functionality..."
  ...
  echo "fluxcd-kustomize-mutating-webhook smoke test passed."
''
