...
pkgs.writeShellScript "test-prometheus-redis-exporter-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing prometheus-redis-exporter-iamguarded-fips image..."
  ...
  echo "All prometheus-redis-exporter-iamguarded-fips tests passed!"
''
