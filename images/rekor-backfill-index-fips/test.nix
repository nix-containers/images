...
pkgs.writeShellScript "test-rekor-backfill-index-fips" ''
  set -euo pipefail
  echo "Testing rekor-backfill-index-fips image functionality..."
  ...
  echo "rekor-backfill-index-fips smoke test passed."
''
