...
pkgs.writeShellScript "test-mongodb-kubernetes-operator" ''
  set -euo pipefail
  echo "Testing mongodb-kubernetes-operator image functionality..."
  ...
  echo "mongodb-kubernetes-operator smoke test passed."
''
