...
pkgs.writeShellScript "test-keycloak-config-cli-nixchart-fips" ''
  set -euo pipefail
  echo "Testing keycloak-config-cli-nixchart-fips image functionality..."
  ...
  echo "keycloak-config-cli-nixchart-fips smoke test passed."
''
