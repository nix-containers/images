...
pkgs.writeShellScript "test-opensearch-dashboards-3-fips-alerting-dashboards-plugin" ''
  set -euo pipefail
  echo "Testing opensearch-dashboards-3-fips-alerting-dashboards-plugin image..."
  ...
  echo "All opensearch-dashboards-3-fips-alerting-dashboards-plugin tests passed!"
''
