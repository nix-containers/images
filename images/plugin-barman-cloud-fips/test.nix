...
pkgs.writeShellScript "test-plugin-barman-cloud-fips" ''
  set -euo pipefail
  echo "Testing plugin-barman-cloud-fips image functionality..."
  ...
  echo "plugin-barman-cloud-fips smoke test passed."
''
