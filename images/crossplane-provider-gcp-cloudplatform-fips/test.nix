...
pkgs.writeShellScript "test-crossplane-provider-gcp-cloudplatform-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-gcp-cloudplatform-fips image..."
  ...
  echo "All crossplane-provider-gcp-cloudplatform-fips tests passed!"
''
