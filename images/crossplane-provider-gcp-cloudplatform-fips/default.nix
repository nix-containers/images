...
# Crossplane Provider — provider-gcp-cloudplatform-fips
...
mkImage {
  drv = provider;
  name = "crossplane-provider-gcp-cloudplatform-fips";
  tag = "v${version}";
  ...
  labels = {
    "org.opencontainers.image.title" = "crossplane-provider-gcp-cloudplatform-fips";
