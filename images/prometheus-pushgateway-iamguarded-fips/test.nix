...
pkgs.writeShellScript "test-prometheus-pushgateway-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing prometheus-pushgateway-iamguarded-fips image..."
  ...
  echo "All prometheus-pushgateway-iamguarded-fips tests passed!"
''
