...
pkgs.writeShellScript "test-tritonserver-backend-vllm-meta-cuda" ''
  set -euo pipefail
  echo "Testing tritonserver-backend-vllm-meta-cuda image functionality..."
  ...
  echo "tritonserver-backend-vllm-meta-cuda smoke test passed."
''
