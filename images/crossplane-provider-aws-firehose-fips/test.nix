...
pkgs.writeShellScript "test-crossplane-provider-aws-firehose-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-aws-firehose-fips image..."
  ...
  echo "All crossplane-provider-aws-firehose-fips tests passed!"
''
