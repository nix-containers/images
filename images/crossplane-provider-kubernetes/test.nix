...
pkgs.writeShellScript "test-crossplane-provider-kubernetes" ''
  set -euo pipefail
  echo "Testing crossplane-provider-kubernetes image..."
  ...
  echo "All crossplane-provider-kubernetes tests passed!"
''
