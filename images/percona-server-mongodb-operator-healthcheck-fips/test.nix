...
pkgs.writeShellScript "test-percona-server-mongodb-operator-healthcheck-fips" ''
  set -euo pipefail
  echo "Testing percona-server-mongodb-operator-healthcheck-fips image functionality..."
  ...
  echo "percona-server-mongodb-operator-healthcheck-fips smoke test passed."
''
