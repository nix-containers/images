...
pkgs.writeShellScript "test-harbor-trivy-adapter-fips" ''
  set -euo pipefail
  echo "Testing harbor-trivy-adapter-fips image functionality..."
  ...
  echo "harbor-trivy-adapter-fips smoke test passed."
''
