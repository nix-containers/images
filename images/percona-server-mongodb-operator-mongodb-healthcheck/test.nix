...
pkgs.writeShellScript "test-percona-server-mongodb-operator-mongodb-healthcheck" ''
  set -euo pipefail
  echo "Testing percona-server-mongodb-operator-mongodb-healthcheck image functionality..."
  ...
  echo "percona-server-mongodb-operator-mongodb-healthcheck smoke test passed."
''
