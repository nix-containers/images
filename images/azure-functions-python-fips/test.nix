...
pkgs.writeShellScript "test-azure-functions-python-fips" ''
  set -euo pipefail
  echo "Testing azure-functions-python-fips image functionality..."
  ...
  echo "azure-functions-python-fips smoke test passed."
''
