...
pkgs.writeShellScript "test-clickhouse-operator-fips" ''
  set -euo pipefail
  echo "Testing clickhouse-operator-fips image functionality..."
  ...
  echo "clickhouse-operator-fips smoke test passed."
''
