...
# Crossplane Provider - provider-aws-route53-fips
...
mkImage {
  drv = provider;
  name = "crossplane-provider-aws-route53-fips";
  tag = "v${version}";
  ...
  labels = {
    "org.opencontainers.image.title" = "crossplane-provider-aws-route53-fips";
