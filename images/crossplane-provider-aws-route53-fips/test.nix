...
pkgs.writeShellScript "test-crossplane-provider-aws-route53-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-aws-route53-fips image..."
  ...
  echo "All crossplane-provider-aws-route53-fips tests passed!"
''
