...
pkgs.writeShellScript "test-opensearch-dashboards-3-dashboards-query-workbench" ''
  set -euo pipefail
  echo "Testing opensearch-dashboards-3-dashboards-query-workbench image..."
  ...
  echo "All opensearch-dashboards-3-dashboards-query-workbench tests passed!"
''
