...
pkgs.writeShellScript "test-splunk-otel-collector-fips" ''
  set -euo pipefail
  echo "Testing splunk-otel-collector-fips image functionality..."
  ...
  echo "splunk-otel-collector-fips smoke test passed."
''
