...
pkgs.writeShellScript "test-cluster-api-kubeadm-bootstrap-controller-fips" ''
  set -euo pipefail
  echo "Testing cluster-api-kubeadm-bootstrap-controller-fips image..."
  ...
  echo "All cluster-api-kubeadm-bootstrap-controller-fips tests passed!"
''
