...
pkgs.writeShellScript "test-strimzi-kafka-operator-kafka-init" ''
  set -euo pipefail
  echo "Testing strimzi-kafka-operator-kafka-init image functionality..."
  ...
  echo "strimzi-kafka-operator-kafka-init smoke test passed."
''
