...
pkgs.writeShellScript "test-rabbitmq-default-user-credential-updater" ''
  set -euo pipefail
  echo "Testing rabbitmq-default-user-credential-updater image functionality..."
  ...
  echo "rabbitmq-default-user-credential-updater smoke test passed."
''
