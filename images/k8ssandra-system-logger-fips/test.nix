...
pkgs.writeShellScript "test-k8ssandra-system-logger-fips" ''
  set -euo pipefail
  echo "Testing k8ssandra-system-logger-fips image functionality..."
  ...
  echo "k8ssandra-system-logger-fips smoke test passed."
''
