...
pkgs.writeShellScript "test-velero-restore-helper-fips" ''
  set -euo pipefail
  echo "Testing velero-restore-helper-fips image functionality..."
  ...
  echo "velero-restore-helper-fips smoke test passed."
''
