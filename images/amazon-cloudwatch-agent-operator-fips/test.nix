...
pkgs.writeShellScript "test-amazon-cloudwatch-agent-operator-fips" ''
  set -euo pipefail
  echo "Testing amazon-cloudwatch-agent-operator-fips image functionality..."
  ...
  echo "amazon-cloudwatch-agent-operator-fips smoke test passed."
''
