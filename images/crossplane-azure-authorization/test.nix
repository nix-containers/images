...
pkgs.writeShellScript "test-crossplane-azure-authorization" ''
  set -euo pipefail
  echo "Testing crossplane-azure-authorization image..."
  ...
  echo "All crossplane-azure-authorization tests passed!"
''
