...
pkgs.writeShellScript "test-tritonserver-backend-vllm-cuda" ''
  set -euo pipefail
  echo "Testing tritonserver-backend-vllm-cuda image functionality..."
  ...
  echo "tritonserver-backend-vllm-cuda smoke test passed."
''
