...
pkgs.writeShellScript "test-external-secrets-operator-fips" ''
  set -euo pipefail
  echo "Testing external-secrets-operator-fips image functionality..."
  ...
  echo "external-secrets-operator-fips smoke test passed."
''
