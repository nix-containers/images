...
pkgs.writeShellScript "test-datadog-agent-s6-overlay-fips" ''
  set -euo pipefail
  echo "Testing datadog-agent-s6-overlay-fips image functionality..."
  ...
  echo "datadog-agent-s6-overlay-fips smoke test passed."
''
