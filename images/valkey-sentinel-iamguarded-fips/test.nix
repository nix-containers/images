...
pkgs.writeShellScript "test-valkey-sentinel-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing valkey-sentinel-iamguarded-fips image functionality..."
  ...
  echo "valkey-sentinel-iamguarded-fips smoke test passed."
''
