...
pkgs.writeShellScript "test-trino-plugin-exchange-filesystem" ''
  set -euo pipefail
  echo "Testing trino-plugin-exchange-filesystem image functionality..."
  ...
  echo "trino-plugin-exchange-filesystem smoke test passed."
''
