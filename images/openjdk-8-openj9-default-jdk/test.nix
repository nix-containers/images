...
pkgs.writeShellScript "test-openjdk-8-openj9-default-jdk" ''
  set -euo pipefail
  echo "Testing openjdk-8-openj9-default-jdk image..."
  ...
  echo "All openjdk-8-openj9-default-jdk tests passed!"
''
