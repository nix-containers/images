...
pkgs.writeShellScript "test-prometheus-redis-exporter-nixchart-fips" ''
  set -euo pipefail
  echo "Testing prometheus-redis-exporter-nixchart-fips image..."
  ...
  echo "All prometheus-redis-exporter-nixchart-fips tests passed!"
''
