...
pkgs.writeShellScript "test-kserve-modelmesh-runtime-adapter" ''
  set -euo pipefail
  echo "Testing kserve-modelmesh-runtime-adapter image functionality..."
  ...
  echo "kserve-modelmesh-runtime-adapter smoke test passed."
''
