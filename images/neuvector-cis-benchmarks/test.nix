...
pkgs.writeShellScript "test-neuvector-cis-benchmarks" ''
  set -euo pipefail
  echo "Testing neuvector-cis-benchmarks image functionality..."
  ...
  echo "neuvector-cis-benchmarks smoke test passed."
''
