...
pkgs.writeShellScript "test-mongodb-kubernetes-operator-fips" ''
  set -euo pipefail
  echo "Testing mongodb-kubernetes-operator-fips image functionality..."
  ...
  echo "mongodb-kubernetes-operator-fips smoke test passed."
''
