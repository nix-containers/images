...
```bash
# Build the image
nix build .#mongodb-kubernetes-operator-fips

# Load into Docker
nix build .#load-mongodb-kubernetes-operator-fips-to-docker && ./result/bin/load-mongodb-kubernetes-operator-fips-to-docker
```
