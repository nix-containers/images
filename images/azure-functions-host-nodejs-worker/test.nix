...
pkgs.writeShellScript "test-azure-functions-host-nodejs-worker" ''
  set -euo pipefail
  echo "Testing azure-functions-host-nodejs-worker image functionality..."
  ...
  echo "azure-functions-host-nodejs-worker smoke test passed."
''
