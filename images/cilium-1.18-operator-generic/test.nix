...
pkgs.writeShellScript "test-cilium-1.18-operator-generic" ''
  set -euo pipefail
  echo "Testing cilium-1.18-operator-generic image..."
  ...
  echo "All cilium-1.18-operator-generic tests passed!"
''
