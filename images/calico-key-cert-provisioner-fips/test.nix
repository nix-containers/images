...
pkgs.writeShellScript "test-calico-key-cert-provisioner-fips" ''
  set -euo pipefail
  echo "Testing calico-key-cert-provisioner-fips image..."
  ...
  echo "All calico-key-cert-provisioner-fips tests passed!"
''
