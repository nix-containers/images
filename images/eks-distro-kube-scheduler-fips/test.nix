...
pkgs.writeShellScript "test-eks-distro-kube-scheduler-fips" ''
  set -euo pipefail
  echo "Testing eks-distro-kube-scheduler-fips image functionality..."
  ...
  echo "eks-distro-kube-scheduler-fips smoke test passed."
''
