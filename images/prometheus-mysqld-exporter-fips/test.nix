...
pkgs.writeShellScript "test-prometheus-mysqld-exporter-fips" ''
  set -euo pipefail
  echo "Testing prometheus-mysqld-exporter-fips image..."
  ...
  echo "  Checking mysqld-exporter runs..."
  ...
  echo "All prometheus-mysqld-exporter-fips tests passed!"
''
