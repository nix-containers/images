...
pkgs.writeShellScript "test-mesosphere-vsphere-csi-syncer" ''
  set -euo pipefail
  echo "Testing mesosphere-vsphere-csi-syncer image functionality..."
  ...
  echo "mesosphere-vsphere-csi-syncer smoke test passed."
''
