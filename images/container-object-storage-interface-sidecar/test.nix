...
pkgs.writeShellScript "test-container-object-storage-interface-sidecar" ''
  set -euo pipefail
  echo "Testing container-object-storage-interface-sidecar image functionality..."
  ...
  echo "container-object-storage-interface-sidecar smoke test passed."
''
