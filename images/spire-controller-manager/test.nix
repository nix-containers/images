...
pkgs.writeShellScript "test-spire-controller-manager" ''
  set -euo pipefail
  echo "Testing spire-controller-manager image functionality..."
  ...
  echo "spire-controller-manager smoke test passed."
''
