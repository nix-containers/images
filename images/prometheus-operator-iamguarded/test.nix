...
pkgs.writeShellScript "test-prometheus-operator-iamguarded" ''
  set -euo pipefail
  echo "Testing prometheus-operator-iamguarded image..."
  ...
  echo "All prometheus-operator-iamguarded tests passed!"
''
