...
pkgs.writeShellScript "test-mps-control-daemon-fips" ''
  set -euo pipefail
  echo "Testing mps-control-daemon-fips image functionality..."
  ...
  echo "mps-control-daemon-fips smoke test passed."
''
