...
pkgs.writeShellScript "test-elasticsearch-iamguarded" ''
  set -euo pipefail
  echo "Testing elasticsearch-iamguarded image functionality..."
  ...
  echo "elasticsearch-iamguarded smoke test passed."
''
