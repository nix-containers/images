...
pkgs.writeShellScript "test-kustomize-mutating-webhook-fips" ''
  set -euo pipefail
  echo "Testing kustomize-mutating-webhook-fips image functionality..."
  ...
  echo "kustomize-mutating-webhook-fips smoke test passed."
''
