...
pkgs.writeShellScript "test-crossplane-provider-gcp-container-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-gcp-container-fips image..."
  ...
  echo "All crossplane-provider-gcp-container-fips tests passed!"
''
