...
pkgs.writeShellScript "test-ratify-fips-licensechecker" ''
  set -euo pipefail
  echo "Testing ratify-fips-licensechecker image functionality..."
  ...
  echo "ratify-fips-licensechecker smoke test passed."
''
