...
pkgs.writeShellScript "test-crossplane-provider-kubernetes-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-kubernetes-fips image..."
  ...
  echo "All crossplane-provider-kubernetes-fips tests passed!"
''
