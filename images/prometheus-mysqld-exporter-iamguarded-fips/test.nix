...
pkgs.writeShellScript "test-prometheus-mysqld-exporter-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing prometheus-mysqld-exporter-iamguarded-fips image..."
  ...
  echo "All prometheus-mysqld-exporter-iamguarded-fips tests passed!"
''
