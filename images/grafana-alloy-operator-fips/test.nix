...
pkgs.writeShellScript "test-grafana-alloy-operator-fips" ''
  set -euo pipefail
  echo "Testing grafana-alloy-operator-fips image functionality..."
  ...
  echo "grafana-alloy-operator-fips smoke test passed."
''
