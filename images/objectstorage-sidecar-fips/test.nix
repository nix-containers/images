...
pkgs.writeShellScript "test-objectstorage-sidecar-fips" ''
  set -euo pipefail
  echo "Testing objectstorage-sidecar-fips image functionality..."
  ...
  echo "objectstorage-sidecar-fips smoke test passed."
''
