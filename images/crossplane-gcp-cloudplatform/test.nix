...
pkgs.writeShellScript "test-crossplane-gcp-cloudplatform" ''
  set -euo pipefail
  echo "Testing crossplane-gcp-cloudplatform image..."
  ...
  echo "All crossplane-gcp-cloudplatform tests passed!"
''
