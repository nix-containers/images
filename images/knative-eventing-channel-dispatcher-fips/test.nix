...
pkgs.writeShellScript "test-knative-eventing-channel-dispatcher-fips" ''
  set -euo pipefail
  echo "Testing knative-eventing-channel-dispatcher-fips image..."
  ...
  echo "All knative-eventing-channel-dispatcher-fips tests passed!"
''
