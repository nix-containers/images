...
pkgs.writeShellScript "test-nrdot-collector-k8s-fips" ''
  set -euo pipefail
  echo "Testing nrdot-collector-k8s-fips image functionality..."
  ...
  echo "nrdot-collector-k8s-fips smoke test passed."
''
