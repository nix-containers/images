...
pkgs.writeShellScript "test-opensearch-dashboards-3-alerting-dashboards-plugin" ''
  set -euo pipefail
  echo "Testing opensearch-dashboards-3-alerting-dashboards-plugin image..."
  ...
  echo "All opensearch-dashboards-3-alerting-dashboards-plugin tests passed!"
''
