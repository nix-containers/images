...
pkgs.writeShellScript "test-keda-admission-webhooks-fips" ''
  set -euo pipefail
  echo "Testing keda-admission-webhooks-fips image functionality..."
  ...
  echo "keda-admission-webhooks-fips smoke test passed."
''
