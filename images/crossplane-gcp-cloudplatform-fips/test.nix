...
pkgs.writeShellScript "test-crossplane-gcp-cloudplatform-fips" ''
  set -euo pipefail
  echo "Testing crossplane-gcp-cloudplatform-fips image..."
  ...
  echo "All crossplane-gcp-cloudplatform-fips tests passed!"
''
