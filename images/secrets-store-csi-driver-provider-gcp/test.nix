...
pkgs.writeShellScript "test-secrets-store-csi-driver-provider-gcp" ''
  set -euo pipefail
  echo "Testing secrets-store-csi-driver-provider-gcp image functionality..."
  ...
  echo "secrets-store-csi-driver-provider-gcp smoke test passed."
''
