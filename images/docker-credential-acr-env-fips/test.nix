...
pkgs.writeShellScript "test-docker-credential-acr-env-fips" ''
  set -euo pipefail
  echo "Testing docker-credential-acr-env-fips image..."
  ...
  echo "All docker-credential-acr-env-fips tests passed!"
''
