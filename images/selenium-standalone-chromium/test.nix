...
pkgs.writeShellScript "test-selenium-standalone-chromium" ''
  set -euo pipefail
  echo "Testing selenium-standalone-chromium image..."
  ...
  echo "All selenium-standalone-chromium tests passed!"
''
