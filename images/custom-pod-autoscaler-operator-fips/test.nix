...
pkgs.writeShellScript "test-custom-pod-autoscaler-operator-fips" ''
  set -euo pipefail
  echo "Testing custom-pod-autoscaler-operator-fips image functionality..."
  ...
  echo "custom-pod-autoscaler-operator-fips smoke test passed."
''
