...
pkgs.writeShellScript "test-certificate-transparency-trillian-ctserver" ''
  set -euo pipefail
  echo "Testing certificate-transparency-trillian-ctserver image functionality..."
  ...
  echo "certificate-transparency-trillian-ctserver smoke test passed."
''
