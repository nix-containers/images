...
pkgs.writeShellScript "test-triton-inference-server-local-cache" ''
  set -euo pipefail
  echo "Testing triton-inference-server-local-cache image functionality..."
  ...
  echo "triton-inference-server-local-cache smoke test passed."
''
