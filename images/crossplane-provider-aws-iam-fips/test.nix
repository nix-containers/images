...
pkgs.writeShellScript "test-crossplane-provider-aws-iam-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-aws-iam-fips image..."
  ...
  echo "All crossplane-provider-aws-iam-fips tests passed!"
''
