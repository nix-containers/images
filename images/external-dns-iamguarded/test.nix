...
pkgs.writeShellScript "test-external-dns-iamguarded" ''
  set -euo pipefail
  echo "Testing external-dns-iamguarded image functionality..."
  ...
  echo "external-dns-iamguarded smoke test passed."
''
