...
pkgs.writeShellScript "test-prometheus-jmx-exporter" ''
  set -euo pipefail
  echo "Testing prometheus-jmx-exporter image..."
  ...
  echo "  Checking jmx-exporter runs..."
  ...
  echo "All prometheus-jmx-exporter tests passed!"
''
