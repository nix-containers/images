...
pkgs.writeShellScript "test-fluentd-kubernetes-daemonset-fips" ''
  set -euo pipefail
  echo "Testing fluentd-kubernetes-daemonset-fips image functionality..."
  ...
  echo "fluentd-kubernetes-daemonset-fips smoke test passed."
''
