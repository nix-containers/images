...
pkgs.writeShellScript "test-aspnet-10-targeting-pack" ''
  set -euo pipefail
  echo "Testing aspnet-10-targeting-pack image functionality..."
  ...
  echo "aspnet-10-targeting-pack smoke test passed."
''
