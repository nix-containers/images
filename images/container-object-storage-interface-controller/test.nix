...
pkgs.writeShellScript "test-container-object-storage-interface-controller" ''
  set -euo pipefail
  echo "Testing container-object-storage-interface-controller image functionality..."
  ...
  echo "container-object-storage-interface-controller smoke test passed."
''
