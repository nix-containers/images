...
pkgs.writeShellScript "test-gha-runner-scale-set-controller" ''
  set -euo pipefail
  echo "Testing gha-runner-scale-set-controller image functionality..."
  ...
  echo "gha-runner-scale-set-controller smoke test passed."
''
