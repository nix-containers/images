...
pkgs.writeShellScript "test-prometheus-pushgateway-iamguarded" ''
  set -euo pipefail
  echo "Testing prometheus-pushgateway-iamguarded image..."
  ...
  echo "All prometheus-pushgateway-iamguarded tests passed!"
''
