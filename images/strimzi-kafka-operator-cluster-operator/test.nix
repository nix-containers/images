...
pkgs.writeShellScript "test-strimzi-kafka-operator-cluster-operator" ''
  set -euo pipefail
  echo "Testing strimzi-kafka-operator-cluster-operator image functionality..."
  ...
  echo "strimzi-kafka-operator-cluster-operator smoke test passed."
''
