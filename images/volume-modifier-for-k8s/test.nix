...
pkgs.writeShellScript "test-volume-modifier-for-k8s" ''
  set -euo pipefail
  echo "Testing volume-modifier-for-k8s image functionality..."
  ...
  echo "volume-modifier-for-k8s smoke test passed."
''
