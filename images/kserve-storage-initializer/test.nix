...
pkgs.writeShellScript "test-kserve-storage-initializer" ''
  set -euo pipefail
  echo "Testing kserve-storage-initializer image functionality..."
  ...
  echo "kserve-storage-initializer smoke test passed."
''
