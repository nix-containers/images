...
pkgs.writeShellScript "test-cilium-fips-1.18-operator-generic" ''
  set -euo pipefail
  echo "Testing cilium-fips-1.18-operator-generic image..."
  ...
  echo "All cilium-fips-1.18-operator-generic tests passed!"
''
