...
pkgs.writeShellScript "test-local-static-provisioner" ''
  set -euo pipefail
  echo "Testing local-static-provisioner image functionality..."
  ...
  echo "local-static-provisioner smoke test passed."
''
