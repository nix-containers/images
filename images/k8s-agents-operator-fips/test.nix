...
pkgs.writeShellScript "test-k8s-agents-operator-fips" ''
  set -euo pipefail
  echo "Testing k8s-agents-operator-fips image functionality..."
  ...
  echo "k8s-agents-operator-fips smoke test passed."
''
