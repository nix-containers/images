...
pkgs.writeShellScript "test-prometheus-podman-exporter-fips" ''
  set -euo pipefail
  echo "Testing prometheus-podman-exporter-fips image..."
  ...
  echo "  Checking podman-exporter runs..."
  ...
  echo "All prometheus-podman-exporter-fips tests passed!"
''
