...
pkgs.writeShellScript "test-prometheus-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing prometheus-iamguarded-fips image..."
  ...
  echo "  Checking prometheus-iamguarded runs..."
  ...
  echo "All prometheus-iamguarded-fips tests passed!"
''
