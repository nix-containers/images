...
pkgs.writeShellScript "test-thingsboard-tb-js-executor" ''
  set -euo pipefail
  echo "Testing thingsboard-tb-js-executor image functionality..."
  ...
  echo "thingsboard-tb-js-executor smoke test passed."
''
