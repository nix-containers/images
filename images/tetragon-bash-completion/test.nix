...
pkgs.writeShellScript "test-tetragon-bash-completion" ''
  set -euo pipefail
  echo "Testing tetragon-bash-completion image functionality..."
  ...
  echo "tetragon-bash-completion smoke test passed."
''
