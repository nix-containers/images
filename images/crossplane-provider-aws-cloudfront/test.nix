...
pkgs.writeShellScript "test-crossplane-provider-aws-cloudfront" ''
  set -euo pipefail
  echo "Testing crossplane-provider-aws-cloudfront image..."
  ...
  echo "All crossplane-provider-aws-cloudfront tests passed!"
''
