...
pkgs.writeShellScript "test-mongodb-kubernetes-operator-readinessprobe" ''
  set -euo pipefail
  echo "Testing mongodb-kubernetes-operator-readinessprobe image functionality..."
  ...
  echo "mongodb-kubernetes-operator-readinessprobe smoke test passed."
''
