...
pkgs.writeShellScript "test-neuvector-enforcer-fips" ''
  set -euo pipefail
  echo "Testing neuvector-enforcer-fips image functionality..."
  ...
  echo "neuvector-enforcer-fips smoke test passed."
''
