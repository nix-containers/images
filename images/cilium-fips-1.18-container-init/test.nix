...
pkgs.writeShellScript "test-cilium-fips-1.18-container-init" ''
  set -euo pipefail
  echo "Testing cilium-fips-1.18-container-init image..."
  ...
  echo "All cilium-fips-1.18-container-init tests passed!"
''
