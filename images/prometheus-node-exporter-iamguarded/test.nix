...
pkgs.writeShellScript "test-prometheus-node-exporter-iamguarded" ''
  set -euo pipefail
  echo "Testing prometheus-node-exporter-iamguarded image..."
  ...
  echo "All prometheus-node-exporter-iamguarded tests passed!"
''
