...
pkgs.writeShellScript "test-cilium-1.18-clustermesh-apiserver" ''
  set -euo pipefail
  echo "Testing cilium-1.18-clustermesh-apiserver image..."
  ...
  echo "All cilium-1.18-clustermesh-apiserver tests passed!"
''
