...
pkgs.writeShellScript "test-mountpoint-s3-csi-driver" ''
  set -euo pipefail
  echo "Testing mountpoint-s3-csi-driver image functionality..."
  ...
  echo "mountpoint-s3-csi-driver smoke test passed."
''
