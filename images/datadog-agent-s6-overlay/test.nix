...
pkgs.writeShellScript "test-datadog-agent-s6-overlay" ''
  set -euo pipefail
  echo "Testing datadog-agent-s6-overlay image functionality..."
  ...
  echo "datadog-agent-s6-overlay smoke test passed."
''
