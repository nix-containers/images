...
pkgs.writeShellScript "test-newrelic-fluent-bit-output-fips" ''
  set -euo pipefail
  echo "Testing newrelic-fluent-bit-output-fips image functionality..."
  ...
  echo "newrelic-fluent-bit-output-fips smoke test passed."
''
