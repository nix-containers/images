...
pkgs.writeShellScript "test-prometheus-mysqld-exporter-nixchart" ''
  set -euo pipefail
  echo "Testing prometheus-mysqld-exporter-nixchart image..."
  ...
  echo "  Checking prometheus-mysqld-exporter-nixchart runs..."
  ...
  echo "All prometheus-mysqld-exporter-nixchart tests passed!"
''
