...
pkgs.writeShellScript "test-x509-certificate-exporter" ''
  set -euo pipefail
  echo "Testing x509-certificate-exporter image functionality..."
  ...
  echo "x509-certificate-exporter smoke test passed."
''
