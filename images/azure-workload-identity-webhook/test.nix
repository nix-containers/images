...
pkgs.writeShellScript "test-azure-workload-identity-webhook" ''
  set -euo pipefail
  echo "Testing azure-workload-identity-webhook image functionality..."
  ...
  echo "azure-workload-identity-webhook smoke test passed."
''
