...
pkgs.writeShellScript "test-chainguard-security-guide" ''
  set -euo pipefail
  echo "Testing chainguard-security-guide image functionality..."
  ...
  echo "chainguard-security-guide smoke test passed."
''
