...
pkgs.writeShellScript "test-kyverno-policy-reporter-plugin-trivy" ''
  set -euo pipefail
  echo "Testing kyverno-policy-reporter-plugin-trivy image..."
  ...
  echo "All kyverno-policy-reporter-plugin-trivy tests passed!"
''
