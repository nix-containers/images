...
pkgs.writeShellScript "test-container-object-storage-interface-controller-fips" ''
  set -euo pipefail
  echo "Testing container-object-storage-interface-controller-fips image functionality..."
  ...
  echo "container-object-storage-interface-controller-fips smoke test passed."
''
