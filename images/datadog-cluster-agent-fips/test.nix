...
pkgs.writeShellScript "test-datadog-cluster-agent-fips" ''
  set -euo pipefail
  echo "Testing datadog-cluster-agent-fips image functionality..."
  ...
  echo "datadog-cluster-agent-fips smoke test passed."
''
