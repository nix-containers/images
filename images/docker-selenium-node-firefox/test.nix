...
pkgs.writeShellScript "test-docker-selenium-node-firefox" ''
  set -euo pipefail
  echo "Testing docker-selenium-node-firefox image..."
  ...
  echo "All docker-selenium-node-firefox tests passed!"
''
