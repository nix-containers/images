...
pkgs.writeShellScript "test-postgres-repmgr-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing postgres-repmgr-iamguarded-fips image functionality..."
  ...
  echo "postgres-repmgr-iamguarded-fips smoke test passed."
''
