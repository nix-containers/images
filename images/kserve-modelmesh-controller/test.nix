...
pkgs.writeShellScript "test-kserve-modelmesh-controller" ''
  set -euo pipefail
  echo "Testing kserve-modelmesh-controller image functionality..."
  ...
  echo "kserve-modelmesh-controller smoke test passed."
''
