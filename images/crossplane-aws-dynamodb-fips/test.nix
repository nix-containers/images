...
pkgs.writeShellScript "test-crossplane-aws-dynamodb-fips" ''
  set -euo pipefail
  echo "Testing crossplane-aws-dynamodb-fips image..."
  ...
  echo "All crossplane-aws-dynamodb-fips tests passed!"
''
