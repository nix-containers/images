...
pkgs.writeShellScript "test-dotnet-10-targeting-pack" ''
  set -euo pipefail
  echo "Testing dotnet-10-targeting-pack image functionality..."
  ...
  echo "dotnet-10-targeting-pack smoke test passed."
''
