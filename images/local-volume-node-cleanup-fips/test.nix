...
pkgs.writeShellScript "test-local-volume-node-cleanup-fips" ''
  set -euo pipefail
  echo "Testing local-volume-node-cleanup-fips image functionality..."
  ...
  echo "local-volume-node-cleanup-fips smoke test passed."
''
