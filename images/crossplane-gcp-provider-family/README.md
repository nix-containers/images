...
```bash
# Build the image
nix build .#crossplane-gcp-provider-family

# Load into Docker
nix build .#load-crossplane-gcp-provider-family-to-docker && ./result/bin/load-crossplane-gcp-provider-family-to-docker
```
