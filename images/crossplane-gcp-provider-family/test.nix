...
pkgs.writeShellScript "test-crossplane-gcp-provider-family" ''
  set -euo pipefail
  echo "Testing crossplane-gcp-provider-family image..."
  ...
  echo "All crossplane-gcp-provider-family tests passed!"
''
