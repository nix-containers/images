...
pkgs.writeShellScript "test-cluster-api-azure-controller-fips" ''
  set -euo pipefail
  echo "Testing cluster-api-azure-controller-fips image..."
  ...
  echo "All cluster-api-azure-controller-fips tests passed!"
''
