...
pkgs.writeShellScript "test-prometheus-mongodb-exporter-iamguarded" ''
  set -euo pipefail
  echo "Testing prometheus-mongodb-exporter-iamguarded image..."
  ...
  echo "  Checking prometheus-mongodb-exporter-iamguarded runs..."
  ...
  echo "All prometheus-mongodb-exporter-iamguarded tests passed!"
''
