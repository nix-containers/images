...
pkgs.writeShellScript "test-katib-file-metricscollector" ''
  set -euo pipefail
  echo "Testing katib-file-metricscollector image functionality..."
  ...
  echo "katib-file-metricscollector smoke test passed."
''
