...
pkgs.writeShellScript "test-seaweedfs-operator-fips" ''
  set -euo pipefail
  echo "Testing seaweedfs-operator-fips image functionality..."
  ...
  echo "seaweedfs-operator-fips smoke test passed."
''
