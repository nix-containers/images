...
let
  ...
  drv = pkgs.buildGoModule {
    pname = "helm-chartmuseum"; inherit version;
...
in mkImage { inherit drv; name = "helm-chartmuseum"; tag = "v${version}"; entrypoint = [ "${drv}/bin/chartmuseum" ]; cmd = [ "--help" ]; labels = { "org.opencontainers.image.title" = "helm-chartmuseum"; "org.opencontainers.image.version" = version; "io.nix-containers.source" = "upstream-source"; }; }
