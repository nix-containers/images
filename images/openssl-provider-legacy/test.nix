...
pkgs.writeShellScript "test-openssl-provider-legacy" ''
  set -euo pipefail
  echo "Testing openssl-provider-legacy image functionality..."
  ...
  echo "openssl-provider-legacy smoke test passed."
''
