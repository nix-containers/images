...
pkgs.writeShellScript "test-cloud-provider-gcp-cloud-controller-manager" ''
  set -euo pipefail
  echo "Testing cloud-provider-gcp-cloud-controller-manager image functionality..."
  ...
  echo "cloud-provider-gcp-cloud-controller-manager smoke test passed."
''
