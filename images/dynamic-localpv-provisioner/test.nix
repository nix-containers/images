...
pkgs.writeShellScript "test-dynamic-localpv-provisioner" ''
  set -euo pipefail
  echo "Testing dynamic-localpv-provisioner image functionality..."
  ...
  echo "dynamic-localpv-provisioner smoke test passed."
''
