...
pkgs.writeShellScript "test-local-volume-provisioner" ''
  set -euo pipefail
  echo "Testing local-volume-provisioner image functionality..."
  ...
  echo "local-volume-provisioner smoke test passed."
''
