...
pkgs.writeShellScript "test-rabbitmq-cluster-operator-nixchart" ''
  set -euo pipefail
  echo "Testing rabbitmq-cluster-operator-nixchart image..."
  ...
  echo "All rabbitmq-cluster-operator-nixchart tests passed!"
''
