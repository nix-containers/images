...
pkgs.writeShellScript "test-nginx-prometheus-exporter-fips" ''
  set -euo pipefail
  echo "Testing nginx-prometheus-exporter-fips image functionality..."
  ...
  echo "nginx-prometheus-exporter-fips smoke test passed."
''
