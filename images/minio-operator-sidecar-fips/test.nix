...
pkgs.writeShellScript "test-minio-operator-sidecar-fips" ''
  set -euo pipefail
  echo "Testing minio-operator-sidecar-fips image functionality..."
  ...
  echo "minio-operator-sidecar-fips smoke test passed."
''
