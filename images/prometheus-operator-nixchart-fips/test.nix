...
pkgs.writeShellScript "test-prometheus-operator-nixchart-fips" ''
  set -euo pipefail
  echo "Testing prometheus-operator-nixchart-fips image..."
  ...
  echo "All prometheus-operator-nixchart-fips tests passed!"
''
