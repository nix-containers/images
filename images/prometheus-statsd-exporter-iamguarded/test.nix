...
pkgs.writeShellScript "test-prometheus-statsd-exporter-iamguarded" ''
  set -euo pipefail
  echo "Testing prometheus-statsd-exporter-iamguarded image..."
  ...
  echo "All prometheus-statsd-exporter-iamguarded tests passed!"
''
