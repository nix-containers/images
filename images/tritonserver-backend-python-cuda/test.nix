...
pkgs.writeShellScript "test-tritonserver-backend-python-cuda" ''
  set -euo pipefail
  echo "Testing tritonserver-backend-python-cuda image functionality..."
  ...
  echo "tritonserver-backend-python-cuda smoke test passed."
''
