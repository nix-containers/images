...
pkgs.writeShellScript "test-docker-selenium-standalone-chromium" ''
  set -euo pipefail
  echo "Testing docker-selenium-standalone-chromium image..."
  ...
  echo "All docker-selenium-standalone-chromium tests passed!"
''
