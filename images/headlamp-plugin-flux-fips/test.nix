...
pkgs.writeShellScript "test-headlamp-plugin-flux-fips" ''
  set -euo pipefail
  echo "Testing headlamp-plugin-flux-fips image functionality..."
  ...
  echo "headlamp-plugin-flux-fips smoke test passed."
''
