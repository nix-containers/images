...
pkgs.writeShellScript "test-nginx-prometheus-exporter-iamguarded" ''
  set -euo pipefail
  echo "Testing nginx-prometheus-exporter-iamguarded image..."
  ...
  echo "All nginx-prometheus-exporter-iamguarded tests passed!"
''
