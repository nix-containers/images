...
pkgs.writeShellScript "test-sealed-secrets-controller" ''
  set -euo pipefail
  echo "Testing sealed-secrets-controller image functionality..."
  ...
  echo "sealed-secrets-controller smoke test passed."
''
