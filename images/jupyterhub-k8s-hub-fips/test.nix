...
pkgs.writeShellScript "test-jupyterhub-k8s-hub-fips" ''
  set -euo pipefail
  echo "Testing jupyterhub-k8s-hub-fips image functionality..."
  ...
  echo "jupyterhub-k8s-hub-fips smoke test passed."
''
