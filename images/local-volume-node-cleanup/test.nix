...
pkgs.writeShellScript "test-local-volume-node-cleanup" ''
  set -euo pipefail
  echo "Testing local-volume-node-cleanup image functionality..."
  ...
  echo "local-volume-node-cleanup smoke test passed."
''
