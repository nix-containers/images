...
pkgs.writeShellScript "test-nginx-prometheus-exporter-nixchart" ''
  set -euo pipefail
  echo "Testing nginx-prometheus-exporter-nixchart image..."
  ...
  echo "All nginx-prometheus-exporter-nixchart tests passed!"
''
