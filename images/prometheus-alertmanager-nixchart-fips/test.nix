...
pkgs.writeShellScript "test-prometheus-alertmanager-nixchart-fips" ''
  set -euo pipefail
  echo "Testing prometheus-alertmanager-nixchart-fips image..."
  ...
  echo "All prometheus-alertmanager-nixchart-fips tests passed!"
''
