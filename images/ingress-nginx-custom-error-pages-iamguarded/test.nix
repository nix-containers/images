...
pkgs.writeShellScript "test-ingress-nginx-custom-error-pages-iamguarded" ''
  set -euo pipefail
  echo "Testing ingress-nginx-custom-error-pages-iamguarded image functionality..."
  ...
  echo "ingress-nginx-custom-error-pages-iamguarded smoke test passed."
''
