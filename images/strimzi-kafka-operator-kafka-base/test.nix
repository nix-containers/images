...
pkgs.writeShellScript "test-strimzi-kafka-operator-kafka-base" ''
  set -euo pipefail
  echo "Testing strimzi-kafka-operator-kafka-base image functionality..."
  ...
  echo "strimzi-kafka-operator-kafka-base smoke test passed."
''
