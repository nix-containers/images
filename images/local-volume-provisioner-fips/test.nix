...
pkgs.writeShellScript "test-local-volume-provisioner-fips" ''
  set -euo pipefail
  echo "Testing local-volume-provisioner-fips image functionality..."
  ...
  echo "local-volume-provisioner-fips smoke test passed."
''
