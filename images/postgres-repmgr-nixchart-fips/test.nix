...
pkgs.writeShellScript "test-postgres-repmgr-nixchart-fips" ''
  set -euo pipefail
  echo "Testing postgres-repmgr-nixchart-fips image functionality..."
  ...
  echo "postgres-repmgr-nixchart-fips smoke test passed."
''
