...
pkgs.writeShellScript "test-apache-nifi-registry-toolkit" ''
  set -euo pipefail
  echo "Testing apache-nifi-registry-toolkit image functionality..."
  ...
  echo "apache-nifi-registry-toolkit smoke test passed."
''
