...
pkgs.writeShellScript "test-secrets-store-csi-driver-provider-azure" ''
  set -euo pipefail
  echo "Testing secrets-store-csi-driver-provider-azure image functionality..."
  ...
  echo "secrets-store-csi-driver-provider-azure smoke test passed."
''
