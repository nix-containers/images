...
pkgs.writeShellScript "test-prometheus-nixchart" ''
  set -euo pipefail
  echo "Testing prometheus-nixchart image..."
  ...
  echo "  Checking prometheus-nixchart runs..."
  ...
  echo "All prometheus-nixchart tests passed!"
''
