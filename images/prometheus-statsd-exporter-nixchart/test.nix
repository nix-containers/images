...
pkgs.writeShellScript "test-prometheus-statsd-exporter-nixchart" ''
  set -euo pipefail
  echo "Testing prometheus-statsd-exporter-nixchart image..."
  ...
  echo "All prometheus-statsd-exporter-nixchart tests passed!"
''
