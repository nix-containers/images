...
pkgs.writeShellScript "test-tritonserver-backend-tensorrt-cuda" ''
  set -euo pipefail
  echo "Testing tritonserver-backend-tensorrt-cuda image functionality..."
  ...
  echo "tritonserver-backend-tensorrt-cuda smoke test passed."
''
