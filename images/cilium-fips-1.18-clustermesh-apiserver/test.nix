...
pkgs.writeShellScript "test-cilium-fips-1.18-clustermesh-apiserver" ''
  set -euo pipefail
  echo "Testing cilium-fips-1.18-clustermesh-apiserver image..."
  ...
  echo "All cilium-fips-1.18-clustermesh-apiserver tests passed!"
''
