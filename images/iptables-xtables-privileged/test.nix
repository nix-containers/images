...
pkgs.writeShellScript "test-iptables-xtables-privileged" ''
  set -euo pipefail
  echo "Testing iptables-xtables-privileged image functionality..."
  ...
  echo "iptables-xtables-privileged smoke test passed."
''
