...
pkgs.writeShellScript "test-verticadb-operator-fips" ''
  set -euo pipefail
  echo "Testing verticadb-operator-fips image functionality..."
  ...
  echo "verticadb-operator-fips smoke test passed."
''
