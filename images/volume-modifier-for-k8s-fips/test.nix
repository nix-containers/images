...
pkgs.writeShellScript "test-volume-modifier-for-k8s-fips" ''
  set -euo pipefail
  echo "Testing volume-modifier-for-k8s-fips image functionality..."
  ...
  echo "volume-modifier-for-k8s-fips smoke test passed."
''
