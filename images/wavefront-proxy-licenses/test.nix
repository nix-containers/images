...
pkgs.writeShellScript "test-wavefront-proxy-licenses" ''
  set -euo pipefail
  echo "Testing wavefront-proxy-licenses image functionality..."
  ...
  echo "wavefront-proxy-licenses smoke test passed."
''
