...
pkgs.writeShellScript "test-newrelic-fluent-bit-output" ''
  set -euo pipefail
  echo "Testing newrelic-fluent-bit-output image functionality..."
  ...
  echo "newrelic-fluent-bit-output smoke test passed."
''
