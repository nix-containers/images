...
pkgs.writeShellScript "test-harbor-registryctl-fips" ''
  set -euo pipefail
  echo "Testing harbor-registryctl-fips image functionality..."
  ...
  echo "harbor-registryctl-fips smoke test passed."
''
