...
pkgs.writeShellScript "test-amazon-cloudwatch-agent-operator" ''
  set -euo pipefail
  echo "Testing amazon-cloudwatch-agent-operator image functionality..."
  ...
  echo "amazon-cloudwatch-agent-operator smoke test passed."
''
