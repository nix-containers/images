...
pkgs.writeShellScript "test-dynamic-localpv-provisioner-fips" ''
  set -euo pipefail
  echo "Testing dynamic-localpv-provisioner-fips image functionality..."
  ...
  echo "dynamic-localpv-provisioner-fips smoke test passed."
''
