...
pkgs.writeShellScript "test-secrets-store-csi-driver" ''
  set -euo pipefail
  echo "Testing secrets-store-csi-driver image functionality..."
  ...
  echo "secrets-store-csi-driver smoke test passed."
''
