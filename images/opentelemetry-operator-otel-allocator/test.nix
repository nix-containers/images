...
pkgs.writeShellScript "test-opentelemetry-operator-otel-allocator" ''
  set -euo pipefail
  echo "Testing opentelemetry-operator-otel-allocator image functionality..."
  ...
  echo "opentelemetry-operator-otel-allocator smoke test passed."
''
