...
pkgs.writeShellScript "test-newrelic-k8s-metadata-injection-fips" ''
  set -euo pipefail
  echo "Testing newrelic-k8s-metadata-injection-fips image functionality..."
  ...
  echo "newrelic-k8s-metadata-injection-fips smoke test passed."
''
