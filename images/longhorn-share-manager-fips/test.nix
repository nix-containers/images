...
pkgs.writeShellScript "test-longhorn-share-manager-fips" ''
  set -euo pipefail
  echo "Testing longhorn-share-manager-fips image functionality..."
  ...
  echo "longhorn-share-manager-fips smoke test passed."
''
