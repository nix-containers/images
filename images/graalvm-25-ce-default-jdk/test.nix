...
pkgs.writeShellScript "test-graalvm-25-ce-default-jdk" ''
  set -euo pipefail
  echo "Testing graalvm-25-ce-default-jdk image functionality..."
  ...
  echo "graalvm-25-ce-default-jdk smoke test passed."
''
