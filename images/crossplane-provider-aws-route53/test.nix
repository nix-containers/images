...
pkgs.writeShellScript "test-crossplane-provider-aws-route53" ''
  set -euo pipefail
  echo "Testing crossplane-provider-aws-route53 image..."
  ...
  echo "All crossplane-provider-aws-route53 tests passed!"
''
