...
pkgs.writeShellScript "test-crossplane-provider-aws-cloudfront-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-aws-cloudfront-fips image..."
  ...
  echo "All crossplane-provider-aws-cloudfront-fips tests passed!"
''
