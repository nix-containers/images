...
pkgs.writeShellScript "test-amazon-cloudwatch-agent-config-downloader-fips" ''
  set -euo pipefail
  echo "Testing amazon-cloudwatch-agent-config-downloader-fips image functionality..."
  ...
  echo "amazon-cloudwatch-agent-config-downloader-fips smoke test passed."
''
