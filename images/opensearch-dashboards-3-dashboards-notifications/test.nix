...
pkgs.writeShellScript "test-opensearch-dashboards-3-dashboards-notifications" ''
  set -euo pipefail
  echo "Testing opensearch-dashboards-3-dashboards-notifications image..."
  ...
  echo "All opensearch-dashboards-3-dashboards-notifications tests passed!"
''
