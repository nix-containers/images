...
pkgs.writeShellScript "test-text-generation-inference" ''
  set -euo pipefail
  echo "Testing text-generation-inference image functionality..."
  ...
  echo "text-generation-inference smoke test passed."
''
