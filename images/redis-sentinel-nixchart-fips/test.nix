...
pkgs.writeShellScript "test-redis-sentinel-nixchart-fips" ''
  set -euo pipefail
  echo "Testing redis-sentinel-nixchart-fips image..."
  ...
  echo "All redis-sentinel-nixchart-fips tests passed!"
''
