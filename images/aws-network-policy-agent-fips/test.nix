...
pkgs.writeShellScript "test-aws-network-policy-agent-fips" ''
  set -euo pipefail
  echo "Testing aws-network-policy-agent-fips image..."
  ...
  echo "All aws-network-policy-agent-fips tests passed!"
''
