...
pkgs.writeShellScript "test-prometheus-yet-another-cloudwatch-exporter-fips" ''
  set -euo pipefail
  echo "Testing prometheus-yet-another-cloudwatch-exporter-fips image..."
  ...
  echo "All prometheus-yet-another-cloudwatch-exporter-fips tests passed!"
''
