...
pkgs.writeShellScript "test-adoptium-openjdk-bcfips-policy-140-3-j21" ''
  set -euo pipefail
  echo "Testing adoptium-openjdk-bcfips-policy-140-3-j21 image functionality..."
  ...
  echo "adoptium-openjdk-bcfips-policy-140-3-j21 smoke test passed."
''
