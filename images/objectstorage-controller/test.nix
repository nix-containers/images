...
pkgs.writeShellScript "test-objectstorage-controller" ''
  set -euo pipefail
  echo "Testing objectstorage-controller image functionality..."
  ...
  echo "objectstorage-controller smoke test passed."
''
