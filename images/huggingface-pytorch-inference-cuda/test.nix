...
pkgs.writeShellScript "test-huggingface-pytorch-inference-cuda" ''
  set -euo pipefail
  echo "Testing huggingface-pytorch-inference-cuda image functionality..."
  ...
  echo "huggingface-pytorch-inference-cuda smoke test passed."
''
