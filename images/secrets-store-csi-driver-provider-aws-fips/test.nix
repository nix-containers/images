...
pkgs.writeShellScript "test-secrets-store-csi-driver-provider-aws-fips" ''
  set -euo pipefail
  echo "Testing secrets-store-csi-driver-provider-aws-fips image functionality..."
  ...
  echo "secrets-store-csi-driver-provider-aws-fips smoke test passed."
''
