...
pkgs.writeShellScript "test-ratify-fips-schemavalidator" ''
  set -euo pipefail
  echo "Testing ratify-fips-schemavalidator image functionality..."
  ...
  echo "ratify-fips-schemavalidator smoke test passed."
''
