...
pkgs.writeShellScript "test-terraform-provider-azurerm" ''
  set -euo pipefail
  echo "Testing terraform-provider-azurerm image functionality..."
  ...
  echo "terraform-provider-azurerm smoke test passed."
''
