...
pkgs.writeShellScript "test-neuvector-prometheus-exporter-fips" ''
  set -euo pipefail
  echo "Testing neuvector-prometheus-exporter-fips image functionality..."
  ...
  echo "neuvector-prometheus-exporter-fips smoke test passed."
''
