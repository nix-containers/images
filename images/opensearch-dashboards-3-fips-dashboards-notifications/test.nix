...
pkgs.writeShellScript "test-opensearch-dashboards-3-fips-dashboards-notifications" ''
  set -euo pipefail
  echo "Testing opensearch-dashboards-3-fips-dashboards-notifications image..."
  ...
  echo "All opensearch-dashboards-3-fips-dashboards-notifications tests passed!"
''
