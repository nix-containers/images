...
pkgs.writeShellScript "test-jmx-exporter-iamguarded" ''
  set -euo pipefail
  echo "Testing jmx-exporter-iamguarded image functionality..."
  ...
  echo "jmx-exporter-iamguarded smoke test passed."
''
