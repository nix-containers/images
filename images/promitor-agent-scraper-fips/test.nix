...
pkgs.writeShellScript "test-promitor-agent-scraper-fips" ''
  set -euo pipefail
  echo "Testing promitor-agent-scraper-fips image functionality..."
  ...
  echo "promitor-agent-scraper-fips smoke test passed."
''
