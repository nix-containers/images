...
pkgs.writeShellScript "test-tetragon-bash-completion-fips" ''
  set -euo pipefail
  echo "Testing tetragon-bash-completion-fips image functionality..."
  ...
  echo "tetragon-bash-completion-fips smoke test passed."
''
