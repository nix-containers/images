...
pkgs.writeShellScript "test-cluster-api-kubeadm-bootstrap-controller" ''
  set -euo pipefail
  echo "Testing cluster-api-kubeadm-bootstrap-controller image..."
  ...
  echo "All cluster-api-kubeadm-bootstrap-controller tests passed!"
''
