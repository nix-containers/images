...
pkgs.writeShellScript "test-ntia-conformance-checker" ''
  set -euo pipefail
  echo "Testing ntia-conformance-checker image functionality..."
  ...
  echo "ntia-conformance-checker smoke test passed."
''
