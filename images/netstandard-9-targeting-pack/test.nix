...
pkgs.writeShellScript "test-netstandard-9-targeting-pack" ''
  set -euo pipefail
  echo "Testing netstandard-9-targeting-pack image functionality..."
  ...
  echo "netstandard-9-targeting-pack smoke test passed."
''
