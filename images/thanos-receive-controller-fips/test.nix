...
pkgs.writeShellScript "test-thanos-receive-controller-fips" ''
  set -euo pipefail
  echo "Testing thanos-receive-controller-fips image functionality..."
  ...
  echo "thanos-receive-controller-fips smoke test passed."
''
