...
pkgs.writeShellScript "test-kubectl-bash-completion-fips" ''
  set -euo pipefail
  echo "Testing kubectl-bash-completion-fips image..."
  ...
  echo "All kubectl-bash-completion-fips tests passed!"
''
