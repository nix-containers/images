...
pkgs.writeShellScript "test-opensearch-dashboards-3-fips" ''
  set -euo pipefail
  echo "Testing opensearch-dashboards-3-fips image..."
  ...
  echo "All opensearch-dashboards-3-fips tests passed!"
''
