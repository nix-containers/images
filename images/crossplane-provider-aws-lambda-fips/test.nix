...
pkgs.writeShellScript "test-crossplane-provider-aws-lambda-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-aws-lambda-fips image..."
  ...
  echo "All crossplane-provider-aws-lambda-fips tests passed!"
''
