...
pkgs.writeShellScript "test-vertical-pod-autoscaler-updater" ''
  set -euo pipefail
  echo "Testing vertical-pod-autoscaler-updater image functionality..."
  ...
  echo "vertical-pod-autoscaler-updater smoke test passed."
''
