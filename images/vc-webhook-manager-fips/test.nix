...
pkgs.writeShellScript "test-vc-webhook-manager-fips" ''
  set -euo pipefail
  echo "Testing vc-webhook-manager-fips image functionality..."
  ...
  echo "vc-webhook-manager-fips smoke test passed."
''
