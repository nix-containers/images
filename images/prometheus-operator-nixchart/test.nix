...
pkgs.writeShellScript "test-prometheus-operator-nixchart" ''
  set -euo pipefail
  echo "Testing prometheus-operator-nixchart image..."
  ...
  echo "  Checking prometheus-operator-nixchart runs..."
  ...
  echo "All prometheus-operator-nixchart tests passed!"
''
