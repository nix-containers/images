...
pkgs.writeShellScript "test-katib-suggestion-nas-darts" ''
  set -euo pipefail
  echo "Testing katib-suggestion-nas-darts image functionality..."
  ...
  echo "katib-suggestion-nas-darts smoke test passed."
''
