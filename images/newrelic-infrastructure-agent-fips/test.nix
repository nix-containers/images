...
pkgs.writeShellScript "test-newrelic-infrastructure-agent-fips" ''
  set -euo pipefail
  echo "Testing newrelic-infrastructure-agent-fips image functionality..."
  ...
  echo "newrelic-infrastructure-agent-fips smoke test passed."
''
