...
pkgs.writeShellScript "test-zookeeper-nixchart-fips" ''
  set -euo pipefail
  echo "Testing zookeeper-nixchart-fips image functionality..."
  ...
  echo "zookeeper-nixchart-fips smoke test passed."
''
