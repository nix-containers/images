...
in nix2container.buildImage {
  name = "rabbitmq-cluster-operator-nixchart-fips";
  tag = pkgs.rabbitmq-server.version;
  copyToRoot = [
    (buildEnv {
      name = "rabbitmq-cluster-operator-nixchart-fips-root";
  ...
  config = nonRoot.defaultConfig // {
    ...
    Labels = base.defaultLabels // {
      ...
      "org.opencontainers.image.title" = "rabbitmq-cluster-operator-nixchart-fips";
