...
pkgs.writeShellScript "test-prometheus-mongodb-exporter-fips" ''
  set -euo pipefail
  echo "Testing prometheus-mongodb-exporter-fips image..."
  ...
  echo "  Checking mongodb-exporter runs..."
  ...
  echo "All prometheus-mongodb-exporter-fips tests passed!"
''
