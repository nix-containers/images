...
pkgs.writeShellScript "test-cluster-api-fips-1.9-clusterctl" ''
  set -euo pipefail
  echo "Testing cluster-api-fips-1.9-clusterctl image..."
  ...
  echo "All cluster-api-fips-1.9-clusterctl tests passed!"
''
