...
pkgs.writeShellScript "test-grafana-rollout-operator" ''
  set -euo pipefail
  echo "Testing grafana-rollout-operator image functionality..."
  ...
  echo "grafana-rollout-operator smoke test passed."
''
