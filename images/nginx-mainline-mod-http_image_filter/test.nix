...
pkgs.writeShellScript "test-nginx-mainline-mod-http_image_filter" ''
  set -euo pipefail
  echo "Testing nginx-mainline-mod-http_image_filter image functionality..."
  ...
  echo "nginx-mainline-mod-http_image_filter smoke test passed."
''
