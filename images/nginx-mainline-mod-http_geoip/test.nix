...
pkgs.writeShellScript "test-nginx-mainline-mod-http_geoip" ''
  set -euo pipefail
  echo "Testing nginx-mainline-mod-http_geoip image functionality..."
  ...
  echo "nginx-mainline-mod-http_geoip smoke test passed."
''
