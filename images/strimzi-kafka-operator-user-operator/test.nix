...
pkgs.writeShellScript "test-strimzi-kafka-operator-user-operator" ''
  set -euo pipefail
  echo "Testing strimzi-kafka-operator-user-operator image functionality..."
  ...
  echo "strimzi-kafka-operator-user-operator smoke test passed."
''
