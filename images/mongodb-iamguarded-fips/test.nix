...
pkgs.writeShellScript "test-mongodb-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing mongodb-iamguarded-fips image functionality..."
  ...
  echo "mongodb-iamguarded-fips smoke test passed."
''
