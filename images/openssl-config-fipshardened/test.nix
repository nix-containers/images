...
pkgs.writeShellScript "test-openssl-config-fipshardened" ''
  set -euo pipefail
  echo "Testing openssl-config-fipshardened image functionality..."
  ...
  echo "openssl-config-fipshardened smoke test passed."
''
