...
pkgs.writeShellScript "test-opentelemetry-operator-fips-otel-allocator" ''
  set -euo pipefail
  echo "Testing opentelemetry-operator-fips-otel-allocator image functionality..."
  ...
  echo "opentelemetry-operator-fips-otel-allocator smoke test passed."
''
