...
```bash
# Build the image
nix build .#kubernetes-event-exporter-nixchart

# Load into Docker
nix build .#load-kubernetes-event-exporter-nixchart-to-docker && ./result/bin/load-kubernetes-event-exporter-nixchart-to-docker
```
