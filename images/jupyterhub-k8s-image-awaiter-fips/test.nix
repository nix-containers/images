...
pkgs.writeShellScript "test-jupyterhub-k8s-image-awaiter-fips" ''
  set -euo pipefail
  echo "Testing jupyterhub-k8s-image-awaiter-fips image functionality..."
  ...
  echo "jupyterhub-k8s-image-awaiter-fips smoke test passed."
''
