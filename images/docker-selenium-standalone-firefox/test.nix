...
pkgs.writeShellScript "test-docker-selenium-standalone-firefox" ''
  set -euo pipefail
  echo "Testing docker-selenium-standalone-firefox image..."
  ...
  echo "All docker-selenium-standalone-firefox tests passed!"
''
