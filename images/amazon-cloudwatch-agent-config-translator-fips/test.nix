...
pkgs.writeShellScript "test-amazon-cloudwatch-agent-config-translator-fips" ''
  set -euo pipefail
  echo "Testing amazon-cloudwatch-agent-config-translator-fips image functionality..."
  ...
  echo "amazon-cloudwatch-agent-config-translator-fips smoke test passed."
''
