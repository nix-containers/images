...
pkgs.writeShellScript "test-redis-server-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing redis-server-iamguarded-fips image..."
  ...
  echo "All redis-server-iamguarded-fips tests passed!"
''
