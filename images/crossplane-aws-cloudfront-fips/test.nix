...
pkgs.writeShellScript "test-crossplane-aws-cloudfront-fips" ''
  set -euo pipefail
  echo "Testing crossplane-aws-cloudfront-fips image..."
  ...
  echo "All crossplane-aws-cloudfront-fips tests passed!"
''
