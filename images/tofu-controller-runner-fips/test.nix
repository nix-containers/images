...
pkgs.writeShellScript "test-tofu-controller-runner-fips" ''
  set -euo pipefail
  echo "Testing tofu-controller-runner-fips image functionality..."
  ...
  echo "tofu-controller-runner-fips smoke test passed."
''
