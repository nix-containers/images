...
pkgs.writeShellScript "test-cyberark-secrets-provider-for-k8s" ''
  set -euo pipefail
  echo "Testing cyberark-secrets-provider-for-k8s image functionality..."
  ...
  echo "cyberark-secrets-provider-for-k8s smoke test passed."
''
