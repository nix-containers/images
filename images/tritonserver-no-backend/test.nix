...
pkgs.writeShellScript "test-tritonserver-no-backend" ''
  set -euo pipefail
  echo "Testing tritonserver-no-backend image functionality..."
  ...
  echo "tritonserver-no-backend smoke test passed."
''
