...
pkgs.writeShellScript "test-ingress-nginx-controller-fips" ''
  set -euo pipefail
  echo "Testing ingress-nginx-controller-fips image functionality..."
  ...
  echo "ingress-nginx-controller-fips smoke test passed."
''
