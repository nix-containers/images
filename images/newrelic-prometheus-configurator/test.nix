...
pkgs.writeShellScript "test-newrelic-prometheus-configurator" ''
  set -euo pipefail
  echo "Testing newrelic-prometheus-configurator image functionality..."
  ...
  echo "newrelic-prometheus-configurator smoke test passed."
''
