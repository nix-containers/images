...
pkgs.writeShellScript "test-crossplane-provider-family-aws-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-family-aws-fips image..."
  ...
  echo "All crossplane-provider-family-aws-fips tests passed!"
''
