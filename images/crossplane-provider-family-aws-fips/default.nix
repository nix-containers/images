...
# Crossplane Provider - provider-family-aws-fips
...
mkImage {
  drv = provider;
  name = "crossplane-provider-family-aws-fips";
  tag = "v${version}";
  ...
  labels = {
    "org.opencontainers.image.title" = "crossplane-provider-family-aws-fips";
