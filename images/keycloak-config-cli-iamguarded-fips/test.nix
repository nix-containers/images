...
pkgs.writeShellScript "test-keycloak-config-cli-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing keycloak-config-cli-iamguarded-fips image functionality..."
  ...
  echo "keycloak-config-cli-iamguarded-fips smoke test passed."
''
