...
pkgs.writeShellScript "test-crossplane-provider-aws-sns-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-aws-sns-fips image..."
  ...
  echo "All crossplane-provider-aws-sns-fips tests passed!"
''
