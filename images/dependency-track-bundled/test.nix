...
pkgs.writeShellScript "test-dependency-track-bundled" ''
  set -euo pipefail
  echo "Testing dependency-track-bundled image functionality..."
  ...
  echo "dependency-track-bundled smoke test passed."
''
