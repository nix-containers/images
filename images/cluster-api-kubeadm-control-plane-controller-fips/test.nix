...
pkgs.writeShellScript "test-cluster-api-kubeadm-control-plane-controller-fips" ''
  set -euo pipefail
  echo "Testing cluster-api-kubeadm-control-plane-controller-fips image..."
  ...
  echo "All cluster-api-kubeadm-control-plane-controller-fips tests passed!"
''
