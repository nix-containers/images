...
pkgs.writeShellScript "test-sriov-network-device-plugin" ''
  set -euo pipefail
  echo "Testing sriov-network-device-plugin image functionality..."
  ...
  echo "sriov-network-device-plugin smoke test passed."
''
