...
pkgs.writeShellScript "test-vertical-pod-autoscaler-admission-controller" ''
  set -euo pipefail
  echo "Testing vertical-pod-autoscaler-admission-controller image functionality..."
  ...
  echo "vertical-pod-autoscaler-admission-controller smoke test passed."
''
