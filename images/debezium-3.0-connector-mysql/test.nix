...
pkgs.writeShellScript "test-debezium-3.0-connector-mysql" ''
  set -euo pipefail
  echo "Testing debezium-3.0-connector-mysql image..."
  ...
  echo "All debezium-3.0-connector-mysql tests passed!"
''
