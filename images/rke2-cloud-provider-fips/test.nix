...
pkgs.writeShellScript "test-rke2-cloud-provider-fips" ''
  set -euo pipefail
  echo "Testing rke2-cloud-provider-fips image functionality..."
  ...
  echo "rke2-cloud-provider-fips smoke test passed."
''
