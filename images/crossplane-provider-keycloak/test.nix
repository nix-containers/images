...
pkgs.writeShellScript "test-crossplane-provider-keycloak" ''
  set -euo pipefail
  echo "Testing crossplane-provider-keycloak image..."
  ...
  echo "All crossplane-provider-keycloak tests passed!"
''
