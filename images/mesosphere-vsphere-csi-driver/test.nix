...
pkgs.writeShellScript "test-mesosphere-vsphere-csi-driver" ''
  set -euo pipefail
  echo "Testing mesosphere-vsphere-csi-driver image functionality..."
  ...
  echo "mesosphere-vsphere-csi-driver smoke test passed."
''
