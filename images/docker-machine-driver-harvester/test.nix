...
pkgs.writeShellScript "test-docker-machine-driver-harvester" ''
  set -euo pipefail
  echo "Testing docker-machine-driver-harvester image..."
  ...
  echo "All docker-machine-driver-harvester tests passed!"
''
