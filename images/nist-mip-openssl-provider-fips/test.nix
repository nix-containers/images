...
pkgs.writeShellScript "test-nist-mip-openssl-provider-fips" ''
  set -euo pipefail
  echo "Testing nist-mip-openssl-provider-fips image functionality..."
  ...
  echo "nist-mip-openssl-provider-fips smoke test passed."
''
