...
pkgs.writeShellScript "test-crossplane-provider-gcp-storage" ''
  set -euo pipefail
  echo "Testing crossplane-provider-gcp-storage image..."
  ...
  echo "All crossplane-provider-gcp-storage tests passed!"
''
