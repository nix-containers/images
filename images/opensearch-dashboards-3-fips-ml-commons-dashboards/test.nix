...
pkgs.writeShellScript "test-opensearch-dashboards-3-fips-ml-commons-dashboards" ''
  set -euo pipefail
  echo "Testing opensearch-dashboards-3-fips-ml-commons-dashboards image..."
  ...
  echo "All opensearch-dashboards-3-fips-ml-commons-dashboards tests passed!"
''
