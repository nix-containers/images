...
pkgs.writeShellScript "test-nginx-prometheus-exporter-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing nginx-prometheus-exporter-iamguarded-fips image..."
  ...
  echo "All nginx-prometheus-exporter-iamguarded-fips tests passed!"
''
