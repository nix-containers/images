...
pkgs.writeShellScript "test-rabbitmq-cluster-operator-fips" ''
  set -euo pipefail
  echo "Testing rabbitmq-cluster-operator-fips image functionality..."
  ...
  echo "rabbitmq-cluster-operator-fips smoke test passed."
''
