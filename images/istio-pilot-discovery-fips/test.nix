...
pkgs.writeShellScript "test-istio-pilot-discovery-fips" ''
  set -euo pipefail
  echo "Testing istio-pilot-discovery-fips image functionality..."
  ...
  echo "istio-pilot-discovery-fips smoke test passed."
''
