...
pkgs.writeShellScript "test-azure-functions-extension-bundles" ''
  set -euo pipefail
  echo "Testing azure-functions-extension-bundles image functionality..."
  ...
  echo "azure-functions-extension-bundles smoke test passed."
''
