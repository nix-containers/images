...
pkgs.writeShellScript "test-vault-csi-provider-fips" ''
  set -euo pipefail
  echo "Testing vault-csi-provider-fips image functionality..."
  ...
  echo "vault-csi-provider-fips smoke test passed."
''
