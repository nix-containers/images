...
pkgs.writeShellScript "test-opensearch-dashboards-3-dashboards-maps" ''
  set -euo pipefail
  echo "Testing opensearch-dashboards-3-dashboards-maps image..."
  ...
  echo "All opensearch-dashboards-3-dashboards-maps tests passed!"
''
