...
pkgs.writeShellScript "test-mongodb-kubernetes-operator-version-upgrade-post-start-hook-fips" ''
  set -euo pipefail
  echo "Testing mongodb-kubernetes-operator-version-upgrade-post-start-hook-fips image functionality..."
  ...
  echo "mongodb-kubernetes-operator-version-upgrade-post-start-hook-fips smoke test passed."
''
