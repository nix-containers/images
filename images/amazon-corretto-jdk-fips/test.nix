...
pkgs.writeShellScript "test-amazon-corretto-jdk-fips" ''
  set -euo pipefail
  echo "Testing amazon-corretto-jdk-fips image functionality..."
  ...
  echo "amazon-corretto-jdk-fips smoke test passed."
''
