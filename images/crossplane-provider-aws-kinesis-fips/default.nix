...
# Crossplane Provider - provider-aws-kinesis-fips
...
mkImage {
  drv = provider;
  name = "crossplane-provider-aws-kinesis-fips";
  tag = "v${version}";
  ...
  labels = {
    "org.opencontainers.image.title" = "crossplane-provider-aws-kinesis-fips";
