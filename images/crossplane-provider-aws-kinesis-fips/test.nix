...
pkgs.writeShellScript "test-crossplane-provider-aws-kinesis-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-aws-kinesis-fips image..."
  ...
  echo "All crossplane-provider-aws-kinesis-fips tests passed!"
''
