...
pkgs.writeShellScript "test-ml-metadata-store-server" ''
  set -euo pipefail
  echo "Testing ml-metadata-store-server image functionality..."
  ...
  echo "ml-metadata-store-server smoke test passed."
''
