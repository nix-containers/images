...
in nix2container.buildImage {
  ...
  copyToRoot = [
    (buildEnv {
      name = "opentelemetry-operator-target-allocator-fips-root";
  ...
  config = nonRoot.defaultConfig // {
    ...
    Labels = base.defaultLabels // {
      ...
      "org.opencontainers.image.description" = "opentelemetry-operator-target-allocator-fips container image";
