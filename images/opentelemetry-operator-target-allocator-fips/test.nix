...
pkgs.writeShellScript "test-opentelemetry-operator-target-allocator-fips" ''
  set -euo pipefail
  echo "Testing opentelemetry-operator-target-allocator-fips image functionality..."
  ...
  echo "opentelemetry-operator-target-allocator-fips smoke test passed."
''
