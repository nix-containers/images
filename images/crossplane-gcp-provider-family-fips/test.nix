...
pkgs.writeShellScript "test-crossplane-gcp-provider-family-fips" ''
  set -euo pipefail
  echo "Testing crossplane-gcp-provider-family-fips image..."
  ...
  echo "All crossplane-gcp-provider-family-fips tests passed!"
''
