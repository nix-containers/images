...
pkgs.writeShellScript "test-yunikorn-scheduler-fips" ''
  set -euo pipefail
  echo "Testing yunikorn-scheduler-fips image functionality..."
  ...
  echo "yunikorn-scheduler-fips smoke test passed."
''
