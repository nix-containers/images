...
# =============
# Placeholder for crossplane-provider-gcp container image.
...
throw "Image 'crossplane-provider-gcp' is not yet implemented. See default.nix for implementation notes."
