...
pkgs.writeShellScript "test-prometheus-yet-another-cloudwatch-exporter" ''
  set -euo pipefail
  echo "Testing prometheus-yet-another-cloudwatch-exporter image..."
  ...
  echo "All prometheus-yet-another-cloudwatch-exporter tests passed!"
''
