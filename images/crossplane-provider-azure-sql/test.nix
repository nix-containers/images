...
pkgs.writeShellScript "test-crossplane-provider-azure-sql" ''
  set -euo pipefail
  echo "Testing crossplane-provider-azure-sql image..."
  ...
  echo "All crossplane-provider-azure-sql tests passed!"
''
