...
pkgs.writeShellScript "test-katib-suggestion-optuna-enas" ''
  set -euo pipefail
  echo "Testing katib-suggestion-optuna-enas image functionality..."
  ...
  echo "katib-suggestion-optuna-enas smoke test passed."
''
