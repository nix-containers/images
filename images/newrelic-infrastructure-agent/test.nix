...
pkgs.writeShellScript "test-newrelic-infrastructure-agent" ''
  set -euo pipefail
  echo "Testing newrelic-infrastructure-agent image functionality..."
  ...
  echo "newrelic-infrastructure-agent smoke test passed."
''
