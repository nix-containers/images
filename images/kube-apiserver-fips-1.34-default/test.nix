...
pkgs.writeShellScript "test-kube-apiserver-fips-1.34-default" ''
  set -euo pipefail
  echo "Testing kube-apiserver-fips-1.34-default image..."
  ...
  echo "All kube-apiserver-fips-1.34-default tests passed!"
''
