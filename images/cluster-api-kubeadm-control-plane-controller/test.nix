...
pkgs.writeShellScript "test-cluster-api-kubeadm-control-plane-controller" ''
  set -euo pipefail
  echo "Testing cluster-api-kubeadm-control-plane-controller image..."
  ...
  echo "All cluster-api-kubeadm-control-plane-controller tests passed!"
''
