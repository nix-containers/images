...
pkgs.writeShellScript "test-nats-server-config-reloader" ''
  set -euo pipefail
  echo "Testing nats-server-config-reloader image functionality..."
  ...
  echo "nats-server-config-reloader smoke test passed."
''
