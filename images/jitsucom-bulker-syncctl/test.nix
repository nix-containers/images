...
pkgs.writeShellScript "test-jitsucom-bulker-syncctl" ''
  set -euo pipefail
  echo "Testing jitsucom-bulker-syncctl image functionality..."
  ...
  echo "jitsucom-bulker-syncctl smoke test passed."
''
