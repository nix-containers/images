...
pkgs.writeShellScript "test-k8ssandra-operator-fips" ''
  set -euo pipefail
  echo "Testing k8ssandra-operator-fips image functionality..."
  ...
  echo "k8ssandra-operator-fips smoke test passed."
''
