...
pkgs.writeShellScript "test-linkerd2-cni-repair-controller" ''
  set -euo pipefail
  echo "Testing linkerd2-cni-repair-controller image functionality..."
  ...
  echo "linkerd2-cni-repair-controller smoke test passed."
''
