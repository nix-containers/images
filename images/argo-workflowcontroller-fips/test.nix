...
pkgs.writeShellScript "test-argo-workflowcontroller-fips" ''
  set -euo pipefail
  echo "Testing argo-workflowcontroller-fips image functionality..."
  ...
  echo "argo-workflowcontroller-fips smoke test passed."
''
