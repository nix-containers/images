...
pkgs.writeShellScript "test-cloud-provider-aws-fips" ''
  set -euo pipefail
  echo "Testing cloud-provider-aws-fips image functionality..."
  ...
  echo "cloud-provider-aws-fips smoke test passed."
''
