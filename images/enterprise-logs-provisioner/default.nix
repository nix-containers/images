...
# =============
# Placeholder for enterprise-logs-provisioner container image.
...
throw "Image 'enterprise-logs-provisioner' is not yet implemented. See default.nix for implementation notes."
