...
pkgs.writeShellScript "test-prometheus-node-exporter-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing prometheus-node-exporter-iamguarded-fips image..."
  ...
  echo "  Checking prometheus-node-exporter-iamguarded runs..."
  ...
  echo "All prometheus-node-exporter-iamguarded-fips tests passed!"
''
