...
pkgs.writeShellScript "test-cilium-clustermesh-apiserver-fips" ''
  set -euo pipefail
  echo "Testing cilium-clustermesh-apiserver-fips image..."
  ...
  echo "All cilium-clustermesh-apiserver-fips tests passed!"
''
