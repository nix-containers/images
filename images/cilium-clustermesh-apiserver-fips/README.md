...
```bash
# Build the image
nix build .#cilium-clustermesh-apiserver-fips

# Load into Docker
nix build .#load-cilium-clustermesh-apiserver-fips-to-docker && ./result/bin/load-cilium-clustermesh-apiserver-fips-to-docker
```
