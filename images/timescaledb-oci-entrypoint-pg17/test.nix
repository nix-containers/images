...
pkgs.writeShellScript "test-timescaledb-oci-entrypoint-pg17" ''
  set -euo pipefail
  echo "Testing timescaledb-oci-entrypoint-pg17 image functionality..."
  ...
  echo "timescaledb-oci-entrypoint-pg17 smoke test passed."
''
