...
pkgs.writeShellScript "test-metrics-server-nixchart-fips" ''
  set -euo pipefail
  echo "Testing metrics-server-nixchart-fips image functionality..."
  ...
  echo "metrics-server-nixchart-fips smoke test passed."
''
