...
pkgs.writeShellScript "test-opensearch-dashboards-3-fips-dashboards-query-workbench" ''
  set -euo pipefail
  echo "Testing opensearch-dashboards-3-fips-dashboards-query-workbench image..."
  ...
  echo "All opensearch-dashboards-3-fips-dashboards-query-workbench tests passed!"
''
