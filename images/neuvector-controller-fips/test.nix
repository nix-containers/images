...
pkgs.writeShellScript "test-neuvector-controller-fips" ''
  set -euo pipefail
  echo "Testing neuvector-controller-fips image functionality..."
  ...
  echo "neuvector-controller-fips smoke test passed."
''
