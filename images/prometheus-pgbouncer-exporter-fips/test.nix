...
pkgs.writeShellScript "test-prometheus-pgbouncer-exporter-fips" ''
  set -euo pipefail
  echo "Testing prometheus-pgbouncer-exporter-fips image..."
  ...
  echo "  Checking pgbouncer-exporter runs..."
  ...
  echo "All prometheus-pgbouncer-exporter-fips tests passed!"
''
