...
pkgs.writeShellScript "test-prometheus-redis-exporter-fips" ''
  set -euo pipefail
  echo "Testing prometheus-redis-exporter-fips image..."
  ...
  echo "All prometheus-redis-exporter-fips tests passed!"
''
