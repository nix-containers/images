...
pkgs.writeShellScript "test-velero-plugin-for-aws-fips" ''
  set -euo pipefail
  echo "Testing velero-plugin-for-aws-fips image functionality..."
  ...
  echo "velero-plugin-for-aws-fips smoke test passed."
''
