...
pkgs.writeShellScript "test-prometheus-mysqld-exporter-nixchart-fips" ''
  set -euo pipefail
  echo "Testing prometheus-mysqld-exporter-nixchart-fips image..."
  ...
  echo "All prometheus-mysqld-exporter-nixchart-fips tests passed!"
''
