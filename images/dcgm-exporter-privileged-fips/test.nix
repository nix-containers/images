...
pkgs.writeShellScript "test-dcgm-exporter-privileged-fips" ''
  set -euo pipefail
  echo "Testing dcgm-exporter-privileged-fips image functionality..."
  ...
  echo "dcgm-exporter-privileged-fips smoke test passed."
''
