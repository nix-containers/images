...
pkgs.writeShellScript "test-crossplane-provider-aws-dynamodb" ''
  set -euo pipefail
  echo "Testing crossplane-provider-aws-dynamodb image..."
  ...
  echo "All crossplane-provider-aws-dynamodb tests passed!"
''
