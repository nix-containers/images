...
pkgs.writeShellScript "test-ingress-nginx-custom-error-pages-fips" ''
  set -euo pipefail
  echo "Testing ingress-nginx-custom-error-pages-fips image functionality..."
  ...
  echo "ingress-nginx-custom-error-pages-fips smoke test passed."
''
