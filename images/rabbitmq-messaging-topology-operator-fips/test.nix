...
pkgs.writeShellScript "test-rabbitmq-messaging-topology-operator-fips" ''
  set -euo pipefail
  echo "Testing rabbitmq-messaging-topology-operator-fips image functionality..."
  ...
  echo "rabbitmq-messaging-topology-operator-fips smoke test passed."
''
