...
pkgs.writeShellScript "test-openjdk-bcfips-policy-140-3-j21" ''
  set -euo pipefail
  echo "Testing openjdk-bcfips-policy-140-3-j21 image..."
  ...
  echo "All openjdk-bcfips-policy-140-3-j21 tests passed!"
''
