...
pkgs.writeShellScript "test-strimzi-kafka-operator-kafka-agent" ''
  set -euo pipefail
  echo "Testing strimzi-kafka-operator-kafka-agent image functionality..."
  ...
  echo "strimzi-kafka-operator-kafka-agent smoke test passed."
''
