...
pkgs.writeShellScript "test-amazon-cloudwatch-agent-config-translator" ''
  set -euo pipefail
  echo "Testing amazon-cloudwatch-agent-config-translator image functionality..."
  ...
  echo "amazon-cloudwatch-agent-config-translator smoke test passed."
''
