...
# amazon-cloudwatch-agent-config-translator — UPSTREAM REFERENCE (not built/hosted). Use public.ecr.aws/cloudwatch-agent/cloudwatch-agent:1.300041.0b681 directly.
