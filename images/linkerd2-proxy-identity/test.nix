...
pkgs.writeShellScript "test-linkerd2-proxy-identity" ''
  set -euo pipefail
  echo "Testing linkerd2-proxy-identity image functionality..."
  ...
  echo "linkerd2-proxy-identity smoke test passed."
''
