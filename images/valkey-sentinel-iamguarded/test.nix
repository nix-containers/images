...
pkgs.writeShellScript "test-valkey-sentinel-iamguarded" ''
  set -euo pipefail
  echo "Testing valkey-sentinel-iamguarded image functionality..."
  ...
  echo "valkey-sentinel-iamguarded smoke test passed."
''
