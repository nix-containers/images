...
pkgs.writeShellScript "test-opensearch-dashboards-3-security-dashboards-plugin" ''
  set -euo pipefail
  echo "Testing opensearch-dashboards-3-security-dashboards-plugin image..."
  ...
  echo "All opensearch-dashboards-3-security-dashboards-plugin tests passed!"
''
