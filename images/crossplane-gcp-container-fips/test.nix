...
pkgs.writeShellScript "test-crossplane-gcp-container-fips" ''
  set -euo pipefail
  echo "Testing crossplane-gcp-container-fips image..."
  ...
  echo "All crossplane-gcp-container-fips tests passed!"
''
