...
pkgs.writeShellScript "test-eks-distro-kube-proxy-fips" ''
  set -euo pipefail
  echo "Testing eks-distro-kube-proxy-fips image functionality..."
  ...
  echo "eks-distro-kube-proxy-fips smoke test passed."
''
