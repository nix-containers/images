...
pkgs.writeShellScript "test-objectstorage-controller-fips" ''
  set -euo pipefail
  echo "Testing objectstorage-controller-fips image functionality..."
  ...
  echo "objectstorage-controller-fips smoke test passed."
''
