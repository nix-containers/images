...
pkgs.writeShellScript "test-vertical-pod-autoscaler-updater-fips" ''
  set -euo pipefail
  echo "Testing vertical-pod-autoscaler-updater-fips image functionality..."
  ...
  echo "vertical-pod-autoscaler-updater-fips smoke test passed."
''
