...
pkgs.writeShellScript "test-custom-pod-autoscaler-operator" ''
  set -euo pipefail
  echo "Testing custom-pod-autoscaler-operator image functionality..."
  ...
  echo "custom-pod-autoscaler-operator smoke test passed."
''
