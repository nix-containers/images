...
pkgs.writeShellScript "test-temporal-admin-tools-fips" ''
  set -euo pipefail
  echo "Testing temporal-admin-tools-fips image functionality..."
  ...
  echo "temporal-admin-tools-fips smoke test passed."
''
