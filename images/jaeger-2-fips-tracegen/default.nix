...
in mkImage {
  ...
  name = "jaeger-2-fips-tracegen";
  tag = "v${version}";
  entrypoint = [ "${jaeger-component}/bin/2-fips-tracegen" ];
  cmd = [];
  extraPkgs = with pkgs; [ cacert tzdata ];
  labels = {
    "org.opencontainers.image.title" = "jaeger 2 fips tracegen";
    "org.opencontainers.image.description" = "Jaeger jaeger-2-fips-tracegen";
