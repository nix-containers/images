...
pkgs.writeShellScript "test-fluent-bit-watcher-fips" ''
  set -euo pipefail
  echo "Testing fluent-bit-watcher-fips image functionality..."
  ...
  echo "fluent-bit-watcher-fips smoke test passed."
''
