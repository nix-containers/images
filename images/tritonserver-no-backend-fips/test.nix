...
pkgs.writeShellScript "test-tritonserver-no-backend-fips" ''
  set -euo pipefail
  echo "Testing tritonserver-no-backend-fips image functionality..."
  ...
  echo "tritonserver-no-backend-fips smoke test passed."
''
