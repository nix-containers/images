...
pkgs.writeShellScript "test-velero-plugin-for-microsoft-azure-fips" ''
  set -euo pipefail
  echo "Testing velero-plugin-for-microsoft-azure-fips image functionality..."
  ...
  echo "velero-plugin-for-microsoft-azure-fips smoke test passed."
''
