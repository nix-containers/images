...
pkgs.writeShellScript "test-prometheus-redis-exporter-nixchart" ''
  set -euo pipefail
  echo "Testing prometheus-redis-exporter-nixchart image..."
  ...
  echo "All prometheus-redis-exporter-nixchart tests passed!"
''
