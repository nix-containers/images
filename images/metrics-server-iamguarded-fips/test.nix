...
pkgs.writeShellScript "test-metrics-server-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing metrics-server-iamguarded-fips image functionality..."
  ...
  echo "metrics-server-iamguarded-fips smoke test passed."
''
