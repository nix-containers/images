...
pkgs.writeShellScript "test-cluster-api-fips-1.9-kubeadm-control-plane-controller" ''
  set -euo pipefail
  echo "Testing cluster-api-fips-1.9-kubeadm-control-plane-controller image..."
  ...
  echo "All cluster-api-fips-1.9-kubeadm-control-plane-controller tests passed!"
''
