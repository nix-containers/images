...
pkgs.writeShellScript "test-minio-object-browser-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing minio-object-browser-iamguarded-fips image functionality..."
  ...
  echo "minio-object-browser-iamguarded-fips smoke test passed."
''
