...
pkgs.writeShellScript "test-jupyterhub-k8s-image-awaiter" ''
  set -euo pipefail
  echo "Testing jupyterhub-k8s-image-awaiter image functionality..."
  ...
  echo "jupyterhub-k8s-image-awaiter smoke test passed."
''
