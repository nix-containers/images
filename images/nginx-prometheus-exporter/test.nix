...
pkgs.writeShellScript "test-nginx-prometheus-exporter" ''
  set -euo pipefail
  echo "Testing nginx-prometheus-exporter image functionality..."
  ...
  echo "nginx-prometheus-exporter smoke test passed."
''
