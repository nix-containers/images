...
pkgs.writeShellScript "test-spire-oidc-discovery-provider-fips" ''
  set -euo pipefail
  echo "Testing spire-oidc-discovery-provider-fips image functionality..."
  ...
  echo "spire-oidc-discovery-provider-fips smoke test passed."
''
