...
pkgs.writeShellScript "test-crossplane-azure-managedidentity" ''
  set -euo pipefail
  echo "Testing crossplane-azure-managedidentity image..."
  ...
  echo "All crossplane-azure-managedidentity tests passed!"
''
