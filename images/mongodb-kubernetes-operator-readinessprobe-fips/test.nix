...
pkgs.writeShellScript "test-mongodb-kubernetes-operator-readinessprobe-fips" ''
  set -euo pipefail
  echo "Testing mongodb-kubernetes-operator-readinessprobe-fips image functionality..."
  ...
  echo "mongodb-kubernetes-operator-readinessprobe-fips smoke test passed."
''
