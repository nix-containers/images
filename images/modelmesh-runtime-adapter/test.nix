...
pkgs.writeShellScript "test-modelmesh-runtime-adapter" ''
  set -euo pipefail
  echo "Testing modelmesh-runtime-adapter image functionality..."
  ...
  echo "modelmesh-runtime-adapter smoke test passed."
''
