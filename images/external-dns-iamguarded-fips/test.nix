...
pkgs.writeShellScript "test-external-dns-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing external-dns-iamguarded-fips image functionality..."
  ...
  echo "external-dns-iamguarded-fips smoke test passed."
''
