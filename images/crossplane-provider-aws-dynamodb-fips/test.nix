...
pkgs.writeShellScript "test-crossplane-provider-aws-dynamodb-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-aws-dynamodb-fips image..."
  ...
  echo "All crossplane-provider-aws-dynamodb-fips tests passed!"
''
