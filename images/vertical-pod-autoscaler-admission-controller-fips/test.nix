...
pkgs.writeShellScript "test-vertical-pod-autoscaler-admission-controller-fips" ''
  set -euo pipefail
  echo "Testing vertical-pod-autoscaler-admission-controller-fips image functionality..."
  ...
  echo "vertical-pod-autoscaler-admission-controller-fips smoke test passed."
''
