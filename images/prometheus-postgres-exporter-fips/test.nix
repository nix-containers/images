...
pkgs.writeShellScript "test-prometheus-postgres-exporter-fips" ''
  set -euo pipefail
  echo "Testing prometheus-postgres-exporter-fips image..."
  ...
  echo "  Checking postgres-exporter runs..."
  ...
  echo "All prometheus-postgres-exporter-fips tests passed!"
''
