...
pkgs.writeShellScript "test-opensearch-dashboards-3-fips-dashboards-observability" ''
  set -euo pipefail
  echo "Testing opensearch-dashboards-3-fips-dashboards-observability image..."
  ...
  echo "All opensearch-dashboards-3-fips-dashboards-observability tests passed!"
''
