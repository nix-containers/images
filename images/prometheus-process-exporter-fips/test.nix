...
pkgs.writeShellScript "test-prometheus-process-exporter-fips" ''
  set -euo pipefail
  echo "Testing prometheus-process-exporter-fips image..."
  ...
  echo "All prometheus-process-exporter-fips tests passed!"
''
