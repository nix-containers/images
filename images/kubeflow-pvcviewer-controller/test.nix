...
pkgs.writeShellScript "test-kubeflow-pvcviewer-controller" ''
  set -euo pipefail
  echo "Testing kubeflow-pvcviewer-controller image..."
  ...
  echo "All kubeflow-pvcviewer-controller tests passed!"
''
