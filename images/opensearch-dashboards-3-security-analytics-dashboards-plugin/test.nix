...
pkgs.writeShellScript "test-opensearch-dashboards-3-security-analytics-dashboards-plugin" ''
  set -euo pipefail
  echo "Testing opensearch-dashboards-3-security-analytics-dashboards-plugin image..."
  ...
  echo "All opensearch-dashboards-3-security-analytics-dashboards-plugin tests passed!"
''
