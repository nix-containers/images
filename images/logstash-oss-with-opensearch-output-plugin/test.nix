...
pkgs.writeShellScript "test-logstash-oss-with-opensearch-output-plugin" ''
  set -euo pipefail
  echo "Testing logstash-oss-with-opensearch-output-plugin image functionality..."
  ...
  echo "logstash-oss-with-opensearch-output-plugin smoke test passed."
''
