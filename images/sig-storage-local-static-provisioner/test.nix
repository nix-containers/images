...
pkgs.writeShellScript "test-sig-storage-local-static-provisioner" ''
  set -euo pipefail
  echo "Testing sig-storage-local-static-provisioner image functionality..."
  ...
  echo "sig-storage-local-static-provisioner smoke test passed."
''
