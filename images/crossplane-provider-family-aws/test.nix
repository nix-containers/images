...
pkgs.writeShellScript "test-crossplane-provider-family-aws" ''
  set -euo pipefail
  echo "Testing crossplane-provider-family-aws image..."
  ...
  echo "All crossplane-provider-family-aws tests passed!"
''
