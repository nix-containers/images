...
pkgs.writeShellScript "test-timestamp-authority-cli" ''
  set -euo pipefail
  echo "Testing timestamp-authority-cli image functionality..."
  ...
  echo "timestamp-authority-cli smoke test passed."
''
