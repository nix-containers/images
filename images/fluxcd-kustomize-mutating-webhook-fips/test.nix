...
pkgs.writeShellScript "test-fluxcd-kustomize-mutating-webhook-fips" ''
  set -euo pipefail
  echo "Testing fluxcd-kustomize-mutating-webhook-fips image functionality..."
  ...
  echo "fluxcd-kustomize-mutating-webhook-fips smoke test passed."
''
