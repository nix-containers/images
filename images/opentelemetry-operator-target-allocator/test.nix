...
pkgs.writeShellScript "test-opentelemetry-operator-target-allocator" ''
  set -euo pipefail
  echo "Testing opentelemetry-operator-target-allocator image functionality..."
  ...
  echo "opentelemetry-operator-target-allocator smoke test passed."
''
