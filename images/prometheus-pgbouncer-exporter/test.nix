...
pkgs.writeShellScript "test-prometheus-pgbouncer-exporter" ''
  set -euo pipefail
  echo "Testing prometheus-pgbouncer-exporter image..."
  ...
  echo "  Checking pgbouncer_exporter runs..."
  ...
  echo "All prometheus-pgbouncer-exporter tests passed!"
''
