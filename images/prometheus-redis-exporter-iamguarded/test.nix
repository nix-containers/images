...
pkgs.writeShellScript "test-prometheus-redis-exporter-iamguarded" ''
  set -euo pipefail
  echo "Testing prometheus-redis-exporter-iamguarded image..."
  ...
  echo "All prometheus-redis-exporter-iamguarded tests passed!"
''
