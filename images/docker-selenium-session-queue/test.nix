...
pkgs.writeShellScript "test-docker-selenium-session-queue" ''
  set -euo pipefail
  echo "Testing docker-selenium-session-queue image..."
  ...
  echo "All docker-selenium-session-queue tests passed!"
''
