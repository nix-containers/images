...
pkgs.writeShellScript "test-crossplane-aws-firehose-fips" ''
  set -euo pipefail
  echo "Testing crossplane-aws-firehose-fips image..."
  ...
  echo "All crossplane-aws-firehose-fips tests passed!"
''
