...
pkgs.writeShellScript "test-valkey-sentinel-nixchart" ''
  set -euo pipefail
  echo "Testing valkey-sentinel-nixchart image functionality..."
  ...
  echo "valkey-sentinel-nixchart smoke test passed."
''
