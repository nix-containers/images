...
pkgs.writeShellScript "test-temporal-ui-server-fips" ''
  set -euo pipefail
  echo "Testing temporal-ui-server-fips image functionality..."
  ...
  echo "temporal-ui-server-fips smoke test passed."
''
