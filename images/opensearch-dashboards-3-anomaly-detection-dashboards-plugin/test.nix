...
pkgs.writeShellScript "test-opensearch-dashboards-3-anomaly-detection-dashboards-plugin" ''
  set -euo pipefail
  echo "Testing opensearch-dashboards-3-anomaly-detection-dashboards-plugin image..."
  ...
  echo "All opensearch-dashboards-3-anomaly-detection-dashboards-plugin tests passed!"
''
