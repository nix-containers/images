...
pkgs.writeShellScript "test-crossplane-provider-gcp-cloudplatform" ''
  set -euo pipefail
  echo "Testing crossplane-provider-gcp-cloudplatform image..."
  ...
  echo "All crossplane-provider-gcp-cloudplatform tests passed!"
''
