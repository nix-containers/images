...
# =============
# Placeholder for snapshot-validation-webhook container image.
...
throw "Image 'snapshot-validation-webhook' is not yet implemented. See default.nix for implementation notes."
