...
pkgs.writeShellScript "test-amazon-cloudwatch-agent-amazon-cloudwatch-agent-config-wizard-fips" ''
  set -euo pipefail
  echo "Testing amazon-cloudwatch-agent-amazon-cloudwatch-agent-config-wizard-fips image functionality..."
  ...
  echo "amazon-cloudwatch-agent-amazon-cloudwatch-agent-config-wizard-fips smoke test passed."
''
