...
pkgs.writeShellScript "test-postgres-repmgr-nixchart" ''
  set -euo pipefail
  echo "Testing postgres-repmgr-nixchart image functionality..."
  ...
  echo "postgres-repmgr-nixchart smoke test passed."
''
