...
pkgs.writeShellScript "test-newrelic-infrastructure-bundle" ''
  set -euo pipefail
  echo "Testing newrelic-infrastructure-bundle image functionality..."
  ...
  echo "newrelic-infrastructure-bundle smoke test passed."
''
