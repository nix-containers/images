...
pkgs.writeShellScript "test-datadog-agent-core-integrations" ''
  set -euo pipefail
  echo "Testing datadog-agent-core-integrations image functionality..."
  ...
  echo "datadog-agent-core-integrations smoke test passed."
''
