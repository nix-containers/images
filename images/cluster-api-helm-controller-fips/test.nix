...
pkgs.writeShellScript "test-cluster-api-helm-controller-fips" ''
  set -euo pipefail
  echo "Testing cluster-api-helm-controller-fips image..."
  ...
  echo "All cluster-api-helm-controller-fips tests passed!"
''
