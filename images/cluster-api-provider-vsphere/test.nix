...
pkgs.writeShellScript "test-cluster-api-provider-vsphere" ''
  set -euo pipefail
  echo "Testing cluster-api-provider-vsphere image..."
  ...
  echo "All cluster-api-provider-vsphere tests passed!"
''
