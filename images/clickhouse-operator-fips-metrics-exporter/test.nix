...
pkgs.writeShellScript "test-clickhouse-operator-fips-metrics-exporter" ''
  set -euo pipefail
  echo "Testing clickhouse-operator-fips-metrics-exporter image functionality..."
  ...
  echo "clickhouse-operator-fips-metrics-exporter smoke test passed."
''
