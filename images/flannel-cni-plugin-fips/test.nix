...
pkgs.writeShellScript "test-flannel-cni-plugin-fips" ''
  set -euo pipefail
  echo "Testing flannel-cni-plugin-fips image functionality..."
  ...
  echo "flannel-cni-plugin-fips smoke test passed."
''
