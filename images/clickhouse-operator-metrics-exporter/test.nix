...
pkgs.writeShellScript "test-clickhouse-operator-metrics-exporter" ''
  set -euo pipefail
  echo "Testing clickhouse-operator-metrics-exporter image functionality..."
  ...
  echo "clickhouse-operator-metrics-exporter smoke test passed."
''
