...
pkgs.writeShellScript "test-prometheus-operator-fips" ''
  set -euo pipefail
  echo "Testing prometheus-operator-fips image..."
  ...
  echo "  Checking prometheus-operator runs..."
  ...
  echo "All prometheus-operator-fips tests passed!"
''
