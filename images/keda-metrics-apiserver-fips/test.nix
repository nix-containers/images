...
pkgs.writeShellScript "test-keda-metrics-apiserver-fips" ''
  set -euo pipefail
  echo "Testing keda-metrics-apiserver-fips image functionality..."
  ...
  echo "keda-metrics-apiserver-fips smoke test passed."
''
