...
pkgs.writeShellScript "test-minio-object-browser-nixchart" ''
  set -euo pipefail
  echo "Testing minio-object-browser-nixchart image functionality..."
  ...
  echo "minio-object-browser-nixchart smoke test passed."
''
