...
pkgs.writeShellScript "test-trillian-logserver-fips" ''
  set -euo pipefail
  echo "Testing trillian-logserver-fips image functionality..."
  ...
  echo "trillian-logserver-fips smoke test passed."
''
