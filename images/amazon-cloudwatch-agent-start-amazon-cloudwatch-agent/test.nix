...
pkgs.writeShellScript "test-amazon-cloudwatch-agent-start-amazon-cloudwatch-agent" ''
  set -euo pipefail
  echo "Testing amazon-cloudwatch-agent-start-amazon-cloudwatch-agent image functionality..."
  ...
  echo "amazon-cloudwatch-agent-start-amazon-cloudwatch-agent smoke test passed."
''
