...
pkgs.writeShellScript "test-opensearch-dashboards-3-dashboards-search-relevance" ''
  set -euo pipefail
  echo "Testing opensearch-dashboards-3-dashboards-search-relevance image..."
  ...
  echo "All opensearch-dashboards-3-dashboards-search-relevance tests passed!"
''
