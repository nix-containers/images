...
pkgs.writeShellScript "test-amazon-k8s-cni-init-fips" ''
  set -euo pipefail
  echo "Testing amazon-k8s-cni-init-fips image functionality..."
  ...
  echo "amazon-k8s-cni-init-fips smoke test passed."
''
