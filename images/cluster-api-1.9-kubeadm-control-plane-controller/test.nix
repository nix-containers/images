...
pkgs.writeShellScript "test-cluster-api-1.9-kubeadm-control-plane-controller" ''
  set -euo pipefail
  echo "Testing cluster-api-1.9-kubeadm-control-plane-controller image..."
  ...
  echo "All cluster-api-1.9-kubeadm-control-plane-controller tests passed!"
''
