...
pkgs.writeShellScript "test-doppler-kubernetes-operator" ''
  set -euo pipefail
  echo "Testing doppler-kubernetes-operator image functionality..."
  ...
  echo "doppler-kubernetes-operator smoke test passed."
''
