...
pkgs.writeShellScript "test-crossplane-aws-provider-fips" ''
  set -euo pipefail
  echo "Testing crossplane-aws-provider-fips image..."
  ...
  echo "All crossplane-aws-provider-fips tests passed!"
''
