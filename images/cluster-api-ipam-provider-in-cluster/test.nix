...
pkgs.writeShellScript "test-cluster-api-ipam-provider-in-cluster" ''
  set -euo pipefail
  echo "Testing cluster-api-ipam-provider-in-cluster image..."
  ...
  echo "All cluster-api-ipam-provider-in-cluster tests passed!"
''
