...
pkgs.writeShellScript "test-runner-container-hooks-k8s" ''
  set -euo pipefail
  echo "Testing runner-container-hooks-k8s image functionality..."
  ...
  echo "runner-container-hooks-k8s smoke test passed."
''
