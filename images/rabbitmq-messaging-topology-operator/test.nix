...
pkgs.writeShellScript "test-rabbitmq-messaging-topology-operator" ''
  set -euo pipefail
  echo "Testing rabbitmq-messaging-topology-operator image functionality..."
  ...
  echo "rabbitmq-messaging-topology-operator smoke test passed."
''
