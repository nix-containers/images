...
pkgs.writeShellScript "test-docker-machine-driver-linode" ''
  set -euo pipefail
  echo "Testing docker-machine-driver-linode image..."
  ...
  echo "All docker-machine-driver-linode tests passed!"
''
