...
pkgs.writeShellScript "test-opentelemetry-java-contrib-jmx-metrics" ''
  set -euo pipefail
  echo "Testing opentelemetry-java-contrib-jmx-metrics image functionality..."
  ...
  echo "opentelemetry-java-contrib-jmx-metrics smoke test passed."
''
