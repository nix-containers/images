...
pkgs.writeShellScript "test-k8s-metadata-injection-fips" ''
  set -euo pipefail
  echo "Testing k8s-metadata-injection-fips image functionality..."
  ...
  echo "k8s-metadata-injection-fips smoke test passed."
''
