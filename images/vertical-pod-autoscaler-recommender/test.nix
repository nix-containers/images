...
pkgs.writeShellScript "test-vertical-pod-autoscaler-recommender" ''
  set -euo pipefail
  echo "Testing vertical-pod-autoscaler-recommender image functionality..."
  ...
  echo "vertical-pod-autoscaler-recommender smoke test passed."
''
