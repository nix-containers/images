...
pkgs.writeShellScript "test-nginx-mainline-mod-http_xslt_filter" ''
  set -euo pipefail
  echo "Testing nginx-mainline-mod-http_xslt_filter image functionality..."
  ...
  echo "nginx-mainline-mod-http_xslt_filter smoke test passed."
''
