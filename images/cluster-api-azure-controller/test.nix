...
pkgs.writeShellScript "test-cluster-api-azure-controller" ''
  set -euo pipefail
  echo "Testing cluster-api-azure-controller image..."
  ...
  echo "All cluster-api-azure-controller tests passed!"
''
