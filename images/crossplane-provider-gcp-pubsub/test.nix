...
pkgs.writeShellScript "test-crossplane-provider-gcp-pubsub" ''
  set -euo pipefail
  echo "Testing crossplane-provider-gcp-pubsub image..."
  ...
  echo "All crossplane-provider-gcp-pubsub tests passed!"
''
