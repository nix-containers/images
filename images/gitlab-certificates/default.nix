# gitlab-certificates
# =============
# Placeholder for gitlab-certificates container image.
...
# Chainguard SBOM packages for gitlab-certificates:
...
throw "Image 'gitlab-certificates' is not yet implemented. See default.nix for implementation notes."
