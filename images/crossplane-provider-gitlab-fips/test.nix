...
pkgs.writeShellScript "test-crossplane-provider-gitlab-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-gitlab-fips image..."
  ...
  echo "All crossplane-provider-gitlab-fips tests passed!"
''
