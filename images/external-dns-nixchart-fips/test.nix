...
pkgs.writeShellScript "test-external-dns-nixchart-fips" ''
  set -euo pipefail
  echo "Testing external-dns-nixchart-fips image functionality..."
  ...
  echo "external-dns-nixchart-fips smoke test passed."
''
