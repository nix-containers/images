...
pkgs.writeShellScript "test-tritonserver-backend-pytorch-cuda" ''
  set -euo pipefail
  echo "Testing tritonserver-backend-pytorch-cuda image functionality..."
  ...
  echo "tritonserver-backend-pytorch-cuda smoke test passed."
''
