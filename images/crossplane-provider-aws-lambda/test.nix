...
pkgs.writeShellScript "test-crossplane-provider-aws-lambda" ''
  set -euo pipefail
  echo "Testing crossplane-provider-aws-lambda image..."
  ...
  echo "All crossplane-provider-aws-lambda tests passed!"
''
