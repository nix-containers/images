...
pkgs.writeShellScript "test-thanos-iamguarded-fips-client" ''
  set -euo pipefail
  echo "Testing thanos-iamguarded-fips-client image functionality..."
  ...
  echo "thanos-iamguarded-fips-client smoke test passed."
''
