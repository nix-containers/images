...
pkgs.writeShellScript "test-ingress-nginx-custom-error-pages" ''
  set -euo pipefail
  echo "Testing ingress-nginx-custom-error-pages image functionality..."
  ...
  echo "ingress-nginx-custom-error-pages smoke test passed."
''
