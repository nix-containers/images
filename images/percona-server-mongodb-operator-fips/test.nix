...
pkgs.writeShellScript "test-percona-server-mongodb-operator-fips" ''
  set -euo pipefail
  echo "Testing percona-server-mongodb-operator-fips image functionality..."
  ...
  echo "percona-server-mongodb-operator-fips smoke test passed."
''
