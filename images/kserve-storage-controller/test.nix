...
pkgs.writeShellScript "test-kserve-storage-controller" ''
  set -euo pipefail
  echo "Testing kserve-storage-controller image functionality..."
  ...
  echo "kserve-storage-controller smoke test passed."
''
