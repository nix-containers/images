...
pkgs.writeShellScript "test-jupyterhub-k8s-network-tools" ''
  set -euo pipefail
  echo "Testing jupyterhub-k8s-network-tools image functionality..."
  ...
  echo "jupyterhub-k8s-network-tools smoke test passed."
''
