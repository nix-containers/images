...
pkgs.writeShellScript "test-vertical-pod-autoscaler-fips" ''
  set -euo pipefail
  echo "Testing vertical-pod-autoscaler-fips image functionality..."
  ...
  echo "vertical-pod-autoscaler-fips smoke test passed."
''
