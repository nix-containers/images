...
pkgs.writeShellScript "test-gcp-compute-persistent-disk-csi-driver-fips" ''
  set -euo pipefail
  echo "Testing gcp-compute-persistent-disk-csi-driver-fips image functionality..."
  ...
  echo "gcp-compute-persistent-disk-csi-driver-fips smoke test passed."
''
