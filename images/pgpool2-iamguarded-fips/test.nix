...
pkgs.writeShellScript "test-pgpool2-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing pgpool2-iamguarded-fips image functionality..."
  ...
  echo "pgpool2-iamguarded-fips smoke test passed."
''
