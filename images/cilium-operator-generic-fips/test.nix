...
pkgs.writeShellScript "test-cilium-operator-generic-fips" ''
  set -euo pipefail
  echo "Testing cilium-operator-generic-fips image..."
  ...
  echo "All cilium-operator-generic-fips tests passed!"
''
