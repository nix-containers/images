...
pkgs.writeShellScript "test-ingress-nginx-opentelemetry-plugin" ''
  set -euo pipefail
  echo "Testing ingress-nginx-opentelemetry-plugin image functionality..."
  ...
  echo "ingress-nginx-opentelemetry-plugin smoke test passed."
''
