...
pkgs.writeShellScript "test-cloud-provider-gcp-cloud-controller-manager-fips" ''
  set -euo pipefail
  echo "Testing cloud-provider-gcp-cloud-controller-manager-fips image functionality..."
  ...
  echo "cloud-provider-gcp-cloud-controller-manager-fips smoke test passed."
''
