...
```bash
# Build the image
nix build .#kubernetes-ingress-defaultbackend-fips

# Load into Docker
nix build .#load-kubernetes-ingress-defaultbackend-fips-to-docker && ./result/bin/load-kubernetes-ingress-defaultbackend-fips-to-docker
```
