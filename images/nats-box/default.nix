...
let
  ...
  drv = pkgs.buildGoModule {
    pname = "nats-box"; inherit version;
...
in mkImage { inherit drv; name = "nats-box"; tag = "v${version}"; entrypoint = [ "${drv}/bin/nats" ]; cmd = [ "--help" ]; labels = { "org.opencontainers.image.title" = "nats-box"; "org.opencontainers.image.version" = version; "io.nix-containers.source" = "upstream-source"; }; }
