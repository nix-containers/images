...
pkgs.writeShellScript "test-plugin-barman-cloud-sidecar" ''
  set -euo pipefail
  echo "Testing plugin-barman-cloud-sidecar image functionality..."
  ...
  echo "plugin-barman-cloud-sidecar smoke test passed."
''
