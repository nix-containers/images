...
pkgs.writeShellScript "test-spire-oidc-discovery-provider" ''
  set -euo pipefail
  echo "Testing spire-oidc-discovery-provider image functionality..."
  ...
  echo "spire-oidc-discovery-provider smoke test passed."
''
