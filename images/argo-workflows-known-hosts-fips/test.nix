...
pkgs.writeShellScript "test-argo-workflows-known-hosts-fips" ''
  set -euo pipefail
  echo "Testing argo-workflows-known-hosts-fips image functionality..."
  ...
  echo "argo-workflows-known-hosts-fips smoke test passed."
''
