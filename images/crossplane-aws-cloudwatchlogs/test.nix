...
pkgs.writeShellScript "test-crossplane-aws-cloudwatchlogs" ''
  set -euo pipefail
  echo "Testing crossplane-aws-cloudwatchlogs image..."
  ...
  echo "All crossplane-aws-cloudwatchlogs tests passed!"
''
