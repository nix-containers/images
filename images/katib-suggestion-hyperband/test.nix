...
pkgs.writeShellScript "test-katib-suggestion-hyperband" ''
  set -euo pipefail
  echo "Testing katib-suggestion-hyperband image functionality..."
  ...
  echo "katib-suggestion-hyperband smoke test passed."
''
