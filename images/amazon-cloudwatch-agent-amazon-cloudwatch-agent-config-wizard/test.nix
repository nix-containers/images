...
pkgs.writeShellScript "test-amazon-cloudwatch-agent-amazon-cloudwatch-agent-config-wizard" ''
  set -euo pipefail
  echo "Testing amazon-cloudwatch-agent-amazon-cloudwatch-agent-config-wizard image functionality..."
  ...
  echo "amazon-cloudwatch-agent-amazon-cloudwatch-agent-config-wizard smoke test passed."
''
