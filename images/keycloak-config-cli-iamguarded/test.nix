...
pkgs.writeShellScript "test-keycloak-config-cli-iamguarded" ''
  set -euo pipefail
  echo "Testing keycloak-config-cli-iamguarded image functionality..."
  ...
  echo "keycloak-config-cli-iamguarded smoke test passed."
''
