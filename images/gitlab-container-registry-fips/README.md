...
```bash
# Build the image
nix build .#gitlab-container-registry-fips

# Load into Docker
nix build .#load-gitlab-container-registry-fips-to-docker && ./result/bin/load-gitlab-container-registry-fips-to-docker
```
