...
pkgs.writeShellScript "test-corretto-bcfips-policy-140-3-j21" ''
  set -euo pipefail
  echo "Testing corretto-bcfips-policy-140-3-j21 image functionality..."
  ...
  echo "corretto-bcfips-policy-140-3-j21 smoke test passed."
''
