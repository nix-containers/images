...
pkgs.writeShellScript "test-ingress-nginx-controller-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing ingress-nginx-controller-iamguarded-fips image functionality..."
  ...
  echo "ingress-nginx-controller-iamguarded-fips smoke test passed."
''
