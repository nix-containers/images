...
pkgs.writeShellScript "test-tritonserver-backend-openvino-cuda" ''
  set -euo pipefail
  echo "Testing tritonserver-backend-openvino-cuda image functionality..."
  ...
  echo "tritonserver-backend-openvino-cuda smoke test passed."
''
