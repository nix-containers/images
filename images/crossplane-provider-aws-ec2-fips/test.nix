...
pkgs.writeShellScript "test-crossplane-provider-aws-ec2-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-aws-ec2-fips image..."
  ...
  echo "All crossplane-provider-aws-ec2-fips tests passed!"
''
