...
```bash
# Build the image
nix build .#kubernetes-csi-external-snapshot-controller-fips

# Load into Docker
nix build .#load-kubernetes-csi-external-snapshot-controller-fips-to-docker && ./result/bin/load-kubernetes-csi-external-snapshot-controller-fips-to-docker
```
