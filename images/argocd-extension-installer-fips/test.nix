...
pkgs.writeShellScript "test-argocd-extension-installer-fips" ''
  set -euo pipefail
  echo "Testing argocd-extension-installer-fips image functionality..."
  ...
  echo "argocd-extension-installer-fips smoke test passed."
''
