...
pkgs.writeShellScript "test-cluster-api-vsphere-controller" ''
  set -euo pipefail
  echo "Testing cluster-api-vsphere-controller image..."
  ...
  echo "All cluster-api-vsphere-controller tests passed!"
''
