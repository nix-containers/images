...
pkgs.writeShellScript "test-redis-cluster-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing redis-cluster-iamguarded-fips image..."
  ...
  echo "All redis-cluster-iamguarded-fips tests passed!"
''
