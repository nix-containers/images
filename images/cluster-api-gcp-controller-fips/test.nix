...
pkgs.writeShellScript "test-cluster-api-gcp-controller-fips" ''
  set -euo pipefail
  echo "Testing cluster-api-gcp-controller-fips image..."
  ...
  echo "All cluster-api-gcp-controller-fips tests passed!"
''
