...
pkgs.writeShellScript "test-hubble-export-stdout-fips" ''
  set -euo pipefail
  echo "Testing hubble-export-stdout-fips image functionality..."
  ...
  echo "hubble-export-stdout-fips smoke test passed."
''
