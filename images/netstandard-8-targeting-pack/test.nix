...
pkgs.writeShellScript "test-netstandard-8-targeting-pack" ''
  set -euo pipefail
  echo "Testing netstandard-8-targeting-pack image functionality..."
  ...
  echo "netstandard-8-targeting-pack smoke test passed."
''
