...
pkgs.writeShellScript "test-cluster-api-provider-vsphere-fips" ''
  set -euo pipefail
  echo "Testing cluster-api-provider-vsphere-fips image..."
  ...
  echo "All cluster-api-provider-vsphere-fips tests passed!"
''
