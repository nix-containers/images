...
pkgs.writeShellScript "test-metric-collector-for-apache-cassandra" ''
  set -euo pipefail
  echo "Testing metric-collector-for-apache-cassandra image functionality..."
  ...
  echo "metric-collector-for-apache-cassandra smoke test passed."
''
