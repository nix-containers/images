...
pkgs.writeShellScript "test-secrets-store-csi-driver-crds-fips" ''
  set -euo pipefail
  echo "Testing secrets-store-csi-driver-crds-fips image functionality..."
  ...
  echo "secrets-store-csi-driver-crds-fips smoke test passed."
''
