...
pkgs.writeShellScript "test-crossplane-function-go-templating-fips" ''
  set -euo pipefail
  echo "Testing crossplane-function-go-templating-fips image..."
  ...
  echo "All crossplane-function-go-templating-fips tests passed!"
''
