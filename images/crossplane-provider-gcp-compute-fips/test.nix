...
pkgs.writeShellScript "test-crossplane-provider-gcp-compute-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-gcp-compute-fips image..."
  ...
  echo "All crossplane-provider-gcp-compute-fips tests passed!"
''
