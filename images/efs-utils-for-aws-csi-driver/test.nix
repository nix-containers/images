...
pkgs.writeShellScript "test-efs-utils-for-aws-csi-driver" ''
  set -euo pipefail
  echo "Testing efs-utils-for-aws-csi-driver image functionality..."
  ...
  echo "efs-utils-for-aws-csi-driver smoke test passed."
''
