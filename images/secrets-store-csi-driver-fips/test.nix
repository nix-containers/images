...
pkgs.writeShellScript "test-secrets-store-csi-driver-fips" ''
  set -euo pipefail
  echo "Testing secrets-store-csi-driver-fips image functionality..."
  ...
  echo "secrets-store-csi-driver-fips smoke test passed."
''
