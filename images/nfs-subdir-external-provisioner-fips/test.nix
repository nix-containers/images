...
pkgs.writeShellScript "test-nfs-subdir-external-provisioner-fips" ''
  set -euo pipefail
  echo "Testing nfs-subdir-external-provisioner-fips image functionality..."
  ...
  echo "nfs-subdir-external-provisioner-fips smoke test passed."
''
