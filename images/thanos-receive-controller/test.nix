...
pkgs.writeShellScript "test-thanos-receive-controller" ''
  set -euo pipefail
  echo "Testing thanos-receive-controller image functionality..."
  ...
  echo "thanos-receive-controller smoke test passed."
''
