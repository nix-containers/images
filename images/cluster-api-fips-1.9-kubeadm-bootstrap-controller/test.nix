...
pkgs.writeShellScript "test-cluster-api-fips-1.9-kubeadm-bootstrap-controller" ''
  set -euo pipefail
  echo "Testing cluster-api-fips-1.9-kubeadm-bootstrap-controller image..."
  ...
  echo "All cluster-api-fips-1.9-kubeadm-bootstrap-controller tests passed!"
''
