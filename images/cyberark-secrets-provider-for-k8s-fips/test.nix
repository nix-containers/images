...
pkgs.writeShellScript "test-cyberark-secrets-provider-for-k8s-fips" ''
  set -euo pipefail
  echo "Testing cyberark-secrets-provider-for-k8s-fips image functionality..."
  ...
  echo "cyberark-secrets-provider-for-k8s-fips smoke test passed."
''
