...
pkgs.writeShellScript "test-volsync-fips-diskrsync-tcp" ''
  set -euo pipefail
  echo "Testing volsync-fips-diskrsync-tcp image functionality..."
  ...
  echo "volsync-fips-diskrsync-tcp smoke test passed."
''
