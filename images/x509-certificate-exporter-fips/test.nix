...
pkgs.writeShellScript "test-x509-certificate-exporter-fips" ''
  set -euo pipefail
  echo "Testing x509-certificate-exporter-fips image functionality..."
  ...
  echo "x509-certificate-exporter-fips smoke test passed."
''
