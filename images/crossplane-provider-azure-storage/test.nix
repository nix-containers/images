...
pkgs.writeShellScript "test-crossplane-provider-azure-storage" ''
  set -euo pipefail
  echo "Testing crossplane-provider-azure-storage image..."
  ...
  echo "All crossplane-provider-azure-storage tests passed!"
''
