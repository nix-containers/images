...
pkgs.writeShellScript "test-harbor-scanner-trivy-fips" ''
  set -euo pipefail
  echo "Testing harbor-scanner-trivy-fips image functionality..."
  ...
  echo "harbor-scanner-trivy-fips smoke test passed."
''
