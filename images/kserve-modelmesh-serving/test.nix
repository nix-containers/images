...
pkgs.writeShellScript "test-kserve-modelmesh-serving" ''
  set -euo pipefail
  echo "Testing kserve-modelmesh-serving image functionality..."
  ...
  echo "kserve-modelmesh-serving smoke test passed."
''
