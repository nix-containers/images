...
pkgs.writeShellScript "test-zookeeper-iamguarded-fips" ''
  set -euo pipefail
  echo "Testing zookeeper-iamguarded-fips image functionality..."
  ...
  echo "zookeeper-iamguarded-fips smoke test passed."
''
