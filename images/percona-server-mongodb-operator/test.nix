...
pkgs.writeShellScript "test-percona-server-mongodb-operator" ''
  set -euo pipefail
  echo "Testing percona-server-mongodb-operator image functionality..."
  ...
  echo "percona-server-mongodb-operator smoke test passed."
''
