...
pkgs.writeShellScript "test-amazon-cloudwatch-agent-config-downloader" ''
  set -euo pipefail
  echo "Testing amazon-cloudwatch-agent-config-downloader image functionality..."
  ...
  echo "amazon-cloudwatch-agent-config-downloader smoke test passed."
''
