...
pkgs.writeShellScript "test-mongodb-kubernetes-operator-version-upgrade-post-start-hook" ''
  set -euo pipefail
  echo "Testing mongodb-kubernetes-operator-version-upgrade-post-start-hook image functionality..."
  ...
  echo "mongodb-kubernetes-operator-version-upgrade-post-start-hook smoke test passed."
''
