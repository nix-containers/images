...
```bash
# Build the image
nix build .#kubernetes-event-exporter-iamguarded-fips

# Load into Docker
nix build .#load-kubernetes-event-exporter-iamguarded-fips-to-docker && ./result/bin/load-kubernetes-event-exporter-iamguarded-fips-to-docker
```
