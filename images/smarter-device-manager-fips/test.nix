...
pkgs.writeShellScript "test-smarter-device-manager-fips" ''
  set -euo pipefail
  echo "Testing smarter-device-manager-fips image functionality..."
  ...
  echo "smarter-device-manager-fips smoke test passed."
''
