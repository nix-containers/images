...
pkgs.writeShellScript "test-katib-suggestion-hyperopt" ''
  set -euo pipefail
  echo "Testing katib-suggestion-hyperopt image functionality..."
  ...
  echo "katib-suggestion-hyperopt smoke test passed."
''
