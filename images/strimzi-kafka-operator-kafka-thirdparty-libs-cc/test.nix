...
pkgs.writeShellScript "test-strimzi-kafka-operator-kafka-thirdparty-libs-cc" ''
  set -euo pipefail
  echo "Testing strimzi-kafka-operator-kafka-thirdparty-libs-cc image functionality..."
  ...
  echo "strimzi-kafka-operator-kafka-thirdparty-libs-cc smoke test passed."
''
