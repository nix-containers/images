...
pkgs.writeShellScript "test-crossplane-aws-cloudwatchlogs-fips" ''
  set -euo pipefail
  echo "Testing crossplane-aws-cloudwatchlogs-fips image..."
  ...
  echo "All crossplane-aws-cloudwatchlogs-fips tests passed!"
''
