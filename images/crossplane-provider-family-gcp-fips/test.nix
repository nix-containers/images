...
pkgs.writeShellScript "test-crossplane-provider-family-gcp-fips" ''
  set -euo pipefail
  echo "Testing crossplane-provider-family-gcp-fips image..."
  ...
  echo "All crossplane-provider-family-gcp-fips tests passed!"
''
